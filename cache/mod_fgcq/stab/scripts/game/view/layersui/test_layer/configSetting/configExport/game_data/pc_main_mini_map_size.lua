...
function ui.init(parent)
	...
	-- Create input_prefix
	local input_prefix = GUI:Text_Create(input_bg, "input_prefix", -3.00, 13.00, 14, "#ffffff", [[小地图宽度]])
	...
	-- Create input_width
	local input_width = GUI:TextInput_Create(input_bg, "input_width", 0.00, 0.00, 55.00, 25.00, 16)
	GUI:TextInput_setString(input_width, "")
	GUI:TextInput_setFontColor(input_width, "#ffffff")
	GUI:setTouchEnabled(input_width, true)
	GUI:setTag(input_width, -1)
	...
	-- Create input_height
	local input_height = GUI:TextInput_Create(input_bg_1, "input_height", 0.00, 0.00, 55.00, 25.00, 16)
	GUI:TextInput_setString(input_height, "")
	GUI:TextInput_setFontColor(input_height, "#ffffff")
	GUI:setTouchEnabled(input_height, true)
	GUI:setTag(input_height, -1)

	-- Create input_prefix
	local input_prefix = GUI:Text_Create(input_bg_1, "input_prefix", -3.00, 13.00, 14, "#ffffff", [[小地图高度]])
	GUI:setAnchorPoint(input_prefix, 1.00, 0.50)
	GUI:setTouchEnabled(input_prefix, false)
	GUI:setTag(input_prefix, -1)
	GUI:Text_enableOutline(input_prefix, "#000000", 1)
	...
	-- Create input_prefix
	local input_prefix = GUI:Text_Create(input_bg_2, "input_prefix", -3.00, 13.00, 14, "#ffffff", [[二级地图宽度]])
	GUI:setAnchorPoint(input_prefix, 1.00, 0.50)
	GUI:setTouchEnabled(input_prefix, false)
	GUI:setTag(input_prefix, -1)
	GUI:Text_enableOutline(input_prefix, "#000000", 1)
	...
	-- Create input_width2
	local input_width2 = GUI:TextInput_Create(input_bg_2, "input_width2", 0.00, 0.00, 55.00, 25.00, 16)
	GUI:TextInput_setString(input_width2, "")
	GUI:TextInput_setFontColor(input_width2, "#ffffff")
	GUI:setTouchEnabled(input_width2, true)
	GUI:setTag(input_width2, -1)
	...
	-- Create input_height2
	local input_height2 = GUI:TextInput_Create(input_bg_3, "input_height2", 0.00, 0.00, 55.00, 25.00, 16)
	GUI:TextInput_setString(input_height2, "")
	GUI:TextInput_setFontColor(input_height2, "#ffffff")
	GUI:setTouchEnabled(input_height2, true)
	GUI:setTag(input_height2, -1)

	-- Create input_prefix
	local input_prefix = GUI:Text_Create(input_bg_3, "input_prefix", -3.00, 13.00, 14, "#ffffff", [[二级地图高度]])
	GUI:setAnchorPoint(input_prefix, 1.00, 0.50)
	GUI:setTouchEnabled(input_prefix, false)
	GUI:setTag(input_prefix, -1)
	GUI:Text_enableOutline(input_prefix, "#000000", 1)
