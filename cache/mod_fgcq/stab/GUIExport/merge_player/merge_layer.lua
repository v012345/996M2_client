...
function ui.init(parent)
	...
	GUI:setChineseName(Scene, "二合一场景")
	...
	local Panel_btnList = GUI:Layout_Create(Image_1, "Panel_btnList", 402.00, 460.00, 32.00, 454.00, false)
	...
	GUI:setChineseName(Button_1, "二合一_装备_按钮")
...
备]])
	GUI:setChineseName(Text_name, "二合一_装备_文本")
	...
	GUI:setChineseName(Button_2, "二合一_状态_按钮")
...
态]])
	...
	GUI:setChineseName(Button_3, "二合一_属性_按钮")
...
性]])
	GUI:setChineseName(Text_name, "二合一_属性_文本")
	GUI:setAnchorPoint(Text_name, 0.50, 1.00)
	GUI:setTouchEnabled(Text_name, false)
	GUI:setTag(Text_name, 94)
	GUI:Text_enableOutline(Text_name, "#111111", 2)
	...
	GUI:setChineseName(Button_4, "二合一_技能_按钮")
