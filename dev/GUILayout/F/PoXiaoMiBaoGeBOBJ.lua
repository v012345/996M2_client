PoXiaoMiBaoGeBOBJ = {}
PoXiaoMiBaoGeBOBJ.__cname = "PoXiaoMiBaoGeBOBJ"
PoXiaoMiBaoGeBOBJ.ItemData = {
...
--PoXiaoMiBaoGeBOBJ.config = ssrRequireCsvCfg("cfg_ShengChengMiBaoGeA")
-------------------------------↓↓↓ UI操作 ↓↓↓---------------------------------------
function PoXiaoMiBaoGeBOBJ:main(objcfg)
    ...
    ------------------------↓↓↓ 通讯后端 ↓↓↓------------------------
    ssrMessage:sendmsg(ssrNetMsgCfg.PoXiaoMiBaoGeB_SyncResponse)
    ------------------------↑↑↑ 通讯后端 ↑↑↑------------------------
    ...
    GUI:addOnClickEvent(self.ui.Button_1, function()
        ssrMessage:sendmsg(ssrNetMsgCfg.PoXiaoMiBaoGeB_Request,1)
    end)

    GUI:addOnClickEvent(self.ui.Button_2, function()
        ssrMessage:sendmsg(ssrNetMsgCfg.PoXiaoMiBaoGeB_Request,2)
    end)
...
function PoXiaoMiBaoGeBOBJ:UpdateUI()
...
-------------------------------↓↓↓ 网络消息 ↓↓↓---------------------------------------
function PoXiaoMiBaoGeBOBJ:SyncResponse(TongXingZheng, RiChongNum, arg3, data)
