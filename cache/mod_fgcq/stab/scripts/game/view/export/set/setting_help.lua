...
function ui.init(parent)
	...
	GUI:setContentSize(Image_3, 567, 364)
	GUI:setIgnoreContentAdaptWithSize(Image_3, false)
	GUI:setTouchEnabled(Image_3, false)
	GUI:setTag(Image_3, -1)

	-- Create ListView_1
	local ListView_1 = GUI:ListView_Create(Image_1, "ListView_1", 127.00, 42.00, 562.00, 362.00, 1)
	GUI:ListView_setGravity(ListView_1, 5)
	GUI:setTouchEnabled(ListView_1, true)
	GUI:setTag(ListView_1, -1)

	-- Create Text_1
	local Text_1 = GUI:Text_Create(ListView_1, "Text_1", 0.00, 362.00, 20, "#ffffff", [[]])
	...
	-- Create ListView_2
	local ListView_2 = GUI:ListView_Create(Image_1, "ListView_2", 0.00, 405.00, 124.00, 405.00, 1)
