...
function ui.init(parent)
	...
	-- Create Text
	local Text = GUI:Text_Create(panel_bg, "Text", 0.00, 350.00, 14, "#ffffff", [[勾选需要屏蔽显示的货币ID]])
	GUI:setTouchEnabled(Text, false)
	GUI:setTag(Text, -1)
	GUI:Text_enableOutline(Text, "#000000", 1)

	-- Create ScrollView_items
	local ScrollView_items = GUI:ScrollView_Create(panel_bg, "ScrollView_items", 0.00, 345.00, 300.00, 300.00, 1)
	GUI:ScrollView_setInnerContainerSize(ScrollView_items, 300.00, 300.00)
