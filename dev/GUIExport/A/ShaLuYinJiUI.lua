...
function ui.init(parent, __data__, __update__)
	...
	-- Create ImageBG
	local ImageBG = GUI:Image_Create(parent, "ImageBG", 0.00, 0.00, "res/custom/ShaLuKeYin/background.png")
	...
	-- Create EquipShow
	local EquipShow = GUI:EquipShow_Create(Node, "EquipShow", 565.00, 349.00, 12, false, {bgVisible = false, doubleTakeOff = false, look = true, movable = false, starLv = false, lookPlayer = false})
	...
	-- Create Item
	local Item = GUI:ItemShow_Create(Node, "Item", 798.00, 380.00, {index = 1, count = 1, look = true, bgVisible = false})
	...
	-- Create Effect
	local Effect = GUI:Effect_Create(ImageBG, "Effect", 364.00, 290.00, 3, 16013)
	GUI:setTag(Effect, -1)

	-- Create ImageView
	local ImageView = GUI:Image_Create(ImageBG, "ImageView", 188.00, 109.00, "res/custom/ShaLuKeYin/tips.png")
