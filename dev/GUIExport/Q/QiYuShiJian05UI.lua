...
function ui.init(parent, __data__, __update__)
	...
	-- Create ImageBG
	local ImageBG = GUI:Image_Create(parent, "ImageBG", 0.00, 0.00, "res/custom/qiyuxitong/jm/jm_5_1.png")
	...
	-- Create Button_1
	local Button_1 = GUI:Button_Create(ImageBG, "Button_1", 252.00, 43.00, "res/custom/qiyuxitong/an/an09.png")
	...
	-- Create Button_2
	local Button_2 = GUI:Button_Create(ImageBG, "Button_2", 405.00, 43.00, "res/custom/qiyuxitong/an/an10.png")
	...
	-- Create Button_3
	local Button_3 = GUI:Button_Create(ImageBG, "Button_3", 558.00, 43.00, "res/custom/qiyuxitong/an/an08.png")
	...
	-- Create Button_4
	local Button_4 = GUI:Button_Create(ImageBG, "Button_4", 399.00, 23.00, "res/custom/qiyuxitong/an/an01.png")
	...
	-- Create items_1
	local items_1 = GUI:Layout_Create(Button_4, "items_1", 79.00, 98.00, 62, 62, false)
	GUI:setAnchorPoint(items_1, 0.00, 0.00)
	GUI:setTouchEnabled(items_1, true)
	GUI:setTag(items_1, 0)

	-- Create Button_5
	local Button_5 = GUI:Button_Create(ImageBG, "Button_5", 399.00, 23.00, "res/custom/qiyuxitong/an/an01.png")
	...
	-- Create items_2
	local items_2 = GUI:Layout_Create(Button_5, "items_2", 79.00, 98.00, 62, 62, false)
	GUI:setAnchorPoint(items_2, 0.00, 0.00)
	GUI:setTouchEnabled(items_2, true)
	GUI:setTag(items_2, 0)

	-- Create Button_6
	local Button_6 = GUI:Button_Create(ImageBG, "Button_6", 399.00, 23.00, "res/custom/qiyuxitong/an/an01.png")
	...
	-- Create items_3
	local items_3 = GUI:Layout_Create(Button_6, "items_3", 79.00, 98.00, 62, 62, false)
