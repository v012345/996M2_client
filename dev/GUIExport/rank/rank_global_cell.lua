...
function ui.init(parent)
	-- Create Panel_cells
	local Panel_cells = GUI:Layout_Create(parent, "Panel_cells", 280.00, 382.00, 560.00, 40.00, false)
	GUI:setChineseName(Panel_cells, "排行榜_组合")
	GUI:setTouchEnabled(Panel_cells, true)
	GUI:setTag(Panel_cells, 1)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_cells, "Image_bg", 1.00, 0.00, "res/private/rank_ui/rank_ui_mobile/1900020022.png")
	GUI:setContentSize(Image_bg, 560, 40)
	...
	-- Create Text_rank
	local Text_rank = GUI:Text_Create(Panel_cells, "Text_rank", 5.00, 20.00, 18, "#ffffff", [[4]])
	...
	-- Create Panel_ranks
	local Panel_ranks = GUI:Layout_Create(Panel_cells, "Panel_ranks", 2.00, 2.00, 34.00, 34.00, false)
	GUI:setChineseName(Panel_ranks, "排行榜_名次组合")
	GUI:setTouchEnabled(Panel_ranks, true)
	GUI:setTag(Panel_ranks, 4)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_ranks, "Image_bg", 17.00, 17.00, "res/private/rank_ui/rank_ui_mobile/1900020023.png")
	GUI:setChineseName(Image_bg, "排行榜_名次背景")
	GUI:setAnchorPoint(Image_bg, 0.50, 0.50)
	GUI:setTouchEnabled(Image_bg, false)
	GUI:setTag(Image_bg, 5)

	-- Create Image_rank
	local Image_rank = GUI:Image_Create(Panel_ranks, "Image_rank", 17.00, 17.00, "res/private/rank_ui/rank_ui_mobile/1900020025.png")
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_cells, "Text_1", 119.00, 20.00, 16, "#fffc98", [[名字]])
	...
	-- Create Text_2
	local Text_2 = GUI:Text_Create(Panel_cells, "Text_2", 224.00, 20.00, 16, "#00ffff", [[服务器]])
	...
	-- Create Text_3
	local Text_3 = GUI:Text_Create(Panel_cells, "Text_3", 347.00, 20.00, 16, "#f67c1a", [[战斗力]])
	...
	-- Create Text_4
	local Text_4 = GUI:Text_Create(Panel_cells, "Text_4", 466.00, 20.00, 16, "#ffffff", [[行会]])
	...
	-- Create Image_select
	local Image_select = GUI:Image_Create(Panel_cells, "Image_select", 1.00, 0.00, "res/private/rank_ui/rank_ui_mobile/1900020028.png")
	GUI:setContentSize(Image_select, 451, 40)
	...
	-- Create Panel_touch
	local Panel_touch = GUI:Layout_Create(Panel_cells, "Panel_touch", 0.00, 0.00, 560.00, 40.00, false)
