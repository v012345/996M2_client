...
function ui.init(parent)
	...
	-- Create Image_20
	local Image_20 = GUI:Image_Create(Panel_1, "Image_20", 174.00, 239.00, "res/private/player_main_layer_ui/player_main_layer_ui_mobile/bg_juese_03_1.png")
	...
	-- Create Panel_pos17
	local Panel_pos17 = GUI:Layout_Create(Panel_1, "Panel_pos17", 175.00, 236.00, 180.00, 240.00, false)
	...
	-- Create Panel_pos21
	local Panel_pos21 = GUI:Layout_Create(Panel_1, "Panel_pos21", 175.00, 361.00, 50.00, 50.00, false)
	...
	-- Create Panel_pos45
	local Panel_pos45 = GUI:Layout_Create(Panel_1, "Panel_pos45", 245.00, 247.00, 85.00, 140.00, false)
	...
	-- Create Panel_pos18
	local Panel_pos18 = GUI:Layout_Create(Panel_1, "Panel_pos18", 68.00, 345.00, 120.00, 206.00, false)
	...
	local Text_guildinfo = GUI:Text_Create(Panel_1, "Text_guildinfo", 100.00, 450.00, 18, "#ffe400", [[]])
	...
	local Panel_pos1019 = GUI:Layout_Create(Panel_1, "Panel_pos1019", 315.00, 436.00, 51.00, 51.00, false)
	...
	local Panel_pos1021 = GUI:Layout_Create(Panel_1, "Panel_pos1021", 315.00, 376.00, 51.00, 51.00, false)
	...
	local Panel_pos1018 = GUI:Layout_Create(Panel_1, "Panel_pos1018", 37.00, 315.00, 51.00, 51.00, false)
	...
	local Panel_pos1017 = GUI:Layout_Create(Panel_1, "Panel_pos1017", 37.00, 255.00, 51.00, 51.00, false)
	...
	-- Create Panel_pos23
	local Panel_pos23 = GUI:Layout_Create(Panel_1, "Panel_pos23", 35.00, 187.00, 51.00, 51.00, false)
	...
	-- Create Panel_pos25
	local Panel_pos25 = GUI:Layout_Create(Panel_1, "Panel_pos25", 34.00, 124.00, 51.00, 51.00, false)
	...
	-- Create Panel_pos24
	local Panel_pos24 = GUI:Layout_Create(Panel_1, "Panel_pos24", 315.00, 124.00, 51.00, 51.00, false)
	...
	-- Create Panel_pos22
	local Panel_pos22 = GUI:Layout_Create(Panel_1, "Panel_pos22", 315.00, 187.00, 51.00, 51.00, false)
	...
	-- Create Panel_pos26
	local Panel_pos26 = GUI:Layout_Create(Panel_1, "Panel_pos26", 315.00, 59.00, 51.00, 51.00, false)
	...
	-- Create Panel_pos20
	local Panel_pos20 = GUI:Layout_Create(Panel_1, "Panel_pos20", 315.00, 251.00, 51.00, 51.00, false)
	...
	-- Create Panel_pos42
	local Panel_pos42 = GUI:Layout_Create(Panel_1, "Panel_pos42", 316.00, 312.00, 51.00, 51.00, false)
	...
	-- Create Panel_pos29
	local Panel_pos29 = GUI:Layout_Create(Panel_1, "Panel_pos29", 34.00, 61.00, 51.00, 51.00, false)
	...
	-- Create Panel_pos28
	local Panel_pos28 = GUI:Layout_Create(Panel_1, "Panel_pos28", 249.00, 61.00, 51.00, 51.00, false)
	...
	-- Create Panel_pos27
	local Panel_pos27 = GUI:Layout_Create(Panel_1, "Panel_pos27", 101.00, 61.00, 51.00, 51.00, false)
	...
	-- Create Panel_pos43
	local Panel_pos43 = GUI:Layout_Create(Panel_1, "Panel_pos43", 175.00, 60.00, 51.00, 51.00, false)
	...
	-- Create Node_1019
	local Node_1019 = GUI:Node_Create(Panel_1, "Node_1019", 315.00, 436.00)
	...
	-- Create Node_1021
	local Node_1021 = GUI:Node_Create(Panel_1, "Node_1021", 315.00, 376.00)
	...
	-- Create Node_1018
	local Node_1018 = GUI:Node_Create(Panel_1, "Node_1018", 37.00, 315.00)
	...
	-- Create Node_1017
	local Node_1017 = GUI:Node_Create(Panel_1, "Node_1017", 37.00, 255.00)
	...
	local CheckBox_shizhuang = GUI:CheckBox_Create(Panel_1, "CheckBox_shizhuang", 264.00, 411.00, "res/public/1900000550.png", "res/public/1900000551.png")
	...
	-- Create EquipShow
	local EquipShow = GUI:EquipShow_Create(Panel_1, "EquipShow", 282.00, 344.00, 21, false, {doubleTakeOff = true, look = true, movable = true, starLv = true, bgVisible = false})
