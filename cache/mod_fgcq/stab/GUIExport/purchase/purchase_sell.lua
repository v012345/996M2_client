...
function ui.init(parent)
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_1, "Button_close", 355.00, 338.00, "res/public/1900000510.png")
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_1, "Text_1", 61.00, 279.00, 16, "#ffffff", [[物品名称：]])
	GUI:setTouchEnabled(Text_1, false)
	GUI:setTag(Text_1, -1)
	GUI:Text_enableOutline(Text_1, "#000000", 1)

	-- Create Text_1_1
	local Text_1_1 = GUI:Text_Create(Panel_1, "Text_1_1", 61.00, 244.00, 16, "#ffffff", [[物品单价：]])
	GUI:setTouchEnabled(Text_1_1, false)
	GUI:setTag(Text_1_1, -1)
	GUI:Text_enableOutline(Text_1_1, "#000000", 1)

	-- Create Text_1_2
	local Text_1_2 = GUI:Text_Create(Panel_1, "Text_1_2", 61.00, 209.00, 16, "#ffffff", [[出售总价：]])
	GUI:setTouchEnabled(Text_1_2, false)
	GUI:setTag(Text_1_2, -1)
	GUI:Text_enableOutline(Text_1_2, "#000000", 1)

	-- Create Text_1_3
	local Text_1_3 = GUI:Text_Create(Panel_1, "Text_1_3", 61.00, 174.00, 16, "#ffffff", [[剩余数量：]])
	GUI:setTouchEnabled(Text_1_3, false)
	GUI:setTag(Text_1_3, -1)
	GUI:Text_enableOutline(Text_1_3, "#000000", 1)

	-- Create Text_1_4
	local Text_1_4 = GUI:Text_Create(Panel_1, "Text_1_4", 61.00, 139.00, 16, "#ffffff", [[拥有数量：]])
	GUI:setTouchEnabled(Text_1_4, false)
	GUI:setTag(Text_1_4, -1)
	GUI:Text_enableOutline(Text_1_4, "#000000", 1)

	-- Create Text_1_5
	local Text_1_5 = GUI:Text_Create(Panel_1, "Text_1_5", 61.00, 104.00, 16, "#ffffff", [[出售数量：]])
	GUI:setTouchEnabled(Text_1_5, false)
	GUI:setTag(Text_1_5, -1)
	GUI:Text_enableOutline(Text_1_5, "#000000", 1)

	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_1, "Text_name", 148.00, 279.00, 16, "#ffffff", [[物品名]])
	...
	-- Create Text_single
	local Text_single = GUI:Text_Create(Image_1_1, "Text_single", 60.00, 14.00, 16, "#ffffff", [[-]])
	...
	-- Create Text_coin_1
	local Text_coin_1 = GUI:Text_Create(Image_1_1, "Text_coin_1", 126.00, 14.00, 16, "#ffffff", [[元宝]])
	...
	-- Create Text_total
	local Text_total = GUI:Text_Create(Image_1_2, "Text_total", 60.00, 14.00, 16, "#ffffff", [[-]])
	...
	-- Create Text_coin_2
	local Text_coin_2 = GUI:Text_Create(Image_1_2, "Text_coin_2", 126.00, 14.00, 16, "#ffffff", [[元宝]])
	...
	-- Create Text_remain
	local Text_remain = GUI:Text_Create(Image_1_3, "Text_remain", 60.00, 14.00, 16, "#ffffff", [[-]])
	...
	-- Create Text_have
	local Text_have = GUI:Text_Create(Image_1_4, "Text_have", 60.00, 14.00, 16, "#ffffff", [[-]])
	...
	-- Create Input_sell
	local Input_sell = GUI:TextInput_Create(Panel_1, "Input_sell", 148.00, 102.00, 116.00, 24.00, 16)
	...
	local Button_confirm = GUI:Button_Create(Panel_1, "Button_confirm", 178.00, 56.00, "res/public/1900000660.png")
	GUI:Button_loadTexturePressed(Button_confirm, "res/public/1900000661.png")
	GUI:Button_setTitleText(Button_confirm, "确认出售")
	GUI:Button_setTitleColor(Button_confirm, "#f8e6c6")
	GUI:Button_setTitleFontSize(Button_confirm, 18)
