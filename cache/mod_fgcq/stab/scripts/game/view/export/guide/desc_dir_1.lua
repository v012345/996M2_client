...
Image_arrow:setPosition(-17.0000, 0.0000)
...
Node_desc:setPosition(-108.7181, 0.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(Node_desc)
layout:setLeftMargin(-108.7181)
layout:setRightMargin(108.7181)
