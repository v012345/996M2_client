local GUIQuickCell = class("GUIQuickCell", function() 
...
function GUIQuickCell:ctor()
    self._entered = false
    self._active = true
end

function GUIQuickCell:Create( data )
    local cell = GUIQuickCell.new()
...
function GUIQuickCell:Init( data )
    self._data = data
