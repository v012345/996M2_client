...
function ui.init(parent)
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_cells, "Text_1", 108.00, 16.00, 18, "#fffc98", [[]])
	...
	-- Create Text_3
	local Text_3 = GUI:Text_Create(Panel_cells, "Text_3", 239.00, 16.00, 18, "#f67c1a", [[]])
	...
	-- Create Text_4
	local Text_4 = GUI:Text_Create(Panel_cells, "Text_4", 370.00, 16.00, 16, "#ffffff", [[]])
