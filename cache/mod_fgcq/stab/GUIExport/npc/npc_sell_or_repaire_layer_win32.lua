...
function ui.init(parent)
	...
	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_1, "Image_bg", 180.00, 205.00, "res/public_win32/bg_npc_03.png")
	...
	-- Create Button_ok
	local Button_ok = GUI:Button_Create(Panel_1, "Button_ok", 156.00, 44.00, "res/public_win32/btn_npcsm_01.png")
	GUI:Button_loadTexturePressed(Button_ok, "res/public_win32/btn_npcsm_02.png")
	GUI:Button_setScale9Slice(Button_ok, 23, 24, 23, 24)
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_1, "Button_close", 190.00, 181.00, "res/public_win32/btn_close1.png")
	GUI:Button_loadTexturePressed(Button_close, "res/public_win32/btn_close2.png")
