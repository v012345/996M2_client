...
function ui.init(parent)
	...
	-- Create Panel_show
	local Panel_show = GUI:Layout_Create(Scene, "Panel_show", 0.00, 270.00, 84.00, 270.00, false)
	GUI:setAnchorPoint(Panel_show, 0.00, 1.00)
	GUI:setTouchEnabled(Panel_show, true)
	GUI:setTag(Panel_show, 154)

	-- Create Image_2
	local Image_2 = GUI:Image_Create(Panel_show, "Image_2", -1.00, 270.00, "res/private/trading_bank/1900000651_2.png")
	GUI:Image_setScale9Slice(Image_2, 21, 21, 21, 21)
	GUI:setContentSize(Image_2, 84, 270)
	...
	-- Create ListView_1
	local ListView_1 = GUI:ListView_Create(Panel_show, "ListView_1", 0.00, 270.00, 84.00, 270.00, 1)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Panel_show, "Panel_1", 0.00, 119.00, 84.00, 30.00, true)
	...
	GUI:setContentSize(Image_1, 84, 30)
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_1, "Text_1", 13.00, 15.00, 14, "#ffffff", [[区服名字]])
