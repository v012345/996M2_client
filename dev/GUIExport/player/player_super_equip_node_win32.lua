...
function ui.init(parent)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Node, "Panel_1", 0.00, 0.00, 374.00, 350.00, false)
	...
	-- Create Panel_pos18
	local Panel_pos18 = GUI:Layout_Create(Panel_1, "Panel_pos18", 117.00, 265.00, 80.73, 120.00, false)
	...
	-- Create Panel_pos45
	local Panel_pos45 = GUI:Layout_Create(Panel_1, "Panel_pos45", 235.00, 207.00, 43.00, 71.60, false)
	...
	local Panel_pos1019 = GUI:Layout_Create(Panel_1, "Panel_pos1019", 299.00, 295.00, 42.00, 42.00, false)
	...
	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_pos1021, "Image_bg", 21.00, 22.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/icon_chenghd_03.png")
	...
	local Panel_pos1018 = GUI:Layout_Create(Panel_1, "Panel_pos1018", 75.00, 205.00, 42.00, 42.00, false)
	...
	local Panel_pos1017 = GUI:Layout_Create(Panel_1, "Panel_pos1017", 75.00, 160.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos44
	local Panel_pos44 = GUI:Layout_Create(Panel_1, "Panel_pos44", 75.00, 24.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos42
	local Panel_pos42 = GUI:Layout_Create(Panel_1, "Panel_pos42", 328.00, 303.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos29
	local Panel_pos29 = GUI:Layout_Create(Panel_1, "Panel_pos29", 47.00, 52.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos43
	local Panel_pos43 = GUI:Layout_Create(Panel_1, "Panel_pos43", 187.00, 51.00, 42.00, 42.00, false)
	...
	-- Create Node_1019
	local Node_1019 = GUI:Node_Create(Panel_1, "Node_1019", 299.00, 295.00)
	...
	-- Create Node_1017
	local Node_1017 = GUI:Node_Create(Panel_1, "Node_1017", 75.00, 160.00)
	...
	-- Create Node_44
	local Node_44 = GUI:Node_Create(Panel_1, "Node_44", 75.00, 24.00)
	...
	-- Create Node_29
	local Node_29 = GUI:Node_Create(Panel_1, "Node_29", 47.00, 52.00)
	...
	-- Create Node_43
	local Node_43 = GUI:Node_Create(Panel_1, "Node_43", 187.00, 51.00)
	GUI:setChineseName(Node_43, "玩家时装_护身符_位置")
	GUI:setAnchorPoint(Node_43, 0.50, 0.50)
	GUI:setTag(Node_43, 183)

	-- Create Text_shizhuang
	local Text_shizhuang = GUI:Text_Create(Panel_1, "Text_shizhuang", 238.00, 362.00, 12, "#ffe400", [[时装外显示]])
	...
	local CheckBox_shizhuang = GUI:CheckBox_Create(Panel_1, "CheckBox_shizhuang", 224.00, 362.00, "res/public/1900000550.png", "res/public/1900000551.png")
