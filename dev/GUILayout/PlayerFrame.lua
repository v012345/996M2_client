...
function PlayerFrame.main(data)
    ...
    if HunZhuangState == "1" then
        ...
        GUI:setPositionX(PlayerFrame._ui.Button_qiYun,642)
        GUI:setPositionX(PlayerFrame._ui.Button_xiuXian,714)
        GUI:setPositionX(PlayerFrame._ui.Button_zhuangBan,786)
    end
