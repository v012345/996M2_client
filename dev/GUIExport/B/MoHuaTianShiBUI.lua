...
function ui.init(parent, __data__, __update__)
	...
	-- Create ImageBG
	local ImageBG = GUI:Image_Create(parent, "ImageBG", 0.00, 1.00, "res/custom/mohuatianshi/jm_2.png")
	...
	-- Create item_1
	local item_1 = GUI:Layout_Create(ImageBG, "item_1", 400.00, 369.00, 52, 52, false)
	GUI:setAnchorPoint(item_1, 0.00, 0.00)
	GUI:setTouchEnabled(item_1, true)
	GUI:setTag(item_1, 0)

	-- Create item_2
	local item_2 = GUI:Layout_Create(ImageBG, "item_2", 784.00, 369.00, 52, 52, false)
	GUI:setAnchorPoint(item_2, 0.00, 0.00)
	GUI:setTouchEnabled(item_2, true)
	GUI:setTag(item_2, 0)

	-- Create item_3
	local item_3 = GUI:Layout_Create(ImageBG, "item_3", 400.00, 257.00, 52, 52, false)
	GUI:setAnchorPoint(item_3, 0.00, 0.00)
	GUI:setTouchEnabled(item_3, true)
	GUI:setTag(item_3, 0)

	-- Create item_4
	local item_4 = GUI:Layout_Create(ImageBG, "item_4", 784.00, 257.00, 52, 52, false)
	GUI:setAnchorPoint(item_4, 0.00, 0.00)
	GUI:setTouchEnabled(item_4, true)
	GUI:setTag(item_4, 0)

	-- Create item_5
	local item_5 = GUI:Layout_Create(ImageBG, "item_5", 628.00, 333.00, 52, 52, false)
	GUI:setAnchorPoint(item_5, 0.00, 0.00)
	GUI:setTouchEnabled(item_5, true)
	GUI:setTag(item_5, 0)

	-- Create Button_1
	local Button_1 = GUI:Button_Create(ImageBG, "Button_1", 393.00, 129.00, "res/custom/mohuatianshi/an_2.png")
	...
	-- Create Button_2
	local Button_2 = GUI:Button_Create(ImageBG, "Button_2", 640.00, 129.00, "res/custom/mohuatianshi/an_3.png")
