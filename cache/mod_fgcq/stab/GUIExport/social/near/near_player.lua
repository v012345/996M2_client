...
function ui.init(parent)
	...
	-- Create CheckBox_add
	local CheckBox_add = GUI:CheckBox_Create(Panel_1, "CheckBox_add", 20.00, 410.00, "res/public/1900000654.png", "res/public/1900000655.png")
	...
	-- Create Text_permit
	local Text_permit = GUI:Text_Create(CheckBox_add, "Text_permit", 20.00, 9.00, 16, "#ffffff", [[允许添加]])
	...
	local CheckBox_team = GUI:CheckBox_Create(Panel_1, "CheckBox_team", 20.00, 380.00, "res/public/1900000654.png", "res/public/1900000655.png")
	...
	-- Create Text_permit
	local Text_permit = GUI:Text_Create(CheckBox_team, "Text_permit", 20.00, 9.00, 16, "#ffffff", [[允许组队]])
	...
	local CheckBox_deal = GUI:CheckBox_Create(Panel_1, "CheckBox_deal", 20.00, 350.00, "res/public/1900000654.png", "res/public/1900000655.png")
	...
	-- Create Text_permit
	local Text_permit = GUI:Text_Create(CheckBox_deal, "Text_permit", 20.00, 9.00, 16, "#ffffff", [[允许交易]])
	...
	local CheckBox_challenge = GUI:CheckBox_Create(Panel_1, "CheckBox_challenge", 20.00, 320.00, "res/public/1900000654.png", "res/public/1900000655.png")
	...
	-- Create Text_permit
	local Text_permit = GUI:Text_Create(CheckBox_challenge, "Text_permit", 20.00, 9.00, 16, "#ffffff", [[允许挑战]])
	...
	local CheckBox_show = GUI:CheckBox_Create(Panel_1, "CheckBox_show", 20.00, 290.00, "res/public/1900000654.png", "res/public/1900000655.png")
	...
	-- Create Text_permit
	local Text_permit = GUI:Text_Create(CheckBox_show, "Text_permit", 20.00, 9.00, 16, "#ffffff", [[允许显示]])
	...
	-- Create Panel_near
	local Panel_near = GUI:Layout_Create(Panel_1, "Panel_near", 0.00, 0.00, 732.00, 445.00, false)
	GUI:setChineseName(Panel_near, "附近_队伍组合")
	GUI:setTouchEnabled(Panel_near, false)
	GUI:setTag(Panel_near, 32)

	-- Create Image_2
	local Image_2 = GUI:Image_Create(Panel_near, "Image_2", 0.00, 52.00, "res/private/team/1900014008.png")
	GUI:setChineseName(Image_2, "附近_装饰条")
	GUI:setTouchEnabled(Image_2, false)
	GUI:setTag(Image_2, 95)

	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_near, "Text_name", 215.00, 432.00, 16, "#ffffff", [[队伍]])
	...
	-- Create Text_job
	local Text_job = GUI:Text_Create(Panel_near, "Text_job", 346.00, 432.00, 16, "#ffffff", [[职业]])
	...
	-- Create Text_level
	local Text_level = GUI:Text_Create(Panel_near, "Text_level", 427.00, 432.00, 16, "#ffffff", [[等级]])
	...
	-- Create Text_guild
	local Text_guild = GUI:Text_Create(Panel_near, "Text_guild", 528.00, 432.00, 16, "#ffffff", [[行会]])
	...
	local Text_operation = GUI:Text_Create(Panel_near, "Text_operation", 660.00, 432.00, 16, "#ffffff", [[操作]])
	...
	local ListView_near = GUI:ListView_Create(Panel_near, "ListView_near", 131.00, 58.00, 600.00, 360.00, 1)
