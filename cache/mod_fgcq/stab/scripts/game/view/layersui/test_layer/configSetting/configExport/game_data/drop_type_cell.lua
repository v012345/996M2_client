...
function ui.init(parent)
	-- Create click_cell
	local click_cell = GUI:Layout_Create(parent, "click_cell", 0.00, 0.00, 150.00, 40.00, false)
	GUI:setTouchEnabled(click_cell, true)
	GUI:setTag(click_cell, -1)

	-- Create Text_desc
	local Text_desc = GUI:Text_Create(click_cell, "Text_desc", 89.00, 20.00, 16, "#ffffff", [[开关:]])
	GUI:setAnchorPoint(Text_desc, 1.00, 0.50)
	GUI:setTouchEnabled(Text_desc, false)
	GUI:setTag(Text_desc, -1)
	GUI:setVisible(Text_desc, false)
	GUI:Text_enableOutline(Text_desc, "#000000", 1)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(click_cell, "Image_bg", 6.00, 6.00, "res/public/1900015004.png")
	GUI:setContentSize(Image_bg, 86, 26)
	GUI:setIgnoreContentAdaptWithSize(Image_bg, false)
	GUI:setTouchEnabled(Image_bg, false)
	GUI:setTag(Image_bg, -1)

	-- Create Input_name
	local Input_name = GUI:TextInput_Create(click_cell, "Input_name", 7.00, 6.00, 84.00, 25.00, 16)
	...
	local CheckBox_able = GUI:Layout_Create(click_cell, "CheckBox_able", 100.00, 19.00, 44.00, 18.00, false)
