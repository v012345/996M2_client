...
function ui.init(parent)
	-- Create member_cell
	local member_cell = GUI:Layout_Create(parent, "member_cell", 107.00, 330.00, 500.00, 24.00, false)
	GUI:setChineseName(member_cell, "队伍成员组合")
	GUI:setTouchEnabled(member_cell, true)
	GUI:setTag(member_cell, 49)

	-- Create Image_leader
	local Image_leader = GUI:Image_Create(member_cell, "Image_leader", 0.00, 12.00, "res/public/1900000678.png")
	GUI:Image_setScale9Slice(Image_leader, 26, 76, 5, 19)
	GUI:setContentSize(Image_leader, 500, 24)
	...
	-- Create Image_5
	local Image_5 = GUI:Image_Create(Image_leader, "Image_5", 15.00, 12.00, "res/private/team_win32/1900014001.png")
	...
	-- Create Image_4
	local Image_4 = GUI:Image_Create(member_cell, "Image_4", 250.00, 12.00, "res/private/team_win32/1900014010.png")
	...
	-- Create Label_name
	local Label_name = GUI:Text_Create(member_cell, "Label_name", 70.00, 13.00, 12, "#ffffff", [[玩家名字七个字]])
	...
	-- Create Label_job
	local Label_job = GUI:Text_Create(member_cell, "Label_job", 165.00, 13.00, 12, "#ffffff", [[战士]])
	...
	-- Create Label_level
	local Label_level = GUI:Text_Create(member_cell, "Label_level", 246.00, 13.00, 12, "#ffffff", [[等级]])
	...
	-- Create Label_guild
	local Label_guild = GUI:Text_Create(member_cell, "Label_guild", 335.00, 13.00, 12, "#ffffff", [[行会名字七个字]])
	...
	-- Create Label_map
	local Label_map = GUI:Text_Create(member_cell, "Label_map", 445.00, 13.00, 12, "#ffffff", [[地图名字七个字]])
