XinYueMiBaoGe1OBJ = {}
XinYueMiBaoGe1OBJ.__cname = "XinYueMiBaoGe1OBJ"
XinYueMiBaoGe1OBJ.ItemData = {
...
-------------------------------↓↓↓ UI操作 ↓↓↓---------------------------------------
function XinYueMiBaoGe1OBJ:main(objcfg)
    ...
    ------------------------↓↓↓ 通讯后端 ↓↓↓------------------------
    ssrMessage:sendmsg(ssrNetMsgCfg.XinYueMiBaoGe1_SyncResponse)
    ------------------------↑↑↑ 通讯后端 ↑↑↑------------------------
    ...
    GUI:addOnClickEvent(self.ui.Button_1, function()
        ssrMessage:sendmsg(ssrNetMsgCfg.XinYueMiBaoGe1_Request, 1)
    end)

    GUI:addOnClickEvent(self.ui.Button_2, function()
        ssrMessage:sendmsg(ssrNetMsgCfg.XinYueMiBaoGe1_Request, 2)
    end)
end

function XinYueMiBaoGe1OBJ:UpdateUI()
...
-------------------------------↓↓↓ 网络消息 ↓↓↓---------------------------------------
function XinYueMiBaoGe1OBJ:SyncResponse(TongXingZheng, RiChongNum, arg3, data)
