...
function ui.init(parent)
	...
	-- Create pBg
	local pBg = GUI:Image_Create(PPopUI, "pBg", 0.00, 0.00, "res/public/bg_hhdb_02.png")
	...
	-- Create ItemBg
	local ItemBg = GUI:Image_Create(PPopUI, "ItemBg", 80.00, 123.00, "res/public/bg_hhdb_item_bg.png")
	...
	-- Create ItemNode
	local ItemNode = GUI:Layout_Create(PPopUI, "ItemNode", 78.00, 124.00, 0.00, 0.00, false)
	...
	-- Create TextName
	local TextName = GUI:Text_Create(PPopUI, "TextName", 78.00, 74.00, 16, "#f69420", [[]])
	...
	GUI:Text_enableOutline(TextName, "#000000", 2)

	-- Create TextTime
	local TextTime = GUI:Text_Create(PPopUI, "TextTime", 134.00, 35.00, 16, "#ffffff", [[(5)]])
	...
	-- Create BtnUse
	local BtnUse = GUI:Button_Create(PPopUI, "BtnUse", 80.00, 36.00, "res/public/bg_hhdb_btn.png")
	...
	-- Create BtnClose
	local BtnClose = GUI:Button_Create(PPopUI, "BtnClose", 153.00, 157.00, "res/public/1900000510.png")
