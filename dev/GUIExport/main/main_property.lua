...
function ui.init(parent)
	...
	-- Create Image_4
	local Image_4 = GUI:Image_Create(Panel_bg, "Image_4", 429.00, 23.00, "res/private/main/1900012000.png")
	...
	-- Create Button_Store
	local Button_Store = GUI:Button_Create(Image_4, "Button_Store", 14.00, 0.00, "res/private/main/store1.png")
	GUI:Button_loadTexturePressed(Button_Store, "res/private/main/store2.png")
	GUI:Button_setTitleText(Button_Store, "")
	GUI:Button_setTitleColor(Button_Store, "#ffffff")
	GUI:Button_setTitleFontSize(Button_Store, 14)
	GUI:Button_titleEnableOutline(Button_Store, "#000000", 1)
	GUI:addOnClickEvent(Button_Store, function ()  ; if true then SL:JumpTo(9) end end)
	GUI:setChineseName(Button_Store, "打开商店")
	GUI:setTouchEnabled(Button_Store, true)
	GUI:setTag(Button_Store, -1)

	-- Create Button_Rank
	local Button_Rank = GUI:Button_Create(Image_4, "Button_Rank", 135.00, 0.00, "res/private/main/rank1.png")
	GUI:Button_loadTexturePressed(Button_Rank, "res/private/main/rank2.png")
	GUI:Button_setTitleText(Button_Rank, "")
	GUI:Button_setTitleColor(Button_Rank, "#ffffff")
	GUI:Button_setTitleFontSize(Button_Rank, 14)
	GUI:Button_titleEnableOutline(Button_Rank, "#000000", 1)
	GUI:addOnClickEvent(Button_Rank, function ()  ; if true then SL:JumpTo(32,1,2) end end)
	GUI:setChineseName(Button_Rank, "打开排行榜")
	GUI:setTouchEnabled(Button_Rank, true)
	GUI:setTag(Button_Rank, -1)
