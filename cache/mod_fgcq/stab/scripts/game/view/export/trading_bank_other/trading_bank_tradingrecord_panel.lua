...
function ui.init(parent)
	...
	-- Create Button_1
	local Button_1 = GUI:Button_Create(Panel_2, "Button_1", 322.00, 59.00, "res/private/trading_bank/1900000680.png")
	...
	-- Create Text_state
	local Text_state = GUI:Text_Create(Panel_2, "Text_state", 35.00, 459.00, 15, "#fb0000", [[交易成功]])
	...
	local Text_server_text = GUI:Text_Create(Panel_2, "Text_server_text", 37.00, 353.00, 14, "#e1d5b5", [[游戏区服:]])
	...
	local Text_goods_type_text = GUI:Text_Create(Panel_2, "Text_goods_type_text", 37.00, 323.00, 14, "#e1d5b5", [[商品类型:]])
	...
	local Text_goods_num_text = GUI:Text_Create(Panel_2, "Text_goods_num_text", 37.00, 291.00, 14, "#e1d5b5", [[商品编号:]])
	...
	local Text_goods_price_text = GUI:Text_Create(Panel_2, "Text_goods_price_text", 37.00, 259.00, 14, "#e1d5b5", [[商品价格:]])
	...
	local Text_goods_count_text = GUI:Text_Create(Panel_2, "Text_goods_count_text", 37.00, 230.00, 14, "#e1d5b5", [[商品件数:]])
	...
	local Text_real_money_text = GUI:Text_Create(Panel_2, "Text_real_money_text", 37.00, 200.00, 14, "#e1d5b5", [[实付款:]])
	...
	-- Create Text_getmoney_text
	local Text_getmoney_text = GUI:Text_Create(Panel_2, "Text_getmoney_text", 37.00, 169.00, 14, "#e1d5b5", [[到账交易币:]])
	GUI:setTouchEnabled(Text_getmoney_text, false)
	GUI:setTag(Text_getmoney_text, -1)
	GUI:Text_enableOutline(Text_getmoney_text, "#000000", 1)

	-- Create Text_will_getmoney_text
	local Text_will_getmoney_text = GUI:Text_Create(Panel_2, "Text_will_getmoney_text", 37.00, 142.00, 14, "#e1d5b5", [[待到账交易币:]])
	GUI:setTouchEnabled(Text_will_getmoney_text, false)
	GUI:setTag(Text_will_getmoney_text, -1)
	GUI:Text_enableOutline(Text_will_getmoney_text, "#000000", 1)

	-- Create Text_order_text
	local Text_order_text = GUI:Text_Create(Panel_2, "Text_order_text", 37.00, 50.00, 14, "#e1d5b5", [[订单编号:]])
	...
	local Text_time_text = GUI:Text_Create(Panel_2, "Text_time_text", 37.00, 21.00, 14, "#e1d5b5", [[下单时间:]])
	GUI:setTouchEnabled(Text_time_text, false)
	GUI:setTag(Text_time_text, -1)
	GUI:Text_enableOutline(Text_time_text, "#000000", 1)

	-- Create Text_desc
	local Text_desc = GUI:Text_Create(Panel_2, "Text_desc", 34.00, 89.00, 14, "#ffffff", [[卖出的商品在扣除服务费后会转化为交易币，交易币
可提现交易币和人民币的比例为1:1]])
	...
	-- Create Text_server
	local Text_server = GUI:Text_Create(Panel_2, "Text_server", 348.00, 353.00, 15, "#ffffff", [[天神一区]])
	...
	local Text_goods_type = GUI:Text_Create(Panel_2, "Text_goods_type", 348.00, 323.00, 15, "#ffffff", [[天神一区]])
	...
	local Text_goods_num = GUI:Text_Create(Panel_2, "Text_goods_num", 348.00, 291.00, 15, "#ffffff", [[天神一区]])
	...
	local Text_goods_price = GUI:Text_Create(Panel_2, "Text_goods_price", 348.00, 259.00, 15, "#ffffff", [[天神一区]])
	...
	local Text_goods_count = GUI:Text_Create(Panel_2, "Text_goods_count", 348.00, 230.00, 15, "#ffffff", [[天神一区]])
	...
	local Text_real_money = GUI:Text_Create(Panel_2, "Text_real_money", 348.00, 200.00, 15, "#ffffff", [[天神一区]])
	...
	-- Create Text_getmoney
	local Text_getmoney = GUI:Text_Create(Panel_2, "Text_getmoney", 348.00, 169.00, 15, "#ffffff", [[天神一区]])
	GUI:setAnchorPoint(Text_getmoney, 1.00, 0.00)
	GUI:setTouchEnabled(Text_getmoney, false)
	GUI:setTag(Text_getmoney, -1)
	GUI:Text_enableOutline(Text_getmoney, "#000000", 1)

	-- Create Text_will_getmoney
	local Text_will_getmoney = GUI:Text_Create(Panel_2, "Text_will_getmoney", 348.00, 142.00, 15, "#ffffff", [[天神一区]])
	GUI:setAnchorPoint(Text_will_getmoney, 1.00, 0.00)
	GUI:setTouchEnabled(Text_will_getmoney, false)
	GUI:setTag(Text_will_getmoney, -1)
	GUI:Text_enableOutline(Text_will_getmoney, "#000000", 1)

	-- Create Text_order
	local Text_order = GUI:Text_Create(Panel_2, "Text_order", 104.00, 50.00, 15, "#ffffff", [[123456789]])
	GUI:setTouchEnabled(Text_order, false)
	GUI:setTag(Text_order, -1)
	GUI:Text_enableOutline(Text_order, "#000000", 1)

	-- Create Text_time
	local Text_time = GUI:Text_Create(Panel_2, "Text_time", 104.00, 21.00, 15, "#ffffff", [[2020.1.1]])
