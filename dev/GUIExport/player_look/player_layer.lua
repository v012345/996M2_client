...
function ui.init(parent)
	...
	-- Create Text_Name
	local Text_Name = GUI:Text_Create(Panel_1, "Text_Name", 182.00, 474.00, 18, "#ffe400", [[]])
	...
	-- Create ButtonClose
	local ButtonClose = GUI:Button_Create(Panel_1, "ButtonClose", 670.00, 505.00, "res/public/1900000510.png")
	...
	local Panel_btnList = GUI:Layout_Create(Panel_1, "Panel_btnList", -127.00, 489.00, 116.00, 454.00, false)
	...
	-- Create Button_6
	local Button_6 = GUI:Button_Create(Panel_btnList, "Button_6", 0.00, 412.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Button_11
	local Button_11 = GUI:Button_Create(Panel_btnList, "Button_11", 0.00, 369.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Image_name
	local Image_name = GUI:Image_Create(Button_20, "Image_name", 28.00, 4.00, "res/private/player_main_layer_ui/name2.png")
	GUI:setTouchEnabled(Image_name, false)
	GUI:setTag(Image_name, -1)

	-- Create ImageTitle
	local ImageTitle = GUI:Image_Create(Panel_1, "ImageTitle", -14.00, 498.00, "res/private/player_main_layer_ui/title1.png")
	GUI:setTouchEnabled(ImageTitle, false)
	GUI:setTag(ImageTitle, -1)

	-- Create Button_qiYun
	local Button_qiYun = GUI:Button_Create(Panel_1, "Button_qiYun", 405.00, 426.00, "res/private/player_main_layer_ui/icon1.png")
