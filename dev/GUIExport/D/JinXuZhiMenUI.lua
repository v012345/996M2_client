...
function ui.init(parent)
	-- Create ImageBG
	local ImageBG = GUI:Image_Create(parent, "ImageBG", 0.00, 0.00, "res/custom/shijianmigong/jm_1.png")
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(ImageBG, "Text_1", 851.00, 194.00, 19, "#5ddd5a", [[0/0]])
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(ImageBG, "Panel_1", 670.00, 222.00, 65.00, 60.00, false)
	GUI:setTouchEnabled(Panel_1, true)
	GUI:setTag(Panel_1, 0)

	-- Create Button_1
	local Button_1 = GUI:Button_Create(ImageBG, "Button_1", 595.00, 72.00, "res/custom/public/btn_jinrufuben.png")
	...
	-- Create Effect
	local Effect = GUI:Effect_Create(ImageBG, "Effect", 177.00, 306.00, 4, 1, 0, 0, 0, 1)
	GUI:setScaleX(Effect, 0.97)
	GUI:setScaleY(Effect, 0.97)
	GUI:setTag(Effect, -1)
end
return ui