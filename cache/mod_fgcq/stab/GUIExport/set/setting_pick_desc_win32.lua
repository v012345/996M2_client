...
function ui.init(parent)
	...
	local Panel_PickDesc = GUI:Layout_Create(parent, "Panel_PickDesc", 0.00, 0.00, 606.00, 390.00, false)
	...
	-- Create Panel_2
	local Panel_2 = GUI:Layout_Create(Panel_PickDesc, "Panel_2", 303.00, 195.00, 430.00, 390.00, false)
	...
	GUI:setContentSize(Image_4, 430, 390)
	...
	-- Create Panel_title
	local Panel_title = GUI:Layout_Create(Panel_2, "Panel_title", 0.00, 388.00, 430.00, 50.00, false)
	...
	GUI:setTag(Text_pick_hang_up, 35)
	...
	-- Create ListView_1
	local ListView_1 = GUI:ListView_Create(Panel_2, "ListView_1", 215.00, 337.00, 430.00, 336.00, 1)
