...
function ui.init(parent)
	...
	-- Create Button_1
	local Button_1 = GUI:Button_Create(Image_bg, "Button_1", 457.89, 51.51, "res/private/trading_bank/1900000680.png")
	...
	-- Create Button_2
	local Button_2 = GUI:Button_Create(Image_bg, "Button_2", 609.26, 51.33, "res/private/trading_bank/1900000680.png")
	...
	-- Create Button_3
	local Button_3 = GUI:Button_Create(Image_bg, "Button_3", 671.52, 409.77, "res/private/trading_bank/1900001024.png")
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_1_1, "Text_1", 62.51, 322.00, 16, "#ffffff", [[步骤1:]])
	...
	-- Create Text_2
	local Text_2 = GUI:Text_Create(Panel_1_1, "Text_2", 271.11, 322.00, 16, "#ffffff", [[步骤2:]])
	...
	-- Create Text_3
	local Text_3 = GUI:Text_Create(Panel_1_1, "Text_3", 500.55, 322.00, 16, "#ffffff", [[步骤3:]])
	...
	-- Create Text_4
	local Text_4 = GUI:Text_Create(Panel_1_1, "Text_4", 87.51, 293.22, 16, "#01c52c", [[点击生成图片]])
	...
	-- Create Text_5
	local Text_5 = GUI:Text_Create(Panel_1_1, "Text_5", 352.61, 293.22, 16, "#01c52c", [[静候三秒将自动截取角色信息]])
	...
	-- Create Text_6
	local Text_6 = GUI:Text_Create(Panel_1_1, "Text_6", 557.55, 293.22, 16, "#01c52c", [[点击寄售角色完成寄售]])
	...
	-- Create Image_show3
	local Image_show3 = GUI:Image_Create(Panel_1_1, "Image_show3", 577.79, 202.12, "res/private/trading_bank/word_jiaoyh_025.png")
	...
	-- Create Image_jt
	local Image_jt = GUI:Image_Create(Image_show3, "Image_jt", 173.13, 47.05, "res/private/trading_bank/word_jiaoyh_020.png")
	...
	-- Create Image_show2
	local Image_show2 = GUI:Image_Create(Panel_1_1, "Image_show2", 357.26, 203.60, "res/private/trading_bank/word_jiaoyh_024.png")
	...
	-- Create Image_show1
	local Image_show1 = GUI:Image_Create(Panel_1_1, "Image_show1", 135.52, 205.07, "res/private/trading_bank/word_jiaoyh_023.png")
	...
	-- Create Image_jt
	local Image_jt = GUI:Image_Create(Image_show1, "Image_jt", 173.55, 47.08, "res/private/trading_bank/word_jiaoyh_020.png")
	GUI:setContentSize(Image_jt, 35.996398925781, 48)
	GUI:setIgnoreContentAdaptWithSize(Image_jt, false)
	GUI:setAnchorPoint(Image_jt, 0.50, 0.50)
	GUI:setTouchEnabled(Image_jt, false)
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_1_2, "Text_1", 355.55, 365.06, 16, "#ffffff", [[          点击图片生成按钮，自动截取关键页面数据，提高角色售卖概率截取图片过程中请不要进行其他操作，截取时间为三秒左右]])
	GUI:setIgnoreContentAdaptWithSize(Text_1,false)
	GUI:setContentSize(Text_1,650,55)
	GUI:setAnchorPoint(Text_1, 0.50, 0.50)
	GUI:setTouchEnabled(Text_1, false)
	...
	-- Create Button_4
	local Button_4 = GUI:Button_Create(Panel_1_2, "Button_4", 64.19, 410.85, "res/private/trading_bank/1900000611.png")
	...
	-- Create Panel_p
	local Panel_p = GUI:ScrollView_Create(Panel_1_2, "Panel_p", 19.14, 349.66, 680.00, 206.00, 1)
	...
	-- Create Image_cp
	local Image_cp = GUI:Image_Create(Panel_1_2, "Image_cp", 87.47, 307.15, "Default/ImageFile.png")
	...
	-- Create Panel_look
	local Panel_look = GUI:Layout_Create(Image_bg, "Panel_look", 358.11, 226.27, 1.00, 1.00, false)
	GUI:setAnchorPoint(Panel_look, 0.50, 0.50)
	GUI:setTouchEnabled(Panel_look, false)
	GUI:setTag(Panel_look, 333)

	-- Create Button_5
	local Button_5 = GUI:Button_Create(Image_bg, "Button_5", 724.95, 427.24, "res/private/trading_bank/1900000510.png")
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_3, "Text_1", 122.68, 148.34, 35, "#ffffff", [[寄售中:]])
	GUI:setAnchorPoint(Text_1, 0.50, 0.50)
	GUI:setTouchEnabled(Text_1, false)
	...
	-- Create Text_pp
	local Text_pp = GUI:Text_Create(Panel_3, "Text_pp", 122.06, 104.91, 35, "#ffffff", [[0%]])
