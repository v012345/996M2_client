...
function HeroFrame_Look.main(data)
    ...
    GUI:LoadExport(parent, "hero_look/hero_layer")
    ...
    --适配
    GUI:setPositionY(HeroFrame_Look._ui.Panel_1, SL:GetMetaValue("SCREEN_HEIGHT") / 2)
...
function HeroFrame_Look.ChangePage(data)
    ...
    HeroFrame_Look._pageid = data.index or SLDefine.PlayerPage.MAIN_PLAYER_LAYER_EQUIP
