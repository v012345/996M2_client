ShengChengMiBaoGeBOBJ = {}
ShengChengMiBaoGeBOBJ.__cname = "ShengChengMiBaoGeBOBJ"
ShengChengMiBaoGeBOBJ.ItemData = {
...
--ShengChengMiBaoGeBOBJ.config = ssrRequireCsvCfg("cfg_ShengChengMiBaoGeA")
-------------------------------↓↓↓ UI操作 ↓↓↓---------------------------------------
function ShengChengMiBaoGeBOBJ:main(objcfg)
    ...
    ------------------------↓↓↓ 通讯后端 ↓↓↓------------------------
    ssrMessage:sendmsg(ssrNetMsgCfg.ShengChengMiBaoGeB_SyncResponse)
    ------------------------↑↑↑ 通讯后端 ↑↑↑------------------------
    ...
    GUI:addOnClickEvent(self.ui.Button_1, function()
        ssrMessage:sendmsg(ssrNetMsgCfg.ShengChengMiBaoGeB_Request,1)
    end)

    GUI:addOnClickEvent(self.ui.Button_2, function()
        ssrMessage:sendmsg(ssrNetMsgCfg.ShengChengMiBaoGeB_Request,2)
    end)
...
function ShengChengMiBaoGeBOBJ:UpdateUI()
...
-------------------------------↓↓↓ 网络消息 ↓↓↓---------------------------------------
function ShengChengMiBaoGeBOBJ:SyncResponse(TongXingZheng, RiChongNum, arg3, data)
