...
function ui.init(parent, __data__, __update__)
	...
	-- Create CloseLayout
	local CloseLayout = GUI:Layout_Create(ImageBG, "CloseLayout", 354.00, 422.00, 75, 75, false)
	...
	-- Create EquipShow_1
	local EquipShow_1 = GUI:EquipShow_Create(Layout, "EquipShow_1", 78.00, 202.00, 101, false, {bgVisible = false, doubleTakeOff = true, look = true, movable = true, starLv = false, lookPlayer = false})
	...
	-- Create EquipShow_2
	local EquipShow_2 = GUI:EquipShow_Create(Layout, "EquipShow_2", 178.00, 202.00, 102, false, {bgVisible = false, doubleTakeOff = true, look = true, movable = true, starLv = false, lookPlayer = false})
	...
	-- Create EquipShow_3
	local EquipShow_3 = GUI:EquipShow_Create(Layout, "EquipShow_3", 0.00, 126.00, 103, false, {bgVisible = false, doubleTakeOff = true, look = true, movable = true, starLv = false, lookPlayer = false})
	...
	-- Create EquipShow_4
	local EquipShow_4 = GUI:EquipShow_Create(Layout, "EquipShow_4", 254.00, 126.00, 104, false, {bgVisible = false, doubleTakeOff = true, look = true, movable = true, starLv = false, lookPlayer = false})
	...
	-- Create EquipShow_5
	local EquipShow_5 = GUI:EquipShow_Create(Layout, "EquipShow_5", -3.00, 24.00, 105, false, {bgVisible = false, doubleTakeOff = true, look = true, movable = true, starLv = false, lookPlayer = false})
	...
	-- Create EquipShow_6
	local EquipShow_6 = GUI:EquipShow_Create(Layout, "EquipShow_6", 259.00, 24.00, 106, false, {bgVisible = false, doubleTakeOff = true, look = true, movable = true, starLv = false, lookPlayer = false})
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(ImageBG, "Text_1", 198.00, 96.00, 24, "#ffff00", [[0]])
