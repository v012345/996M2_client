...
function ui.init(parent)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Node, "Panel_1", 0.00, -63.00, 272.00, 349.00, false)
	GUI:setChineseName(Panel_1, "玩家装备_组合")
	GUI:setTouchEnabled(Panel_1, false)
	GUI:setTag(Panel_1, 137)

	-- Create Image_equippanel
	local Image_equippanel = GUI:Image_Create(Panel_1, "Image_equippanel", 138.00, 174.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015001_1.png")
	...
	local Node_playerModel = GUI:Node_Create(Panel_1, "Node_playerModel", 140.00, 217.00)
	GUI:setChineseName(Node_playerModel, "玩家装备_裸模")
	GUI:setTag(Node_playerModel, 139)

	-- Create Panel_pos0
	local Panel_pos0 = GUI:Layout_Create(Panel_1, "Panel_pos0", 136.00, 199.00, 80.00, 144.00, false)
	...
	-- Create Panel_pos1
	local Panel_pos1 = GUI:Layout_Create(Panel_1, "Panel_pos1", 80.00, 269.00, 60.00, 120.00, false)
	...
	-- Create Panel_pos16
	local Panel_pos16 = GUI:Layout_Create(Panel_1, "Panel_pos16", 183.00, 211.00, 43.00, 71.60, false)
	...
	-- Create Panel_pos4
	local Panel_pos4 = GUI:Layout_Create(Panel_1, "Panel_pos4", 138.00, 286.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos13
	local Panel_pos13 = GUI:Layout_Create(Panel_1, "Panel_pos13", 138.00, 286.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos55
	local Panel_pos55 = GUI:Layout_Create(Panel_1, "Panel_pos55", 138.00, 286.00, 42.00, 42.00, false)
	...
	local Panel_pos1001 = GUI:Layout_Create(Panel_1, "Panel_pos1001", 24.00, 284.00, 42.00, 42.00, false)
	...
	local Panel_pos1000 = GUI:Layout_Create(Panel_1, "Panel_pos1000", 24.00, 239.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos6
	local Panel_pos6 = GUI:Layout_Create(Panel_1, "Panel_pos6", -4.00, 178.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos8
	local Panel_pos8 = GUI:Layout_Create(Panel_1, "Panel_pos8", -4.00, 115.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos7
	local Panel_pos7 = GUI:Layout_Create(Panel_1, "Panel_pos7", 277.00, 115.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos5
	local Panel_pos5 = GUI:Layout_Create(Panel_1, "Panel_pos5", 277.00, 178.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos2
	local Panel_pos2 = GUI:Layout_Create(Panel_1, "Panel_pos2", 137.00, 52.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos3
	local Panel_pos3 = GUI:Layout_Create(Panel_1, "Panel_pos3", 277.00, 241.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos14
	local Panel_pos14 = GUI:Layout_Create(Panel_1, "Panel_pos14", 276.00, 52.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos15
	local Panel_pos15 = GUI:Layout_Create(Panel_1, "Panel_pos15", 205.00, 115.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos12
	local Panel_pos12 = GUI:Layout_Create(Panel_1, "Panel_pos12", -4.00, 52.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos11
	local Panel_pos11 = GUI:Layout_Create(Panel_1, "Panel_pos11", 206.00, 52.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos10
	local Panel_pos10 = GUI:Layout_Create(Panel_1, "Panel_pos10", 67.00, 52.00, 42.00, 42.00, false)
	...
	-- Create Panel_pos9
	local Panel_pos9 = GUI:Layout_Create(Panel_1, "Panel_pos9", 67.00, 115.00, 42.00, 42.00, false)
	...
	-- Create Best_ringBox
	local Best_ringBox = GUI:Layout_Create(Panel_1, "Best_ringBox", 253.00, 346.00, 46.00, 36.00, false)
	...
	local Best_ShouShiBox = GUI:Layout_Create(Panel_1, "Best_ShouShiBox", 235.00, 401.00, 80.00, 60.00, false)
	GUI:setChineseName(Best_ShouShiBox, "玩家装备_首饰盒组合")
	GUI:setTouchEnabled(Best_ShouShiBox, true)
	GUI:setTag(Best_ShouShiBox, 0)

	-- Create Image_box
	local Image_box = GUI:Image_Create(Best_ShouShiBox, "Image_box", 40.00, 30.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/btn_shoushi_1_0.png")
	...
	-- Create EquipShow
	local EquipShow = GUI:EquipShow_Create(Panel_1, "EquipShow", -36.00, 273.00, 1, false, {movable = false, lookPlayer = true, bgVisible = false, starLv = false, doubleTakeOff = false, look = true})
	GUI:setTag(EquipShow, -1)
	GUI:EquipShow_setAutoUpdate(EquipShow)

	-- Create EquipShow_1
	local EquipShow_1 = GUI:EquipShow_Create(Panel_1, "EquipShow_1", -36.00, 210.00, 0, false, {movable = false, lookPlayer = true, bgVisible = false, starLv = false, doubleTakeOff = false, look = true})
	GUI:setTag(EquipShow_1, -1)
	GUI:EquipShow_setAutoUpdate(EquipShow_1)

	-- Create EquipShow_1_1
	local EquipShow_1_1 = GUI:EquipShow_Create(Panel_1, "EquipShow_1_1", 245.00, 273.00, 4, false, {movable = false, lookPlayer = true, bgVisible = false, starLv = false, doubleTakeOff = false, look = true})
	GUI:setTag(EquipShow_1_1, -1)
	GUI:EquipShow_setAutoUpdate(EquipShow_1_1)

	-- Create Best_HunZhuangBox
	local Best_HunZhuangBox = GUI:Layout_Create(Panel_1, "Best_HunZhuangBox", 104.00, 89.00, 66.00, 56.00, false)
	...
	GUI:setChineseName(Image_huangzhuang, "玩家装备_魂装")
