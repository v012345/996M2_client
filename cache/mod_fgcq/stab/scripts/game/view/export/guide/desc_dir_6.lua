...
Image_arrow:setTag(50)
Image_arrow:setCascadeColorEnabled(true)
Image_arrow:setCascadeOpacityEnabled(true)
Image_arrow:setPosition(12.3438, -12.6512)
Image_arrow:setRotationSkewX(225.0000)
Image_arrow:setRotationSkewY(225.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(Image_arrow)
layout:setSize({width = 33.0000, height = 29.0000})
layout:setLeftMargin(-4.1562)
layout:setRightMargin(-28.8438)
layout:setTopMargin(-1.8488)
layout:setBottomMargin(-27.1512)
...
Node_desc:setPosition(98.9005, -55.2587)
layout = ccui.LayoutComponent:bindLayoutComponent(Node_desc)
layout:setLeftMargin(98.9005)
layout:setRightMargin(-98.9005)
layout:setTopMargin(55.2587)
layout:setBottomMargin(-55.2587)
