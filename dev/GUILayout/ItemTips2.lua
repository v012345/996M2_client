...
function ItemTips.CreateEquipPanel(data, itemData, isWear, panelInsertIndex)
    ...
    local r_name = GUI:Text_Create(contentPanel, "r_name", 60, 90, 21, "#ffffff", name)
    GUI:Text_setTextVerticalAlignment(r_name, 1)
    -- ==============================================================================
    
    local aji = GUI:Image_Create(contentPanel, "aji_ceshi", 3, 0,"res/public/88888.png")
    ItemTips.PushItem(contentPanel, aji)
    ItemTips.PushItem(contentPanel, r_name)
    ...
    GUI:setContentSize(ListBg, maxWidth, listH + 20)
