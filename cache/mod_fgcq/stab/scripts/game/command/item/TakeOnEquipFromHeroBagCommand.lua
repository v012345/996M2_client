local TakeOnEquipFromHeroBagCommand = class('TakeOnEquipFromHeroBagCommand', framework.SimpleCommand)

function TakeOnEquipFromHeroBagCommand:ctor()
end

function TakeOnEquipFromHeroBagCommand:execute(notification)--穿装备
    ...
    LuaSendMsg(global.MsgType.MSG_CS_HUM_TAKEON_FROM_HEROBAG, MakeIndex, pos, 0, 0, Name, string.len(Name))
end


return TakeOnEquipFromHeroBagCommand