...
function ui.init(parent)
	...
	local Node_bid_price = GUI:Node_Create(Panel_1, "Node_bid_price", 370.00, 35.00)
	GUI:setChineseName(Node_bid_price, "竞拍_竞价_货币节点")
	GUI:setAnchorPoint(Node_bid_price, 0.50, 0.50)
	GUI:setTag(Node_bid_price, 224)

	-- Create Text_status
	local Text_status = GUI:Text_Create(Panel_1, "Text_status", 400.00, 58.00, 12, "#28ef01", [[竞价被超过]])
	...
	-- Create Button_bid
	local Button_bid = GUI:Button_Create(Panel_1, "Button_bid", 400.00, 35.00, "res/public/1900000652.png")
	...
	-- Create Button_buy
	local Button_buy = GUI:Button_Create(Panel_1, "Button_buy", 550.00, 35.00, "res/public/1900000652.png")
	...
	local Text_unable_buy = GUI:Text_Create(Panel_1, "Text_unable_buy", 550.00, 35.00, 12, "#ff0500", [[无法一口价]])
	...
	-- Create Node_price
	local Node_price = GUI:Node_Create(Panel_1, "Node_price", 520.00, 35.00)
	GUI:setChineseName(Node_price, "竞拍_一口价_货币")
	GUI:setAnchorPoint(Node_price, 0.50, 0.50)
	GUI:setTag(Node_price, 229)

	-- Create Text_acquire
	local Text_acquire = GUI:Text_Create(Panel_1, "Text_acquire", 470.00, 35.00, 12, "#28ef01", [[竞拍成功]])
	...
	local Button_acquire = GUI:Button_Create(Panel_1, "Button_acquire", 550.00, 35.00, "res/public/1900000652.png")
	...
	GUI:Button_setTitleFontSize(Button_acquire, 12)
