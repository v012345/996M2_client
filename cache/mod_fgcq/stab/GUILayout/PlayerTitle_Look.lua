...
function PlayerTitle_Look.main(data)
    ...
    local path = "player_look/player_title_node"
    PlayerTitle_Look._resPath = SLDefine.PATH_RES_PRIVATE .. "title_layer_ui/"
...
function PlayerTitle_Look.refresh()
    ...
    if activateId then
        ...
        GUI:Text_setFontSize(PlayerTitle_Look._ui.Text_curTitle, 18)
    ...
    local cellPath = "player_look/title_cell.lua"
    for i = 1, count do
        local widget = GUI:Widget_Create(PlayerTitle_Look._ui.ListView_cells, "title_cell_" .. i, 0, 0, 348, 55)
