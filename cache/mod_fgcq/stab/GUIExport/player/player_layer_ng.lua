...
function ui.init(parent)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Scene, "Panel_1", 688.00, 340.00, 382.00, 595.00, false)
	...
	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_1, "Image_bg", 191.00, 298.00, "res/private/player_main_layer_ui/player_main_layer_ui_mobile/1900015000_ng.png")
	...
	-- Create Text_Name
	local Text_Name = GUI:Text_Create(Panel_1, "Text_Name", 191.00, 552.00, 18, "#ffe400", [[]])
	...
	-- Create ButtonClose
	local ButtonClose = GUI:Button_Create(Panel_1, "ButtonClose", 394.00, 511.00, "res/public/1900000510.png")
	...
	-- Create topLayout
	local topLayout = GUI:Layout_Create(Panel_1, "topLayout", 191.00, 490.00, 164.00, 35.00, false)
	...
	local Panel_btnList = GUI:Layout_Create(Panel_1, "Panel_btnList", 380.00, 478.00, 32.00, 454.00, false)
...
装]])
	...
	local Panel_btnList_ng = GUI:Layout_Create(Panel_1, "Panel_btnList_ng", 380.00, 478.00, 32.00, 454.00, false)
	...
	GUI:Button_setTitleFontSize(Button_1, 14)
	GUI:Button_titleEnableOutline(Button_1, "#000000", 1)
	GUI:setChineseName(Button_1, "玩家内功面板_状态_按钮")
	GUI:setAnchorPoint(Button_1, 0.00, 1.00)
	GUI:setTouchEnabled(Button_1, true)
	GUI:setTag(Button_1, -1)
...
态]])
	...
	GUI:Button_setTitleFontSize(Button_2, 14)
	GUI:Button_titleEnableOutline(Button_2, "#000000", 1)
	GUI:setChineseName(Button_2, "玩家内功面板_技能_按钮")
	GUI:setAnchorPoint(Button_2, 0.00, 1.00)
	GUI:setTouchEnabled(Button_2, true)
	GUI:setTag(Button_2, -1)
...
能]])
	...
	GUI:Button_setTitleFontSize(Button_3, 14)
	GUI:Button_titleEnableOutline(Button_3, "#000000", 1)
	GUI:setChineseName(Button_3, "玩家内功面板_经络_按钮")
	GUI:setAnchorPoint(Button_3, 0.00, 1.00)
	GUI:setTouchEnabled(Button_3, true)
	GUI:setTag(Button_3, -1)
...
络]])
	...
	GUI:Button_setTitleFontSize(Button_4, 14)
	GUI:Button_titleEnableOutline(Button_4, "#000000", 1)
	GUI:setChineseName(Button_4, "玩家内功面板_连击_按钮")
	GUI:setAnchorPoint(Button_4, 0.00, 1.00)
	GUI:setTouchEnabled(Button_4, true)
	GUI:setTag(Button_4, -1)
...
击]])
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Button_20, "Text_name", 22.00, 84.00, 16, "#807256", [[天
赋]])
