...
function ui.init(parent)
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_skill_cell, "Image_1", 140.00, 35.00, "res/private/player_skill-win32/1900015021.png")
	...
	local Text_skillLevel = GUI:Text_Create(Panel_skill_cell, "Text_skillLevel", 165.00, 35.00, 12, "#ffff0f", [[-]])
