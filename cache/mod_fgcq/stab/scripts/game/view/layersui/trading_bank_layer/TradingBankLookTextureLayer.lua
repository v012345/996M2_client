...
function TradingBankLookTextureLayer:Init(data)
    GUI:LoadInternalExport(self, "trading_bank/trading_bank_look_texture")
...
function TradingBankLookTextureLayer:onButtonClick(sender, type)
    ...
    if name == "Panel_1" then -- 取消
        global.Facade:sendNotification(global.NoticeTable.Layer_TradingBankLookTexture_Close)
    end
