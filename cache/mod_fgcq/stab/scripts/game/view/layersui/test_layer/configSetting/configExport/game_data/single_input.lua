...
function ui.init(parent)
	...
	-- Create input_bg
	local input_bg = GUI:Image_Create(panel_bg, "input_bg", 120.00, 275.00, "res/public/1900015004.png")
	...
	-- Create input_suffix
	local input_suffix = GUI:Text_Create(input_bg, "input_suffix", 110.00, 13.00, 16, "#ffffff", [[秒]])
	...
	-- Create input
	local input = GUI:TextInput_Create(input_bg, "input", 0.00, 0.00, 100.00, 25.00, 16)
	...
	-- Create input_prefix
	local input_prefix = GUI:Text_Create(panel_bg, "input_prefix", 120.00, 288.00, 16, "#ffffff", [[时间：]])
