...
function ui.init(parent)
	...
	local Panel_skill_cell = GUI:Layout_Create(parent, "Panel_skill_cell", 0.00, 0.00, 272.00, 50.00, false)
	GUI:setChineseName(Panel_skill_cell, "英雄技能_组合")
	GUI:setTouchEnabled(Panel_skill_cell, true)
	GUI:setTag(Panel_skill_cell, 14)

	-- Create Image_3
	local Image_3 = GUI:Image_Create(Panel_skill_cell, "Image_3", 60.00, 24.00, "res/private/player_skill-win32/1900015023.png")
	...
	GUI:setChineseName(Image_3, "英雄技能_背景图")
	...
	GUI:setChineseName(Image_icon, "英雄技能_技能图标")
	GUI:setAnchorPoint(Image_icon, 0.50, 0.50)
	GUI:setTouchEnabled(Image_icon, false)
	GUI:setTag(Image_icon, 14)

	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_skill_cell, "Image_1", 155.00, 35.00, "res/private/player_skill-win32/1900015021.png")
	GUI:setChineseName(Image_1, "英雄技能_Lv图片")
	GUI:setAnchorPoint(Image_1, 0.00, 0.50)
	GUI:setTouchEnabled(Image_1, false)
	GUI:setTag(Image_1, 16)

	-- Create Image_2
	local Image_2 = GUI:Image_Create(Panel_skill_cell, "Image_2", 65.00, 15.00, "res/private/player_skill-win32/1900015020.png")
	GUI:setChineseName(Image_2, "英雄技能_Exp图片")
	GUI:setAnchorPoint(Image_2, 0.00, 0.50)
	GUI:setTouchEnabled(Image_2, false)
	GUI:setTag(Image_2, 17)

	-- Create Text_skillName
	local Text_skillName = GUI:Text_Create(Panel_skill_cell, "Text_skillName", 65.00, 35.00, 12, "#ffffff", [[技能名称]])
	GUI:setChineseName(Text_skillName, "英雄技能_技能名称_文本")
	...
	local Text_skillLevel = GUI:Text_Create(Panel_skill_cell, "Text_skillLevel", 180.00, 35.00, 12, "#ffff0f", [[-]])
	GUI:setChineseName(Text_skillLevel, "英雄技能_技能等级")
	...
	local Text_skillTrain = GUI:Text_Create(Panel_skill_cell, "Text_skillTrain", 100.00, 15.00, 12, "#ffffff", [[-]])
	GUI:setChineseName(Text_skillTrain, "英雄技能_技能经验_文本")
	...
	-- Create Text_levelup
	local Text_levelup = GUI:Text_Create(Panel_skill_cell, "Text_levelup", 65.00, 15.00, 12, "#ffffff", [[强化-重]])
	GUI:setChineseName(Text_levelup, "英雄技能_强化等级")
	...
	-- Create Image_key
	local Image_key = GUI:Image_Create(Panel_skill_cell, "Image_key", 265.00, 40.00, "res/private/player_skill-win32/word_anzi_1.png")
	GUI:setChineseName(Image_key, "英雄技能_快捷键")
