...
function HeroSkill.main(data)
    ...
    GUI:LoadExport(parent, "hero/hero_skill_node")
    ...
    if data and data.typeCapture == 1 then
        local list = HeroSkill._ui.ListView_cells
        GUI:ListView_setClippingEnabled(list,false)
        GUI:setVisible(HeroSkill._ui.Image_5, false)
        GUI:setVisible(HeroSkill._ui.Button_setting, false)
...
function HeroSkill.UpdateSkillCell(skillID)
    ...
    if not btn1 then
        btn1 = GUI:Button_Create(panel, "text_onoff", 300, 40, "")
