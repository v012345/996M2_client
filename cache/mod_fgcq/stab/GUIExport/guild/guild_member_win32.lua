...
function ui.init(parent)
	...
	-- Create Image_bg
	local Image_bg = GUI:Image_Create(PMainUI, "Image_bg", 303.00, 30.00, "res/public/bg_hhdb_01.jpg")
	GUI:Image_setScale9Slice(Image_bg, 246, 244, 22, 20)
	GUI:setContentSize(Image_bg, 606, 64)
	...
	-- Create Image_line2
	local Image_line2 = GUI:Image_Create(Image_line, "Image_line2", 245.00, 0.00, "res/public/bg_yyxsz_02.png")
	...
	-- Create Image_line3
	local Image_line3 = GUI:Image_Create(Image_line, "Image_line3", 360.00, 0.00, "res/public/bg_yyxsz_02.png")
	...
	-- Create Image_line4
	local Image_line4 = GUI:Image_Create(Image_line, "Image_line4", 500.00, 0.00, "res/public/bg_yyxsz_02.png")
	...
	-- Create BtnApplyList
	local BtnApplyList = GUI:Button_Create(PMainUI, "BtnApplyList", 425.00, 30.00, "res/public_win32/1900000660.png")
	GUI:Button_loadTexturePressed(BtnApplyList, "res/public_win32/1900000661.png")
	GUI:Button_setScale9Slice(BtnApplyList, 15, 15, 11, 11)
	GUI:setContentSize(BtnApplyList, 79, 30)
	...
	GUI:Button_setTitleFontSize(BtnApplyList, 14)
	...
	-- Create BtnDissolve
	local BtnDissolve = GUI:Button_Create(PMainUI, "BtnDissolve", 550.00, 30.00, "res/public_win32/1900000660.png")
	GUI:Button_loadTexturePressed(BtnDissolve, "res/public_win32/1900000661.png")
	GUI:Button_setScale9Slice(BtnDissolve, 15, 15, 11, 11)
	GUI:setContentSize(BtnDissolve, 79, 30)
	...
	GUI:Button_setTitleFontSize(BtnDissolve, 14)
	...
	-- Create BtnEditTitle
	local BtnEditTitle = GUI:Button_Create(PMainUI, "BtnEditTitle", 300.00, 30.00, "res/public_win32/1900000660.png")
	GUI:Button_loadTexturePressed(BtnEditTitle, "res/public_win32/1900000661.png")
	GUI:Button_setScale9Slice(BtnEditTitle, 15, 15, 11, 11)
	GUI:setContentSize(BtnEditTitle, 79, 30)
	...
	GUI:Button_setTitleFontSize(BtnEditTitle, 14)
	...
	-- Create BtnQuit
	local BtnQuit = GUI:Button_Create(PMainUI, "BtnQuit", 550.00, 30.00, "res/public_win32/1900000660.png")
	GUI:Button_loadTexturePressed(BtnQuit, "res/public_win32/1900000661.png")
	GUI:Button_setScale9Slice(BtnQuit, 15, 15, 11, 11)
	GUI:setContentSize(BtnQuit, 79, 30)
	...
	GUI:Button_setTitleFontSize(BtnQuit, 14)
	...
	-- Create LabelOnline
	local LabelOnline = GUI:Text_Create(PMainUI, "LabelOnline", 20.00, 30.00, 12, "#28ef01", [[在线人数:]])
	...
	-- Create MemberList
	local MemberList = GUI:ListView_Create(PMainUI, "MemberList", 0.00, 62.00, 606.00, 290.00, 1)
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(PMainUI, "Text_name", 68.00, 370.00, 12, "#ffffff", [[玩家名字]])
	...
	-- Create Text_level
	local Text_level = GUI:Text_Create(PMainUI, "Text_level", 195.00, 370.00, 12, "#ffffff", [[等级]])
	...
	-- Create TouchSize
	local TouchSize = GUI:Layout_Create(Text_level, "TouchSize", 34.00, 8.00, 58.00, 25.50, false)
	...
	-- Create Text_job
	local Text_job = GUI:Text_Create(PMainUI, "Text_job", 305.00, 370.00, 12, "#ffffff", [[职业]])
	...
	local Text_official = GUI:Text_Create(PMainUI, "Text_official", 430.00, 370.00, 12, "#ffffff", [[职务]])
	...
	-- Create Text_state
	local Text_state = GUI:Text_Create(PMainUI, "Text_state", 555.00, 370.00, 12, "#ffffff", [[状态]])
	...
	-- Create Image_none
	local Image_none = GUI:Image_Create(PMainUI, "Image_none", 303.00, 195.00, "res/private/guild_ui/word_hhzy_12.png")
	...
	-- Create BtnLevel
	local BtnLevel = GUI:Button_Create(PMainUI, "BtnLevel", 229.00, 370.00, "res/public/btn_szjm_01.png")
	...
	-- Create BtnJob
	local BtnJob = GUI:Button_Create(PMainUI, "BtnJob", 340.00, 370.00, "res/public/btn_szjm_01.png")
	...
	-- Create BtnOfficial
	local BtnOfficial = GUI:Button_Create(PMainUI, "BtnOfficial", 480.00, 370.00, "res/public/btn_szjm_01.png")
	...
	-- Create FilterLevel
	local FilterLevel = GUI:Image_Create(PMainUI, "FilterLevel", 197.00, 350.00, "res/public/1900000677.png")
	GUI:Image_setScale9Slice(FilterLevel, 21, 21, 37, 29)
	...
	-- Create Text
	local Text = GUI:Text_Create(filter1, "Text", 50.00, 13.00, 12, "#ffffff", [[由高至低]])
	...
	-- Create Text
	local Text = GUI:Text_Create(filter2, "Text", 50.00, 13.00, 12, "#ffffff", [[由低至高]])
	...
	-- Create FilterJob
	local FilterJob = GUI:Image_Create(PMainUI, "FilterJob", 306.00, 350.00, "res/public/1900000677.png")
	GUI:Image_setScale9Slice(FilterJob, 21, 21, 37, 29)
	...
	-- Create Text
	local Text = GUI:Text_Create(filter0, "Text", 50.00, 13.00, 12, "#ffffff", [[全部]])
	...
	-- Create Text
	local Text = GUI:Text_Create(filter1, "Text", 50.00, 13.00, 12, "#ffffff", [[战士]])
	...
	-- Create Text
	local Text = GUI:Text_Create(filter2, "Text", 50.00, 13.00, 12, "#ffffff", [[法师]])
	...
	-- Create Text
	local Text = GUI:Text_Create(filter3, "Text", 50.00, 13.00, 12, "#ffffff", [[道士]])
	...
	local FilterOfficial = GUI:Image_Create(PMainUI, "FilterOfficial", 430.00, 350.00, "res/public/1900000677.png")
	GUI:Image_setScale9Slice(FilterOfficial, 21, 21, 37, 29)
	GUI:setContentSize(FilterOfficial, 130, 182)
	...
	-- Create ListView_filter
	local ListView_filter = GUI:ListView_Create(FilterOfficial, "ListView_filter", 65.00, 7.00, 120.00, 168.00, 1)
	GUI:ListView_setGravity(ListView_filter, 2)
	GUI:ListView_setItemsMargin(ListView_filter, 2)
	...
	-- Create filter0
	local filter0 = GUI:Layout_Create(ListView_filter, "filter0", 0.00, 142.00, 120.00, 26.00, false)
	GUI:setChineseName(filter0, "职务_全部下拉_组合")
	GUI:setTouchEnabled(filter0, true)
	GUI:setTag(filter0, 0)

	-- Create Image_select
	local Image_select = GUI:Image_Create(filter0, "Image_select", 60.00, 13.00, "res/public/1900000678.png")
	GUI:setContentSize(Image_select, 120, 26)
	GUI:setIgnoreContentAdaptWithSize(Image_select, false)
	...
	-- Create Text
	local Text = GUI:Text_Create(filter0, "Text", 60.00, 13.00, 12, "#ffffff", [[全部]])
	...
	-- Create filter1
	local filter1 = GUI:Layout_Create(ListView_filter, "filter1", 0.00, 114.00, 120.00, 26.00, false)
	GUI:setChineseName(filter1, "职务_会长下拉_组合")
	GUI:setTouchEnabled(filter1, true)
	GUI:setTag(filter1, 1)

	-- Create Image_select
	local Image_select = GUI:Image_Create(filter1, "Image_select", 60.00, 13.00, "res/public/1900000678.png")
	GUI:setContentSize(Image_select, 120, 26)
	GUI:setIgnoreContentAdaptWithSize(Image_select, false)
	...
	-- Create Text
	local Text = GUI:Text_Create(filter1, "Text", 60.00, 13.00, 12, "#ffffff", [[会长]])
	...
	-- Create filter2
	local filter2 = GUI:Layout_Create(ListView_filter, "filter2", 0.00, 86.00, 120.00, 26.00, false)
	GUI:setChineseName(filter2, "职务_精英下拉_组合")
	GUI:setTouchEnabled(filter2, true)
	GUI:setTag(filter2, 2)

	-- Create Image_select
	local Image_select = GUI:Image_Create(filter2, "Image_select", 60.00, 13.00, "res/public/1900000678.png")
	GUI:setContentSize(Image_select, 120, 26)
	GUI:setIgnoreContentAdaptWithSize(Image_select, false)
	...
	-- Create Text
	local Text = GUI:Text_Create(filter2, "Text", 60.00, 13.00, 12, "#ffffff", [[精英]])
	...
	-- Create filter3
	local filter3 = GUI:Layout_Create(ListView_filter, "filter3", 0.00, 58.00, 120.00, 26.00, false)
	GUI:setChineseName(filter3, "职务_会员下拉_组合")
	GUI:setTouchEnabled(filter3, true)
	GUI:setTag(filter3, 3)

	-- Create Image_select
	local Image_select = GUI:Image_Create(filter3, "Image_select", 60.00, 13.00, "res/public/1900000678.png")
	GUI:setContentSize(Image_select, 120, 26)
	GUI:setIgnoreContentAdaptWithSize(Image_select, false)
	...
	-- Create Text
	local Text = GUI:Text_Create(filter3, "Text", 60.00, 13.00, 12, "#ffffff", [[会员]])
	...
	-- Create filter4
	local filter4 = GUI:Layout_Create(ListView_filter, "filter4", 0.00, 30.00, 120.00, 26.00, false)
	GUI:setChineseName(filter4, "职务_会员下拉_组合")
	GUI:setTouchEnabled(filter4, true)
	GUI:setTag(filter4, 4)

	-- Create Image_select
	local Image_select = GUI:Image_Create(filter4, "Image_select", 60.00, 13.00, "res/public/1900000678.png")
	GUI:setContentSize(Image_select, 120, 26)
	GUI:setIgnoreContentAdaptWithSize(Image_select, false)
	GUI:setChineseName(Image_select, "职务_会员_选中背景图")
	GUI:setAnchorPoint(Image_select, 0.50, 0.50)
	...
	-- Create Text
	local Text = GUI:Text_Create(filter4, "Text", 60.00, 13.00, 12, "#ffffff", [[会员]])
	GUI:setChineseName(Text, "职务_会员_文本")
	GUI:setAnchorPoint(Text, 0.50, 0.50)
	GUI:setTouchEnabled(Text, false)
	GUI:setTag(Text, 144)
	...
	-- Create filter5
	local filter5 = GUI:Layout_Create(ListView_filter, "filter5", 0.00, 2.00, 120.00, 26.00, false)
	GUI:setChineseName(filter5, "职务_会员下拉_组合")
	GUI:setTouchEnabled(filter5, true)
	GUI:setTag(filter5, 5)

	-- Create Image_select
	local Image_select = GUI:Image_Create(filter5, "Image_select", 60.00, 13.00, "res/public/1900000678.png")
	GUI:setContentSize(Image_select, 120, 26)
	GUI:setIgnoreContentAdaptWithSize(Image_select, false)
	GUI:setChineseName(Image_select, "职务_会员_选中背景图")
	GUI:setAnchorPoint(Image_select, 0.50, 0.50)
	...
	-- Create Text
	local Text = GUI:Text_Create(filter5, "Text", 60.00, 13.00, 12, "#ffffff", [[会员]])
	GUI:setChineseName(Text, "职务_会员_文本")
	GUI:setAnchorPoint(Text, 0.50, 0.50)
	GUI:setTouchEnabled(Text, false)
	GUI:setTag(Text, 147)
