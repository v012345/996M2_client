...
function ui.init(parent)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Node, "Panel_1", 0.00, -50.00, 348.00, 478.00, false)
	...
	-- Create Image_11
	local Image_11 = GUI:Image_Create(Image_cur, "Image_11", 80.00, 26.00, "res/private/title_layer_ui/title_1.png")
