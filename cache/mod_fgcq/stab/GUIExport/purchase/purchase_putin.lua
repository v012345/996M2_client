...
function ui.init(parent)
	...
	-- Create TitleText
	local TitleText = GUI:Text_Create(FrameLayout, "TitleText", 104.00, 486.00, 20, "#d8c8ae", [[我要求购]])
	...
	-- Create Panel_search
	local Panel_search = GUI:Layout_Create(PMainUI, "Panel_search", 236.00, 406.00, 220.00, 35.00, false)
	...
	local ListView_filter_1 = GUI:ListView_Create(PMainUI, "ListView_filter_1", 62.00, 400.00, 125.00, 400.00, 1)
	...
	local ListView_filter_2 = GUI:ListView_Create(PMainUI, "ListView_filter_2", 192.00, 400.00, 125.00, 400.00, 1)
	...
	-- Create Layout_item
	local Layout_item = GUI:Layout_Create(PMainUI, "Layout_item", 258.00, 400.00, 200.00, 400.00, false)
	...
	local ListView_item = GUI:ListView_Create(Layout_item, "ListView_item", 0.00, 0.00, 200.00, 400.00, 1)
	GUI:ListView_setBackGroundImage(ListView_item, "res/public/1900000610799.png")
	GUI:ListView_setBackGroundImageScale9Slice(ListView_item, 0, 205, 0, 410)
	...
	local Panel_hide_filter = GUI:Layout_Create(PMainUI, "Panel_hide_filter", 0.00, 0.00, 732.00, 445.00, false)
	GUI:setTouchEnabled(Panel_hide_filter, true)
	GUI:setTag(Panel_hide_filter, 45)
	GUI:setVisible(Panel_hide_filter, false)

	-- Create Layout_param
	local Layout_param = GUI:Layout_Create(PMainUI, "Layout_param", 460.00, 400.00, 270.00, 400.00, false)
	GUI:setAnchorPoint(Layout_param, 0.00, 1.00)
	GUI:setTouchEnabled(Layout_param, false)
	GUI:setTag(Layout_param, -1)

	-- Create Text_1
	local Text_1 = GUI:Text_Create(Layout_param, "Text_1", 2.00, 378.00, 16, "#ffffff", [[求购配置：]])
	GUI:setTouchEnabled(Text_1, false)
	GUI:setTag(Text_1, -1)
	GUI:Text_enableOutline(Text_1, "#000000", 1)

	-- Create Text_2
	local Text_2 = GUI:Text_Create(Layout_param, "Text_2", 16.00, 350.00, 16, "#ffffff", [[物品名称：]])
	GUI:setTouchEnabled(Text_2, false)
	GUI:setTag(Text_2, -1)
	GUI:Text_enableOutline(Text_2, "#000000", 1)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Text_2, "Image_bg", 74.00, -5.00, "res/public/1900000676.png")
	GUI:Image_setScale9Slice(Image_bg, 24, 25, 10, 11)
	GUI:setContentSize(Image_bg, 174, 31)
	GUI:setIgnoreContentAdaptWithSize(Image_bg, false)
	GUI:setTouchEnabled(Image_bg, false)
	GUI:setTag(Image_bg, -1)

	-- Create Text_3
	local Text_3 = GUI:Text_Create(Layout_param, "Text_3", 16.00, 318.00, 16, "#ffffff", [[货币类型：]])
	GUI:setTouchEnabled(Text_3, false)
	GUI:setTag(Text_3, -1)
	GUI:Text_enableOutline(Text_3, "#000000", 1)

	-- Create Panel_currency
	local Panel_currency = GUI:Layout_Create(Layout_param, "Panel_currency", 90.00, 314.00, 120.00, 30.00, false)
	...
	local Text_coin_type = GUI:Text_Create(Panel_currency, "Text_coin_type", 6.00, 16.00, 16, "#ffffff", [[元宝]])
	...
	local Image_filter_c = GUI:Image_Create(Text_coin_type, "Image_filter_c", 78.00, 10.00, "res/public/btn_szjm_01.png")
	GUI:setAnchorPoint(Image_filter_c, 0.00, 0.50)
	GUI:setTouchEnabled(Image_filter_c, true)
	GUI:setTag(Image_filter_c, -1)

	-- Create Text_4
	local Text_4 = GUI:Text_Create(Layout_param, "Text_4", 16.00, 286.00, 16, "#ffffff", [[求购单价：]])
	GUI:setTouchEnabled(Text_4, false)
	GUI:setTag(Text_4, -1)
	GUI:Text_enableOutline(Text_4, "#000000", 1)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Text_4, "Image_bg", 74.00, -5.00, "res/public/1900000676.png")
	GUI:Image_setScale9Slice(Image_bg, 24, 25, 10, 11)
	GUI:setContentSize(Image_bg, 174, 31)
	GUI:setIgnoreContentAdaptWithSize(Image_bg, false)
	GUI:setTouchEnabled(Image_bg, false)
	...
	-- Create Input_single
	local Input_single = GUI:TextInput_Create(Text_4, "Input_single", 76.00, -1.00, 168.00, 25.00, 16)
	...
	-- Create Text_5
	local Text_5 = GUI:Text_Create(Layout_param, "Text_5", 16.00, 254.00, 16, "#ffffff", [[求购数量：]])
	GUI:setTouchEnabled(Text_5, false)
	GUI:setTag(Text_5, -1)
	GUI:Text_enableOutline(Text_5, "#000000", 1)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Text_5, "Image_bg", 74.00, -5.00, "res/public/1900000676.png")
	GUI:Image_setScale9Slice(Image_bg, 24, 25, 10, 11)
	GUI:setContentSize(Image_bg, 174, 31)
	GUI:setIgnoreContentAdaptWithSize(Image_bg, false)
	GUI:setTouchEnabled(Image_bg, false)
	...
	-- Create Input_num
	local Input_num = GUI:TextInput_Create(Text_5, "Input_num", 76.00, -1.00, 168.00, 25.00, 16)
	...
	-- Create Text_6
	local Text_6 = GUI:Text_Create(Layout_param, "Text_6", 16.00, 222.00, 16, "#ffffff", [[最小数量：]])
	GUI:setTouchEnabled(Text_6, false)
	GUI:setTag(Text_6, -1)
	GUI:Text_enableOutline(Text_6, "#000000", 1)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Text_6, "Image_bg", 74.00, -5.00, "res/public/1900000676.png")
	GUI:Image_setScale9Slice(Image_bg, 24, 25, 10, 11)
	GUI:setContentSize(Image_bg, 174, 31)
	GUI:setIgnoreContentAdaptWithSize(Image_bg, false)
	GUI:setTouchEnabled(Image_bg, false)
	...
	local Input_min_num = GUI:TextInput_Create(Text_6, "Input_min_num", 76.00, -1.00, 168.00, 25.00, 16)
	...
	-- Create Text_2_1
	local Text_2_1 = GUI:Text_Create(Layout_param, "Text_2_1", 2.00, 170.00, 16, "#ffffff", [[物品信息：]])
	GUI:setTouchEnabled(Text_2_1, false)
	GUI:setTag(Text_2_1, -1)
	GUI:Text_enableOutline(Text_2_1, "#000000", 1)

	-- Create Text_2_2
	local Text_2_2 = GUI:Text_Create(Layout_param, "Text_2_2", 16.00, 140.00, 16, "#ffffff", [[物品底价：]])
	GUI:setTouchEnabled(Text_2_2, false)
	GUI:setTag(Text_2_2, -1)
	GUI:Text_enableOutline(Text_2_2, "#000000", 1)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Text_2_2, "Image_bg", 74.00, -5.00, "res/public/1900000676.png")
	GUI:Image_setScale9Slice(Image_bg, 24, 25, 10, 11)
	GUI:setContentSize(Image_bg, 174, 31)
	GUI:setIgnoreContentAdaptWithSize(Image_bg, false)
	GUI:setTouchEnabled(Image_bg, false)
	...
	local Text_price_base = GUI:Text_Create(Text_2_2, "Text_price_base", 82.00, 0.00, 16, "#ffffff", [[-]])
	GUI:setTouchEnabled(Text_price_base, false)
	GUI:setTag(Text_price_base, -1)
	GUI:Text_enableOutline(Text_price_base, "#000000", 1)

	-- Create Text_2_3
	local Text_2_3 = GUI:Text_Create(Layout_param, "Text_2_3", 16.00, 108.00, 16, "#ffffff", [[物品总价：]])
	GUI:setTouchEnabled(Text_2_3, false)
	GUI:setTag(Text_2_3, -1)
	GUI:Text_enableOutline(Text_2_3, "#000000", 1)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Text_2_3, "Image_bg", 74.00, -5.00, "res/public/1900000676.png")
	GUI:Image_setScale9Slice(Image_bg, 24, 25, 10, 11)
	GUI:setContentSize(Image_bg, 174, 31)
	GUI:setIgnoreContentAdaptWithSize(Image_bg, false)
	GUI:setTouchEnabled(Image_bg, false)
	...
	local Text_price_total = GUI:Text_Create(Text_2_3, "Text_price_total", 82.00, 0.00, 16, "#ffffff", [[-]])
	GUI:setTouchEnabled(Text_price_total, false)
	GUI:setTag(Text_price_total, -1)
	GUI:Text_enableOutline(Text_price_total, "#000000", 1)

	-- Create Text_2_4
	local Text_2_4 = GUI:Text_Create(Layout_param, "Text_2_4", 16.00, 76.00, 16, "#ffffff", [[货币数量：]])
	GUI:setTouchEnabled(Text_2_4, false)
	GUI:setTag(Text_2_4, -1)
	GUI:Text_enableOutline(Text_2_4, "#000000", 1)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Text_2_4, "Image_bg", 74.00, -5.00, "res/public/1900000676.png")
	GUI:Image_setScale9Slice(Image_bg, 24, 25, 10, 11)
	GUI:setContentSize(Image_bg, 174, 31)
	GUI:setIgnoreContentAdaptWithSize(Image_bg, false)
	GUI:setTouchEnabled(Image_bg, false)
	...
	local Text_coin_num = GUI:Text_Create(Text_2_4, "Text_coin_num", 82.00, 1.00, 16, "#ffffff", [[-]])
	...
	local Text_item_name = GUI:Text_Create(Layout_param, "Text_item_name", 100.00, 350.00, 16, "#ffffff", [[-]])
	...
	local Image_filter_bg = GUI:Image_Create(Layout_param, "Image_filter_bg", 145.00, 318.00, "res/public/1900000677.png")
	...
	-- Create Button_add
	local Button_add = GUI:Button_Create(PMainUI, "Button_add", 544.00, 14.00, "res/public/1900000660.png")
