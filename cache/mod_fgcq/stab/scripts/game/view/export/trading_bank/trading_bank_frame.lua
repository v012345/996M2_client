...
function ui.init(parent)
	...
	-- Create FrameBG
	local FrameBG = GUI:Image_Create(PMainUI, "FrameBG", -22.00, 0.00, "res/private/trading_bank/1900000610.png")
	...
	-- Create CloseButton
	local CloseButton = GUI:Button_Create(PMainUI, "CloseButton", 780.00, 477.00, "res/private/trading_bank/1900000510.png")
	...
	-- Create page_cell_1
	local page_cell_1 = GUI:Button_Create(PMainUI, "page_cell_1", 780.00, 380.00, "res/private/trading_bank/1900000641.png")
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_1, "PageText", 13.00, 56.00, 16, "#807256", [[购
买]])
	...
	-- Create page_cell_2
	local page_cell_2 = GUI:Button_Create(PMainUI, "page_cell_2", 780.00, 305.00, "res/private/trading_bank/1900000641.png")
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_2, "PageText", 13.00, 56.00, 16, "#807256", [[寄
售]])
	GUI:setAnchorPoint(PageText, 0.50, 0.50)
	GUI:setTouchEnabled(PageText, false)
	GUI:setTag(PageText, -1)
	...
	-- Create page_cell_3
	local page_cell_3 = GUI:Button_Create(PMainUI, "page_cell_3", 780.00, 230.00, "res/private/trading_bank/1900000641.png")
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_3, "PageText", 13.00, 56.00, 16, "#807256", [[货
架]])
	GUI:setAnchorPoint(PageText, 0.50, 0.50)
	GUI:setTouchEnabled(PageText, false)
	GUI:setTag(PageText, -1)
	...
	-- Create page_cell_4
	local page_cell_4 = GUI:Button_Create(PMainUI, "page_cell_4", 780.00, 155.00, "res/private/trading_bank/1900000641.png")
	...
	-- Create PageText
	local PageText = GUI:Text_Create(page_cell_4, "PageText", 13.00, 56.00, 16, "#807256", [[我
的]])
	GUI:setAnchorPoint(PageText, 0.50, 0.50)
	GUI:setTouchEnabled(PageText, false)
	GUI:setTag(PageText, -1)
