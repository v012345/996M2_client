...
function ui.init(parent)
	...
	-- Create input_bg
	local input_bg = GUI:Image_Create(panel_bg, "input_bg", 70.00, 300.00, "res/public/1900015004.png")
	...
	-- Create input_prefix
	local input_prefix = GUI:Text_Create(input_bg, "input_prefix", -3.00, 13.00, 14, "#ffffff", [[手机端：]])
	...
	-- Create input_mobile
	local input_mobile = GUI:TextInput_Create(input_bg, "input_mobile", 0.00, 0.00, 220.00, 25.00, 16)
	...
	-- Create input_bg_1
	local input_bg_1 = GUI:Image_Create(panel_bg, "input_bg_1", 70.00, 200.00, "res/public/1900015004.png")
	...
	-- Create input_prefix
	local input_prefix = GUI:Text_Create(input_bg_1, "input_prefix", -3.00, 13.00, 14, "#ffffff", [[电脑端：]])
	GUI:setAnchorPoint(input_prefix, 1.00, 0.50)
	GUI:setTouchEnabled(input_prefix, false)
	GUI:setTag(input_prefix, -1)
	GUI:Text_enableOutline(input_prefix, "#000000", 1)
	...
	-- Create input_pc
	local input_pc = GUI:TextInput_Create(input_bg_1, "input_pc", 0.00, 0.00, 220.00, 25.00, 16)
