...
function ui.init(parent, __data__, __update__)
	...
	-- Create ImageBG
	local ImageBG = GUI:Image_Create(parent, "ImageBG", 0.00, 0.00, "res/custom/qiyuxitong/jm/jm_14_1.png")
	...
	-- Create Button_1
	local Button_1 = GUI:Button_Create(ImageBG, "Button_1", 262.00, 33.00, "res/custom/qiyuxitong/an/an24.png")
	...
	-- Create Button_2
	local Button_2 = GUI:Button_Create(ImageBG, "Button_2", 473.00, 33.00, "res/custom/qiyuxitong/an/an25.png")
	...
	-- Create Button_3
	local Button_3 = GUI:Button_Create(ImageBG, "Button_3", 386.00, 27.00, "res/custom/qiyuxitong/an/an01.png")
	...
	-- Create items_1
	local items_1 = GUI:Layout_Create(Button_3, "items_1", 81.00, 94.00, 62, 62, false)
	GUI:setAnchorPoint(items_1, 0.00, 0.00)
	GUI:setTouchEnabled(items_1, true)
	GUI:setTag(items_1, 0)

	-- Create Button_4
	local Button_4 = GUI:Button_Create(ImageBG, "Button_4", 387.00, 14.00, "res/custom/qiyuxitong/an/an01.png")
	...
	-- Create items_2
	local items_2 = GUI:Layout_Create(Button_4, "items_2", 23.00, 93.00, 62, 62, false)
	GUI:setAnchorPoint(items_2, 0.00, 0.00)
	GUI:setTouchEnabled(items_2, true)
	GUI:setTag(items_2, 0)

	-- Create items_3
	local items_3 = GUI:Layout_Create(Button_4, "items_3", 139.00, 93.00, 62, 62, false)
