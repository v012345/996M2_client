...
function ui.init(parent)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Scene, "Panel_1", 568.00, 320.00, 462.00, 540.00, false)
	...
	GUI:setTag(Panel_1, 121)

	-- Create Image_3
	local Image_3 = GUI:Image_Create(Panel_1, "Image_3", 24.00, 50.00, "res/private/rein_attr_ui/attr_ui_mobile/word_zswz_01.png")
	GUI:setChineseName(Image_3, "属性点_属性_图片")
	GUI:setTouchEnabled(Image_3, false)
	GUI:setTag(Image_3, 123)

	-- Create Text_tip
	local Text_tip = GUI:Text_Create(Panel_1, "Text_tip", 38.00, 472.00, 16, "#ffffff", [[-]])
	GUI:setChineseName(Text_tip, "属性点_描述_文本")
	GUI:setAnchorPoint(Text_tip, 0.00, 0.50)
	GUI:setTouchEnabled(Text_tip, false)
	GUI:setTag(Text_tip, 125)
	GUI:Text_enableOutline(Text_tip, "#111111", 1)

	-- Create Panel_data
	local Panel_data = GUI:Layout_Create(Panel_1, "Panel_data", 130.00, 106.00, 320.00, 300.00, false)
	GUI:setChineseName(Panel_data, "属性点_属性组合")
	GUI:setTouchEnabled(Panel_data, true)
	GUI:setTag(Panel_data, 127)

	-- Create Panel_cell
	local Panel_cell = GUI:Layout_Create(Panel_data, "Panel_cell", 0.00, 0.00, 320.00, 30.00, false)
	GUI:setChineseName(Panel_cell, "属性点_加点分组")
	GUI:setTouchEnabled(Panel_cell, true)
	GUI:setTag(Panel_cell, 126)

	-- Create Text_data
	local Text_data = GUI:Text_Create(Panel_cell, "Text_data", 0.00, 15.00, 16, "#ffffff", [[-]])
	...
	-- Create btn_add
	local btn_add = GUI:Button_Create(Panel_cell, "btn_add", 125.00, 15.00, "res/public/1900000621.png")
	...
	-- Create btn_sub
	local btn_sub = GUI:Button_Create(Panel_cell, "btn_sub", 155.00, 15.00, "res/public/1900000620.png")
	...
	-- Create Image_4
	local Image_4 = GUI:Image_Create(Panel_cell, "Image_4", 174.00, 15.00, "res/public/1900015004.png")
	GUI:setContentSize(Image_4, 128, 30)
	...
	GUI:setTag(Image_4, 135)

	-- Create Text_num
	local Text_num = GUI:Text_Create(Panel_cell, "Text_num", 183.00, 15.00, 16, "#ffffff", [[1/20]])
	...
	GUI:setTag(btn_agree, 133)

	-- Create btn_close
	local btn_close = GUI:Button_Create(Panel_1, "btn_close", 475.00, 519.00, "res/public/1900000510.png")
