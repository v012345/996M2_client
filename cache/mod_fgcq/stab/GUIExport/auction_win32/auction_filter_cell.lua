...
function ui.init(parent)
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(parent, "Panel_1", 0.00, 0.00, 90.00, 25.00, false)
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_1, "Image_1", 45.00, 12.00, "res/public/1900000668.png")
	GUI:Image_setScale9Slice(Image_1, 51, 51, 10, 10)
	GUI:setContentSize(Image_1, 90, 25)
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_1, "Text_1", 5.00, 12.00, 14, "#ffffff", [[职业]])
	...
	-- Create Image_arrow
	local Image_arrow = GUI:Image_Create(Panel_1, "Image_arrow", 45.00, 12.00, "res/public/btn_szjm_01_4.png")
	...
	-- Create Image_pull
	local Image_pull = GUI:Image_Create(Panel_1, "Image_pull", 75.00, 12.00, "res/public/btn_szjm_01.png")
