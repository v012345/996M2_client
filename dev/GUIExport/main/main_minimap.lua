...
function ui.init(parent)
	-- Create LayoutClip
	local LayoutClip = GUI:Layout_Create(parent, "LayoutClip", 0.00, 30.00, 600.00, 160.00, true)
	...
	local MapButtonText = GUI:Image_Create(MapButton, "MapButtonText", 23.00, 40.00, "res/private/main/Button_1/1900012301_1.png")
	GUI:setContentSize(MapButtonText, 26, 62)
