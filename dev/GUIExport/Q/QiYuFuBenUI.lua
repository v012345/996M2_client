...
function ui.init(parent, __data__, __update__)
	...
	-- Create ImageBG
	local ImageBG = GUI:Image_Create(parent, "ImageBG", 0.00, 0.00, "res/custom/qiyuxitong/jm/jm_19.png")
	GUI:setAnchorPoint(ImageBG, 0.00, 0.00)
	GUI:setTouchEnabled(ImageBG, false)
	GUI:setTag(ImageBG, -1)

	-- Create CloseLayout
	local CloseLayout = GUI:Layout_Create(ImageBG, "CloseLayout", 591.00, 276.00, 86, 86, false)
	...
	-- Create Button_JinRuFuBen
	local Button_JinRuFuBen = GUI:Button_Create(ImageBG, "Button_JinRuFuBen", 419.00, 122.00, "res/custom/JuQing/btn32.png")
	GUI:Button_setTitleText(Button_JinRuFuBen, [[]])
	GUI:Button_setTitleColor(Button_JinRuFuBen, "#ffffff")
	GUI:Button_setTitleFontSize(Button_JinRuFuBen, 16)
	GUI:Button_titleEnableOutline(Button_JinRuFuBen, "#000000", 1)
	GUI:setAnchorPoint(Button_JinRuFuBen, 0.00, 0.00)
	GUI:setScaleX(Button_JinRuFuBen, 0.80)
	GUI:setScaleY(Button_JinRuFuBen, 0.80)
	GUI:setTouchEnabled(Button_JinRuFuBen, true)
	GUI:setTag(Button_JinRuFuBen, 0)

	-- Create Ask_bg
	local Ask_bg = GUI:Image_Create(ImageBG, "Ask_bg", 204.00, 105.00, "res/custom/qiyuxitong/bg_ask.png")
