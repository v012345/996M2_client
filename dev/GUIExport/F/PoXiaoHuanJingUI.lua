...
function ui.init(parent, __data__, __update__)
	...
	-- Create ImageBG
	local ImageBG = GUI:Image_Create(parent, "ImageBG", 0.00, 1.00, "res/custom/MeiRiHuanJing/hjbg5.png")
	GUI:setAnchorPoint(ImageBG, 0.00, 0.00)
	GUI:setTouchEnabled(ImageBG, false)
	GUI:setTag(ImageBG, -1)

	-- Create CloseLayout
	local CloseLayout = GUI:Layout_Create(ImageBG, "CloseLayout", 815.00, 430.00, 86, 86, false)
	...
	-- Create Button_1
	local Button_1 = GUI:Button_Create(ImageBG, "Button_1", 476.00, 50.00, "res/custom/MeiRiHuanJing/button1.png")
	...
	-- Create Button_2
	local Button_2 = GUI:Button_Create(ImageBG, "Button_2", 671.00, 50.00, "res/custom/MeiRiHuanJing/button2.png")
	...
	-- Create Tips_Button
	local Tips_Button = GUI:Button_Create(ImageBG, "Tips_Button", 378.00, 281.00, "res/custom/public/helpBtn.png")
	...
	-- Create Tips_Show
	local Tips_Show = GUI:Image_Create(ImageBG, "Tips_Show", 286.00, 167.00, "res/custom/public/picktypeui.png")
	...
	-- Create TipsInfo
	local TipsInfo = GUI:RichText_Create(Tips_Show, "TipsInfo", 30.00, 24.00, "<font color='#ffff00' size='16' >刷新: </font><font color='#00ff00' size='16' >幻の牛头魔蛛[破晓]</font><br><font color='#00ff00' size='16' >          幻の神圣海王[破晓]</font><br><font color='#ffff00' size='16' >爆出: </font><font color='#00ff00' size='16' >造化结晶</font><br><font color='#ff0000' size='16' >再次点击按钮关闭提示</font>", 200)
