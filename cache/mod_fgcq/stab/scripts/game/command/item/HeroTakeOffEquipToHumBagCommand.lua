local HeroTakeOffEquipToHumBagCommand = class('HeroTakeOffEquipToHumBagCommand', framework.SimpleCommand)

function HeroTakeOffEquipToHumBagCommand:ctor()
end

function HeroTakeOffEquipToHumBagCommand:execute(notification) ---脱装备
    ...
    LuaSendMsg(global.MsgType.MSG_CS_HERO_TAKEOFF_HUMBAG, MakeIndex, pos, 0, 0, name, string.len(name))

end


return HeroTakeOffEquipToHumBagCommand