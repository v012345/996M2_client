...
function FuLiDaTingOBJ:UpdateUI()
    ...
    if _Parent then
        ...
        if FuLiDaTingOBJ.page == 7 then
            local S_daynum = Player:getServerVar("G3")
            if tonumber(S_daynum) >= 7 then
                GUI:Image_loadTexture(_Parent,"res/custom/fulidating/"..FuLiDaTingOBJ.page.."/bgk2.png")
                GUI:setVisible(FuLiDaTingOBJ.ui.FanYe_L,true)
                GUI:setVisible(FuLiDaTingOBJ.ui.FanYe_R,true)
                GUI:setVisible(FuLiDaTingOBJ.ui.Effect_FanYe_L,true)
                GUI:setVisible(FuLiDaTingOBJ.ui.Effect_FanYe_R,true)
            else
                GUI:Image_loadTexture(_Parent,"res/custom/fulidating/"..FuLiDaTingOBJ.page.."/bgk1.png")
            end
        else
                ...
                if _Handle then
                    ...
                    GUI:addOnClickEvent(_Handle, function()
                        ...
                        if FuLiDaTingOBJ.page ~= i then
                            ...
                            FuLiDaTingOBJ.sign = 1
                            if FuLiDaTingOBJ.page == 7 and tonumber(S_daynum)>= 7 then
                                FuLiDaTingOBJ.sign = 2
                            end
                            FuLiDaTingOBJ:UpdateUI()
                        end
                    end)
        ...
        if _GUIHandle then
            ...
            elseif FuLiDaTingOBJ.page == 7 then
                ...
                GUI:Image_loadTexture(_Parent,"res/custom/fulidating/"..FuLiDaTingOBJ.page.."/bgk"..FuLiDaTingOBJ.sign..".png")
                ...
                if _Handle then
                    ...
                    GUI:addOnClickEvent(_Handle, function()
                        ssrMessage:sendmsg(ssrNetMsgCfg.FuLiDaTing_Request,FuLiDaTingOBJ.page,FuLiDaTingOBJ.sign)
                    end )
                end

                _Handle = GUI:GetWindow(_GUIHandle,"FanYe_L")
                if _Handle then
                      GUI:addOnClickEvent(_Handle,function()
                          if FuLiDaTingOBJ.sign == 1 then
                              SL:ShowSystemTips("已经是第一页了！！！")
                ...
                _Handle = GUI:GetWindow(_GUIHandle,"FanYe_R")
                if _Handle then
                      GUI:addOnClickEvent(_Handle,function()
                          if FuLiDaTingOBJ.sign == #FuLiDaTingOBJ.config[FuLiDaTingOBJ.page] then
                              SL:ShowSystemTips("已经最后一页了！！！")
                              return
                          else
                              FuLiDaTingOBJ.sign = FuLiDaTingOBJ.sign + 1
                              FuLiDaTingOBJ:UpdateUI()
                ...
                if _Handle then
                    local item_data = {}
                    item_data.index = SL:GetMetaValue("ITEM_INDEX_BY_NAME", FuLiDaTingOBJ.config[FuLiDaTingOBJ.page][FuLiDaTingOBJ.sign].award[1][1])
                    item_data.look  = true
                    item_data.bgVisible = false
                    item_data.count =  FuLiDaTingOBJ.config[FuLiDaTingOBJ.page][FuLiDaTingOBJ.sign].award[1][2]
                    item_data.color = 250
                    item_data.noMouseTips = false
                ...
                for i=1,#FuLiDaTingOBJ.config[FuLiDaTingOBJ.page][FuLiDaTingOBJ.sign].show do
                    _Handle = GUI:GetWindow(_GUIHandle,"ItemShow_"..i)
                    if _Handle then
                        local item_data = {}
                        item_data.index = SL:GetMetaValue("ITEM_INDEX_BY_NAME", FuLiDaTingOBJ.config[FuLiDaTingOBJ.page][FuLiDaTingOBJ.sign].show[i][1])
                        item_data.look  = true
                        item_data.bgVisible = false
                        item_data.count =  FuLiDaTingOBJ.config[FuLiDaTingOBJ.page][FuLiDaTingOBJ.sign].show[i][2]
                        item_data.color = 250
                        item_data.noMouseTips = false
