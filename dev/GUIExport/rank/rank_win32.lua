...
function ui.init(parent)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Scene, "Panel_1", 568.00, 349.00, 900.00, 506.00, false)
	...
	-- Create Panel_bg
	local Panel_bg = GUI:Layout_Create(Panel_1, "Panel_bg", 0.00, 252.00, 900.00, 506.00, false)
	...
	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_bg, "Image_bg", 452.00, 241.00, "res/custom/Rank/background.png")
	...
	-- Create Panel_type
	local Panel_type = GUI:Layout_Create(Panel_1, "Panel_type", 657.00, 436.00, 185.00, 45.00, false)
	...
	local Panel_btnList = GUI:Layout_Create(Panel_1, "Panel_btnList", 117.00, 46.00, 60.00, 310.00, false)
	...
	-- Create ImageView
	local ImageView = GUI:Image_Create(Panel_1, "ImageView", 623.00, 78.00, "res/custom/Rank/z.png")
	GUI:setTouchEnabled(ImageView, false)
	GUI:setTag(ImageView, -1)

	-- Create Image_13
	local Image_13 = GUI:Image_Create(Panel_1, "Image_13", 450.00, 473.00, "res/custom/Rank/title.png")
	...
	local ListView_list = GUI:ListView_Create(Panel_1, "ListView_list", 88.00, 82.00, 560.00, 307.00, 1)
	...
	-- Create Node_model
	local Node_model = GUI:Node_Create(Panel_1, "Node_model", 721.00, 222.00)
	GUI:setChineseName(Node_model, "排行榜_模型_节点")
	GUI:setAnchorPoint(Node_model, 0.50, 0.50)
	GUI:setTag(Node_model, 47)

	-- Create Button_looks
	local Button_looks = GUI:Button_Create(Panel_1, "Button_looks", 722.00, 104.00, "res/custom/Rank/btn_lock.png")
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_1, "Button_close", 916.00, 433.00, "res/public/1900000510.png")
	...
	-- Create Panel_myInfo
	local Panel_myInfo = GUI:Layout_Create(Panel_1, "Panel_myInfo", 112.00, 26.00, 656.00, 40.00, false)
	...
	-- Create Text_level
	local Text_level = GUI:Text_Create(Panel_myInfo, "Text_level", 118.00, 20.00, 16, "#ffffff", [[未上榜]])
	...
	local Text_guildName = GUI:Text_Create(Panel_myInfo, "Text_guildName", 330.00, 20.00, 16, "#ffffff", [[无]])
	...
	-- Create ImageView
	local ImageView = GUI:Image_Create(Panel_myInfo, "ImageView", 7.00, 0.00, "res/custom/Rank/img_my_rank.png")
	GUI:setTouchEnabled(ImageView, false)
	GUI:setTag(ImageView, -1)

	-- Create ImageView_1
	local ImageView_1 = GUI:Image_Create(Panel_myInfo, "ImageView_1", 217.00, -0.00, "res/custom/Rank/img_belong_to_guild.png")
	GUI:setTouchEnabled(ImageView_1, false)
	GUI:setTag(ImageView_1, -1)

	-- Create LayoutTItle
	local LayoutTItle = GUI:Layout_Create(Panel_1, "LayoutTItle", 53.00, 393.00, 650.00, 50.00, false)
	...
	local ImageView_Desc = GUI:Image_Create(Panel_1, "ImageView_Desc", 628.00, 74.00, "res/custom/Rank/this_power_desc_100.png")
	...
	local Button_upZhanLi = GUI:Button_Create(ImageView_Desc, "Button_upZhanLi", 35.00, 10.00, "res/custom/Rank/upzhanli.png")
