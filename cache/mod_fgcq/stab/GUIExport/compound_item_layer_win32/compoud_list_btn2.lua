...
function ui.init(parent)
	...
	-- Create Button_type2
	local Button_type2 = GUI:Button_Create(Panel_1, "Button_type2", 72.00, 19.00, "res/private/compound_items_ui/1900000663_2.png")
	...
	GUI:setContentSize(Button_type2, 142, 37)
