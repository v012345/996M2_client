...
function ui.init(parent)
	...
	-- Create Text
	local Text = GUI:Text_Create(Layout0, "Text", 43.00, 15.00, 16, "#ffffff", [[仅背包显示]])
	...
	-- Create Text
	local Text = GUI:Text_Create(Layout1, "Text", 43.00, 15.00, 16, "#ffffff", [[背包身上显示]])
	GUI:setAnchorPoint(Text, 0.00, 0.50)
	GUI:setTouchEnabled(Text, false)
	GUI:setTag(Text, -1)
	GUI:Text_enableOutline(Text, "#000000", 1)
	...
	-- Create Text
	local Text = GUI:Text_Create(Layout2, "Text", 43.00, 15.00, 16, "#ffffff", [[不显示]])
	GUI:setAnchorPoint(Text, 0.00, 0.50)
	GUI:setTouchEnabled(Text, false)
	GUI:setTag(Text, -1)
	GUI:Text_enableOutline(Text, "#000000", 1)
