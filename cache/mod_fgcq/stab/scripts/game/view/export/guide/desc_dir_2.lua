...
Image_arrow:setTag(30)
Image_arrow:setCascadeColorEnabled(true)
Image_arrow:setCascadeOpacityEnabled(true)
Image_arrow:setPosition(-12.2959, 12.5045)
Image_arrow:setRotationSkewX(45.0000)
Image_arrow:setRotationSkewY(45.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(Image_arrow)
layout:setSize({width = 33.0000, height = 29.0000})
layout:setLeftMargin(-28.7959)
layout:setRightMargin(-4.2041)
layout:setTopMargin(-27.0045)
layout:setBottomMargin(-1.9955)
...
Node_desc:setPosition(-97.4632, 52.1000)
layout = ccui.LayoutComponent:bindLayoutComponent(Node_desc)
layout:setLeftMargin(-97.4632)
layout:setRightMargin(97.4632)
layout:setTopMargin(-52.1000)
layout:setBottomMargin(52.1000)
