...
function ui.init(parent)
	...
	-- Create Panel_11
	local Panel_11 = GUI:Layout_Create(Panel_1, "Panel_11", 0.00, 414.80, 732.00, 33.00, false)
	GUI:setTouchEnabled(Panel_11, false)
	GUI:setTag(Panel_11, 9)

	-- Create ListView_2
	local ListView_2 = GUI:ListView_Create(Panel_11, "ListView_2", 366.00, -4.77, 732.00, 408.00, 1)
	GUI:setAnchorPoint(ListView_2, 0.50, 1.00)
	GUI:setTouchEnabled(ListView_2, true)
	GUI:setTag(ListView_2, 596)

	-- Create Image_1_0
	local Image_1_0 = GUI:Image_Create(Panel_11, "Image_1_0", 0.00, -0.95, "res/private/trading_bank/bg_yyxsz_01.png")
	...
	-- Create Text_3
	local Text_3 = GUI:Text_Create(Panel_11, "Text_3", 94.82, 14.32, 18, "#ffffff", [[全部]])
	...
	-- Create Image_1_0_0
	local Image_1_0_0 = GUI:Image_Create(Panel_11, "Image_1_0_0", 190.37, 14.71, "res/private/trading_bank/bg_yyxsz_02.png")
	...
	-- Create Text_4
	local Text_4 = GUI:Text_Create(Panel_11, "Text_4", 235.37, 14.32, 18, "#ffffff", [[数量]])
	...
	local Image_1_0_0_0 = GUI:Image_Create(Panel_11, "Image_1_0_0_0", 277.07, 14.71, "res/private/trading_bank/bg_yyxsz_02.png")
	...
	-- Create Text_5
	local Text_5 = GUI:Text_Create(Panel_11, "Text_5", 334.72, 14.32, 18, "#ffffff", [[价格]])
	...
	local Image_1_0_0_0_0 = GUI:Image_Create(Panel_11, "Image_1_0_0_0_0", 393.40, 14.71, "res/private/trading_bank/bg_yyxsz_02.png")
	...
	-- Create Text_6
	local Text_6 = GUI:Text_Create(Panel_11, "Text_6", 435.90, 14.32, 18, "#ffffff", [[状态]])
	...
	local Image_1_0_0_0_0_0 = GUI:Image_Create(Panel_11, "Image_1_0_0_0_0_0", 476.66, 14.71, "res/private/trading_bank/bg_yyxsz_02.png")
	...
	-- Create Text_7
	local Text_7 = GUI:Text_Create(Panel_11, "Text_7", 599.91, 14.32, 18, "#ffffff", [[操作]])
	...
	-- Create Panel_item
	local Panel_item = GUI:Layout_Create(Panel_1, "Panel_item", 365.65, 352.80, 732.00, 85.00, false)
	GUI:setAnchorPoint(Panel_item, 0.50, 1.00)
	GUI:setTouchEnabled(Panel_item, true)
	GUI:setTag(Panel_item, 43)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_item, "Image_bg", 1.02, 1.50, "res/private/trading_bank/word_jiaoyh_019.png")
	...
	-- Create Image_item
	local Image_item = GUI:Image_Create(Panel_item, "Image_item", 42.32, 42.51, "res/private/trading_bank/1900000651.png")
	...
	local Text_goodname = GUI:Text_Create(Panel_item, "Text_goodname", 120.78, 42.82, 16, "#ffffff", [[职业：战士]])
	...
	-- Create Text_num
	local Text_num = GUI:Text_Create(Panel_item, "Text_num", 236.72, 42.82, 16, "#ffffff", [[100000]])
	...
	-- Create Text_pirce
	local Text_pirce = GUI:Text_Create(Panel_item, "Text_pirce", 334.07, 42.82, 16, "#ffffff", [[88888888]])
	...
	-- Create Text_state
	local Text_state = GUI:Text_Create(Panel_item, "Text_state", 438.38, 42.82, 16, "#ffffff", [[上架中]])
	...
	-- Create Button_1
	local Button_1 = GUI:Button_Create(Panel_item, "Button_1", 524.75, 41.63, "res/private/trading_bank/1900000611.png")
	...
	-- Create Button_2
	local Button_2 = GUI:Button_Create(Panel_item, "Button_2", 603.53, 41.63, "res/private/trading_bank/1900000611.png")
	...
	-- Create Button_3
	local Button_3 = GUI:Button_Create(Panel_item, "Button_3", 682.32, 41.63, "res/private/trading_bank/1900000611.png")
	...
	-- Create Text_tips
	local Text_tips = GUI:Text_Create(Panel_1, "Text_tips", 366.00, 222.50, 20, "#2abb2a", [[使用交易行需先验证身份信息,避免出现盗号现象]])
	GUI:setAnchorPoint(Text_tips, 0.50, 0.50)
	GUI:setTouchEnabled(Text_tips, false)
	GUI:setTag(Text_tips, 86)
	GUI:Text_enableOutline(Text_tips, "#000000", 1)

	-- Create Button_tips
	local Button_tips = GUI:Button_Create(Panel_1, "Button_tips", 366.00, 176.66, "res/private/trading_bank/1900000680.png")
