...
function ui.init(parent, __data__, __update__)
	...
	-- Create ImageBG
	local ImageBG = GUI:Image_Create(parent, "ImageBG", 0.00, 1.00, "res/custom/qiyuxitong/jm/jm_8_1.png")
	...
	-- Create Button_1
	local Button_1 = GUI:Button_Create(ImageBG, "Button_1", 393.00, 24.00, "res/custom/qiyuxitong/an/an01.png")
	...
	-- Create items_1
	local items_1 = GUI:Layout_Create(ImageBG, "items_1", 477.00, 119.00, 62, 62, false)
