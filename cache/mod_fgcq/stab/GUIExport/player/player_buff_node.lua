...
function ui.init(parent)
	...
	local ListView_buff = GUI:ListView_Create(Panel_1, "ListView_buff", 0.00, 10.00, 348.00, 460.00, 1)
	GUI:ListView_setGravity(ListView_buff, 5)
	GUI:setChineseName(ListView_buff, "玩家_buff列表")
	GUI:setTouchEnabled(ListView_buff, true)
	GUI:setTag(ListView_buff, 13)
end
return ui