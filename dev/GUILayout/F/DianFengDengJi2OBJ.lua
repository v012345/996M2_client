DianFengDengJi2OBJ = {}
DianFengDengJi2OBJ.__cname = "DianFengDengJi2OBJ"
DianFengDengJi2OBJ.config = ssrRequireCsvCfg("cfg_DianFengDengJi2")
DianFengDengJi2OBJ.cost = {{}}
DianFengDengJi2OBJ.give = {{"你我山巅自相逢·出尘[称号]",1}}
-------------------------------↓↓↓ UI操作 ↓↓↓---------------------------------------
function DianFengDengJi2OBJ:main(objcfg)
    ...
    GUI:addOnClickEvent(self.ui.Button_1, function()
        ssrMessage:sendmsg(ssrNetMsgCfg.DianFengDengJi2_Request,1)
    end)
    GUI:addOnClickEvent(self.ui.Button_2, function()
        ssrMessage:sendmsg(ssrNetMsgCfg.DianFengDengJi2_Request,2)
    end)
...
function DianFengDengJi2OBJ:UpdateUI()
...
function DianFengDengJi2OBJ:UpdateDot()
...
-------------------------------↓↓↓ 网络消息 ↓↓↓---------------------------------------
function DianFengDengJi2OBJ:SyncResponse(arg1, arg2, arg3, data)
    self.currLevel = arg1 or 0
    if GUI:GetWindow(nil, self.__cname) then
        self:UpdateUI()
    end
end
return DianFengDengJi2OBJ