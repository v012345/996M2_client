...
function ui.init(parent)
	...
	-- Create Text_info1
	local Text_info1 = GUI:Text_Create(Panel_menu, "Text_info1", 20.00, 600.00, 16, "#ffffff", [[Id]])
	...
	-- Create Text_info2
	local Text_info2 = GUI:Text_Create(Panel_menu, "Text_info2", 70.00, 600.00, 16, "#ffffff", [[分类名称]])
	...
	-- Create Panel_info
	local Panel_info = GUI:Layout_Create(Panel_main, "Panel_info", 936.00, 0.00, 730.00, 640.00, false)
	...
	-- Create Text_info3
	local Text_info3 = GUI:Text_Create(Panel_info, "Text_info3", 20.00, 620.00, 16, "#ffffff", [[备注效果：]])
	...
	-- Create Text_info4
	local Text_info4 = GUI:Text_Create(Panel_info, "Text_info4", 20.00, 220.00, 16, "#ffffff", [[编辑：]])
	...
	-- Create img_inputBg
	local img_inputBg = GUI:Image_Create(Text_info4, "img_inputBg", -10.00, -10.00, "res/public/1900015004.png")
	GUI:Image_setScale9Slice(img_inputBg, 73, 74, 13, 14)
	GUI:setContentSize(img_inputBg, 710, 160)
	...
	-- Create Input_edit
	local Input_edit = GUI:TextInput_Create(Text_info4, "Input_edit", 0.00, -15.00, 690.00, 150.00, 16)
	...
	-- Create Input_id
	local Input_id = GUI:TextInput_Create(Panel_tips, "Input_id", 100.00, 100.00, 120.00, 25.00, 16)
	GUI:TextInput_setString(Input_id, "")
	GUI:TextInput_setPlaceHolder(Input_id, "请输入组别.......")
	...
	-- Create Node_tips
	local Node_tips = GUI:Node_Create(Panel_main, "Node_tips", 220.00, 240.00)
