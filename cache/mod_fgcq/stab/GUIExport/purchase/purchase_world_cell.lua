...
function ui.init(parent)
	-- Create Panel_cell
	local Panel_cell = GUI:Layout_Create(parent, "Panel_cell", 605.00, 290.00, 605.00, 80.00, false)
	...
	-- Create Text_p_num
	local Text_p_num = GUI:Text_Create(Panel_cell, "Text_p_num", 214.00, 40.00, 16, "#ffffff", [[求购数量]])
	...
	-- Create Text_min_num
	local Text_min_num = GUI:Text_Create(Panel_cell, "Text_min_num", 287.00, 40.00, 16, "#ffffff", [[最小数量]])
	...
	-- Create Text_coin
	local Text_coin = GUI:Text_Create(Panel_cell, "Text_coin", 354.00, 40.00, 16, "#ffffff", [[全部]])
	...
	-- Create Text_single
	local Text_single = GUI:Text_Create(Panel_cell, "Text_single", 422.00, 40.00, 16, "#ffffff", [[单价]])
	...
	-- Create Text_total
	local Text_total = GUI:Text_Create(Panel_cell, "Text_total", 488.00, 40.00, 16, "#ffffff", [[总价]])
