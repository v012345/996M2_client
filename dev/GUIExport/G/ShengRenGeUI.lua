...
function ui.init(parent, __data__, __update__)
	...
	-- Create Button_1
	local Button_1 = GUI:Button_Create(ImageBG, "Button_1", 409.00, 98.00, "Default/Button_Normal.png")
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(ImageBG, "Panel_1", 255.00, 206.00, 331, 200, false)
