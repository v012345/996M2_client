...
function ui.init(parent)
	...
	GUI:setTag(Image_frame_bg2, 101)
	...
	GUI:setTag(Image_material_bg, 76)

	-- Create ListView_2
	local ListView_2 = GUI:ListView_Create(Panel_material, "ListView_2", 180.00, 138.00, 250.00, 64.00, 2)
	...
	-- Create ListView_get
	local ListView_get = GUI:ListView_Create(Panel_get, "ListView_get", 180.00, 172.00, 250.00, 64.00, 2)
	...
	local ListView_money = GUI:ListView_Create(Panel_money, "ListView_money", 120.00, 50.00, 150.00, 58.00, 1)
	...
	-- Create item_money
	local item_money = GUI:Layout_Create(Panel_money, "item_money", 450.00, 60.00, 150.00, 30.00, false)
	...
	-- Create Panel_icon
	local Panel_icon = GUI:Layout_Create(Panel_show, "Panel_icon", 550.00, 223.00, 50.00, 50.00, false)
