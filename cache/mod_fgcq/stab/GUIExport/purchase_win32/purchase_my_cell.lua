...
function ui.init(parent)
	-- Create Panel_cell
	local Panel_cell = GUI:Layout_Create(parent, "Panel_cell", 506.00, 70.00, 505.00, 70.00, true)
	...
	-- Create Text_remain
	local Text_remain = GUI:Text_Create(Panel_cell, "Text_remain", 172.00, 35.00, 12, "#ffffff", [[剩余数量]])
	...
	-- Create Text_min_num
	local Text_min_num = GUI:Text_Create(Panel_cell, "Text_min_num", 232.00, 35.00, 12, "#ffffff", [[最小数量]])
	...
	-- Create Text_coin
	local Text_coin = GUI:Text_Create(Panel_cell, "Text_coin", 280.00, 35.00, 12, "#ffffff", [[货币]])
	...
	-- Create Text_single
	local Text_single = GUI:Text_Create(Panel_cell, "Text_single", 324.00, 35.00, 12, "#ffffff", [[单价]])
	...
	local Text_remain_total = GUI:Text_Create(Panel_cell, "Text_remain_total", 390.00, 35.00, 12, "#ffffff", [[剩余总价]])
