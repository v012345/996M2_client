...
function ui.init(parent)
	-- Create page_cell
	local page_cell = GUI:Layout_Create(parent, "page_cell", 260.00, 330.00, 300.00, 60.00, false)
	...
	-- Create text_name
	local text_name = GUI:Text_Create(page_cell, "text_name", 180.00, 30.00, 16, "#ffffff", [[备注]])
