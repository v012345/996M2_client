...
function ui.init(parent)
	...
	-- Create Button_open
	local Button_open = GUI:Button_Create(Panel_main, "Button_open", 181.00, 82.00, "res/public/1900000611.png")
	GUI:Button_loadTexturePressed(Button_open, "res/public/1900000611.png")
	GUI:Button_loadTextureDisabled(Button_open, "Default/Button_Disable.png")
	GUI:Button_setScale9Slice(Button_open, 26, 24, 12, 10)
	GUI:setContentSize(Button_open, 76, 33)
