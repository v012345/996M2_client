...
function ui.init(parent)
	...
	local Image_mapFlag = GUI:Image_Create(Panel_minimap, "Image_mapFlag", 61.00, 0.00, "res/private/main-win32/00150.png")
	GUI:setChineseName(Image_mapFlag, "小地图_是否可战斗图标")
	GUI:setAnchorPoint(Image_mapFlag, 1.00, 0.00)
