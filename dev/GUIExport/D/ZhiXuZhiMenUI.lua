...
function ui.init(parent, __data__, __update__)
	...
	-- Create ImageBG
	local ImageBG = GUI:Image_Create(parent, "ImageBG", 0.00, -2.00, "res/custom/shijianmigong/jm_4.png")
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(ImageBG, "Text_1", 829.00, 204.00, 19, "#5ddd5a", [[0/0]])
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(ImageBG, "Panel_1", 649.00, 232.00, 65, 60, false)
	GUI:setAnchorPoint(Panel_1, 0.00, 0.00)
	GUI:setTouchEnabled(Panel_1, true)
	GUI:setTag(Panel_1, 0)

	-- Create Button_1
	local Button_1 = GUI:Button_Create(ImageBG, "Button_1", 573.00, 84.00, "res/custom/public/btn_jinrufuben.png")
	...
	-- Create Node_1
	local Node_1 = GUI:Node_Create(ImageBG, "Node_1", 141.00, 191.00)
