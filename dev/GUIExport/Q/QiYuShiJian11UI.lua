...
function ui.init(parent, __data__, __update__)
	...
	-- Create ImageBG
	local ImageBG = GUI:Image_Create(parent, "ImageBG", 0.00, 0.00, "res/custom/qiyuxitong/jm/jm_11_1.png")
	...
	-- Create Button_1
	local Button_1 = GUI:Button_Create(ImageBG, "Button_1", 317.00, 43.00, "res/custom/qiyuxitong/an/an19.png")
	...
	-- Create Button_2
	local Button_2 = GUI:Button_Create(ImageBG, "Button_2", 494.00, 43.00, "res/custom/qiyuxitong/an/an18.png")
	...
	-- Create Button_3
	local Button_3 = GUI:Button_Create(ImageBG, "Button_3", 385.00, 15.00, "res/custom/qiyuxitong/an/an01.png")
	...
	-- Create items_1
	local items_1 = GUI:Layout_Create(Button_3, "items_1", 82.00, 93.00, 62, 62, false)
	GUI:setAnchorPoint(items_1, 0.00, 0.00)
	GUI:setTouchEnabled(items_1, true)
	GUI:setTag(items_1, 0)

	-- Create Button_4
	local Button_4 = GUI:Button_Create(ImageBG, "Button_4", 385.00, 15.00, "res/custom/qiyuxitong/an/an01.png")
	...
	-- Create items_2
	local items_2 = GUI:Layout_Create(Button_4, "items_2", 82.00, 93.00, 62, 62, false)
