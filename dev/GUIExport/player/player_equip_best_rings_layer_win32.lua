...
function ui.init(parent)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Scene, "Panel_1", 512.00, 384.00, 428.00, 428.00, false)
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_1, "Image_1", 216.00, 210.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/bg_sx_01.png")
	...
	-- Create Image_2
	local Image_2 = GUI:Image_Create(Panel_1, "Image_2", 218.00, 289.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_jewelry_1.png")
	...
	-- Create Image_3
	local Image_3 = GUI:Image_Create(Panel_1, "Image_3", 216.00, 290.00, "res/public/word_sxbt_05.png")
	...
	-- Create Panel_items
	local Panel_items = GUI:Layout_Create(Panel_1, "Panel_items", 67.00, 365.00, 290.00, 290.00, false)
	...
	-- Create Image_30
	local Image_30 = GUI:Image_Create(Panel_items, "Image_30", 148.00, 295.00, "res/public_win32/bg_daoju_00.png")
	GUI:Image_setScale9Slice(Image_30, 16, 15, 16, 16)
	...
	-- Create Image_tag30
	local Image_tag30 = GUI:Image_Create(Panel_items, "Image_tag30", 148.00, 295.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_1.png")
	...
	-- Create Image_31
	local Image_31 = GUI:Image_Create(Panel_items, "Image_31", 262.00, 248.00, "res/public_win32/bg_daoju_00.png")
	...
	-- Create Image_tag31
	local Image_tag31 = GUI:Image_Create(Panel_items, "Image_tag31", 262.00, 248.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_2.png")
	...
	-- Create Image_32
	local Image_32 = GUI:Image_Create(Panel_items, "Image_32", 308.00, 138.00, "res/public_win32/bg_daoju_00.png")
	...
	-- Create Image_tag32
	local Image_tag32 = GUI:Image_Create(Panel_items, "Image_tag32", 308.00, 138.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_3.png")
	...
	-- Create Image_33
	local Image_33 = GUI:Image_Create(Panel_items, "Image_33", 261.00, 27.00, "res/public_win32/bg_daoju_00.png")
	...
	-- Create Image_tag33
	local Image_tag33 = GUI:Image_Create(Panel_items, "Image_tag33", 261.00, 27.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_4.png")
	...
	-- Create Image_34
	local Image_34 = GUI:Image_Create(Panel_items, "Image_34", 148.00, -20.00, "res/public_win32/bg_daoju_00.png")
	...
	-- Create Image_tag34
	local Image_tag34 = GUI:Image_Create(Panel_items, "Image_tag34", 149.00, -20.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_5.png")
	...
	-- Create Image_35
	local Image_35 = GUI:Image_Create(Panel_items, "Image_35", 35.00, 26.00, "res/public_win32/bg_daoju_00.png")
	...
	-- Create Image_tag35
	local Image_tag35 = GUI:Image_Create(Panel_items, "Image_tag35", 35.00, 26.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_6.png")
	...
	-- Create Image_36
	local Image_36 = GUI:Image_Create(Panel_items, "Image_36", -10.00, 137.00, "res/public_win32/bg_daoju_00.png")
	...
	-- Create Image_tag36
	local Image_tag36 = GUI:Image_Create(Panel_items, "Image_tag36", -10.00, 137.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_7.png")
	...
	-- Create Image_37
	local Image_37 = GUI:Image_Create(Panel_items, "Image_37", 36.00, 248.00, "res/public_win32/bg_daoju_00.png")
	...
	-- Create Image_tag37
	local Image_tag37 = GUI:Image_Create(Panel_items, "Image_tag37", 36.00, 248.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_8.png")
	...
	-- Create Image_38
	local Image_38 = GUI:Image_Create(Panel_items, "Image_38", 149.00, 178.00, "res/public_win32/bg_daoju_00.png")
	...
	-- Create Image_tag38
	local Image_tag38 = GUI:Image_Create(Panel_items, "Image_tag38", 149.00, 178.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_9.png")
	...
	-- Create Image_39
	local Image_39 = GUI:Image_Create(Panel_items, "Image_39", 149.00, 99.00, "res/public_win32/bg_daoju_00.png")
	...
	-- Create Image_tag39
	local Image_tag39 = GUI:Image_Create(Panel_items, "Image_tag39", 149.00, 99.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_10.png")
	...
	-- Create Image_40
	local Image_40 = GUI:Image_Create(Panel_items, "Image_40", 174.00, 66.00, "res/public_win32/bg_daoju_00.png")
	...
	-- Create Image_tag40
	local Image_tag40 = GUI:Image_Create(Panel_items, "Image_tag40", 174.00, 66.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_11.png")
	...
	-- Create Image_41
	local Image_41 = GUI:Image_Create(Panel_items, "Image_41", 227.00, 66.00, "res/public_win32/bg_daoju_00.png")
	...
	-- Create Image_tag41
	local Image_tag41 = GUI:Image_Create(Panel_items, "Image_tag41", 227.00, 66.00, "res/private/player_best_rings_ui/player_best_rings_ui_win32/word_shengxiao_12.png")
	...
	-- Create Node_41
	local Node_41 = GUI:Node_Create(Panel_items, "Node_41", 227.00, 66.00)
	...
	-- Create Panel_touch
	local Panel_touch = GUI:Layout_Create(Panel_1, "Panel_touch", 56.00, 374.00, 320.00, 320.00, false)
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_1, "Button_close", 405.00, 384.00, "res/public_win32/1900000510.png")
