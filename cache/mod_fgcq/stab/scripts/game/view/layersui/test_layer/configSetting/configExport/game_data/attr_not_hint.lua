...
function ui.init(parent)
	...
	-- Create Text
	local Text = GUI:Text_Create(panel_bg, "Text", 5.00, 360.00, 14, "#ffffff", [[已配置]])
	GUI:setTouchEnabled(Text, false)
	GUI:setTag(Text, -1)
	GUI:Text_enableOutline(Text, "#000000", 1)

	-- Create ScrollView_sel
	local ScrollView_sel = GUI:ScrollView_Create(panel_bg, "ScrollView_sel", 0.00, 356.00, 300.00, 155.00, 1)
	GUI:ScrollView_setInnerContainerSize(ScrollView_sel, 300.00, 155.00)
	GUI:setAnchorPoint(ScrollView_sel, 0.00, 1.00)
	GUI:setTouchEnabled(ScrollView_sel, true)
	GUI:setTag(ScrollView_sel, -1)

	-- Create Layout_line
	local Layout_line = GUI:Layout_Create(panel_bg, "Layout_line", 0.00, 200.00, 300.00, 1.00, false)
	...
	-- Create ScrollView_unSel
	local ScrollView_unSel = GUI:ScrollView_Create(panel_bg, "ScrollView_unSel", 0.00, 199.00, 300.00, 155.00, 1)
	GUI:ScrollView_setInnerContainerSize(ScrollView_unSel, 300.00, 155.00)
	GUI:setAnchorPoint(ScrollView_unSel, 0.00, 1.00)
	GUI:setTouchEnabled(ScrollView_unSel, true)
	GUI:setTag(ScrollView_unSel, -1)
end
return ui