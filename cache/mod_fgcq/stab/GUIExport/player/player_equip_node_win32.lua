...
function ui.init(parent)
	...
	-- Create Panel_pos0
	local Panel_pos0 = GUI:Layout_Create(Panel_1, "Panel_pos0", 136.00, 120.00, 80.00, 144.00, false)
	...
	-- Create Panel_pos1
	local Panel_pos1 = GUI:Layout_Create(Panel_1, "Panel_pos1", 80.00, 190.00, 60.00, 120.00, false)
	...
	local Panel_pos1001 = GUI:Layout_Create(Panel_1, "Panel_pos1001", 24.00, 205.00, 42.00, 42.00, false)
	...
	local Panel_pos1000 = GUI:Layout_Create(Panel_1, "Panel_pos1000", 24.00, 160.00, 42.00, 42.00, false)
	...
	-- Create Node_1001
	local Node_1001 = GUI:Node_Create(Panel_1, "Node_1001", 24.00, 205.00)
	GUI:setChineseName(Node_1001, "玩家装备_武器_位置")
	GUI:setAnchorPoint(Node_1001, 0.50, 0.50)
	GUI:setTag(Node_1001, 175)
	GUI:setVisible(Node_1001, false)

	-- Create Node_1000
	local Node_1000 = GUI:Node_Create(Panel_1, "Node_1000", 24.00, 160.00)
	GUI:setChineseName(Node_1000, "玩家装备_衣服_位置")
	GUI:setAnchorPoint(Node_1000, 0.50, 0.50)
