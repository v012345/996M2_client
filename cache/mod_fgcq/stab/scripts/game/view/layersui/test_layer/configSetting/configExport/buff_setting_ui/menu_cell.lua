...
function ui.init(parent)
	-- Create page_cell
	local page_cell = GUI:Layout_Create(parent, "page_cell", 260.00, 330.00, 300.00, 65.00, false)
	...
	-- Create text_id
	local text_id = GUI:Text_Create(page_cell, "text_id", 50.00, 33.00, 16, "#ffffff", [[1]])
	...
	-- Create text_name
	local text_name = GUI:Text_Create(page_cell, "text_name", 150.00, 33.00, 16, "#ffffff", [[魔法盾]])
