...
function ui.init(parent)
	...
	-- Create Text_title
	local Text_title = GUI:Text_Create(Panel_2, "Text_title", 177.00, 465.00, 16, "#f8e6c6", [[下架道具]])
	...
	-- Create Image_14
	local Image_14 = GUI:Image_Create(Panel_2, "Image_14", 177.00, 450.00, "res/public/1900000667.png")
	...
	-- Create Image_icon
	local Image_icon = GUI:Image_Create(Panel_2, "Image_icon", 177.00, 380.00, "res/public_win32/1900000664.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_2, "Text_name", 177.00, 420.00, 12, "#ffffff", [[装备名称七个字]])
	...
	-- Create Text_1_0_2
	local Text_1_0_2 = GUI:Text_Create(Panel_2, "Text_1_0_2", 110.00, 210.00, 12, "#ffffff", [[竞拍价：]])
	...
	-- Create Text_1_0_3
	local Text_1_0_3 = GUI:Text_Create(Panel_2, "Text_1_0_3", 111.00, 159.00, 12, "#ffffff", [[一口价：]])
	...
	local Button_cancel = GUI:Button_Create(Panel_2, "Button_cancel", 93.00, 52.00, "res/public_win32/1900000660.png")
	...
	local Button_submit = GUI:Button_Create(Panel_2, "Button_submit", 262.00, 52.00, "res/public_win32/1900000660.png")
	...
	local Text_bid_price = GUI:Text_Create(Panel_2, "Text_bid_price", 220.00, 210.00, 12, "#ffffff", [[9999]])
	...
	local Text_buy_price = GUI:Text_Create(Panel_2, "Text_buy_price", 220.00, 159.00, 12, "#ffffff", [[9999]])
	...
	local Text_remaining = GUI:Text_Create(Panel_2, "Text_remaining", 95.00, 265.00, 12, "#28ef01", [[竞拍中03:20:00]])
	...
	-- Create Text_count
	local Text_count = GUI:Text_Create(Panel_2, "Text_count", 260.00, 265.00, 12, "#28ef01", [[数量1]])
	...
	-- Create Text_status
	local Text_status = GUI:Text_Create(Panel_2, "Text_status", 177.00, 335.00, 12, "#ffffff", [[状态]])
