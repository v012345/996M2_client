...
function ui.init(parent)
	...
	-- Create ScrollView_1
	local ScrollView_1 = GUI:ScrollView_Create(Image_1, "ScrollView_1", 0.00, 0.00, 693.00, 407.00, 1)
	GUI:ScrollView_setBounceEnabled(ScrollView_1, true)
	GUI:ScrollView_setInnerContainerSize(ScrollView_1, 693.00, 407.00)
