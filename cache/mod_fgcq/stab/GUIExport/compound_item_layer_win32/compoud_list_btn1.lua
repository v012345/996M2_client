...
function ui.init(parent)
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(parent, "Panel_1", 0.00, 0.00, 100.00, 38.00, false)
	GUI:setChineseName(Panel_1, "系统合成一级按钮_组合")
	GUI:setTouchEnabled(Panel_1, true)
	GUI:setTag(Panel_1, 34)

	-- Create Button_type
	local Button_type = GUI:Button_Create(Panel_1, "Button_type", 50.00, 20.00, "res/private/compound_items_ui/1900000663.png")
	...
	GUI:setContentSize(Button_type, 100, 37)
	...
	-- Create Image_red
	local Image_red = GUI:Image_Create(Panel_1, "Image_red", 91.00, 29.00, "res/public/btn_npcfh_04.png")
