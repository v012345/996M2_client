...
function ui.init(parent)
	...
	local ScrollView_items = GUI:ScrollView_Create(panel_bg, "ScrollView_items", 0.00, 380.00, 300.00, 338.00, 1)
	GUI:ScrollView_setInnerContainerSize(ScrollView_items, 300.00, 338.00)
