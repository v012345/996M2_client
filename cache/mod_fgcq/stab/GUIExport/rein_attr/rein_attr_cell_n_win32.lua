...
function ui.init(parent)
	...
	local Panel_cell_new = GUI:Layout_Create(parent, "Panel_cell_new", 0.00, 0.00, 280.00, 18.00, false)
	GUI:setChineseName(Panel_cell_new, "属性点_加点分组")
	GUI:setTouchEnabled(Panel_cell_new, true)
	GUI:setTag(Panel_cell_new, 152)

	-- Create Text_title
	local Text_title = GUI:Text_Create(Panel_cell_new, "Text_title", 0.00, 9.00, 12, "#ffffff", [[-]])
	GUI:setChineseName(Text_title, "属性点_当前属性点数")
	GUI:setAnchorPoint(Text_title, 0.00, 0.50)
	GUI:setTouchEnabled(Text_title, false)
	GUI:setTag(Text_title, 153)
	GUI:Text_enableOutline(Text_title, "#111111", 1)

	-- Create Text_data
	local Text_data = GUI:Text_Create(Panel_cell_new, "Text_data", 64.00, 9.00, 12, "#ffffff", [[-]])
	...
	-- Create btn_add
	local btn_add = GUI:Button_Create(Panel_cell_new, "btn_add", 240.00, 9.00, "res/public/1900000621.png")
	...
	-- Create btn_sub
	local btn_sub = GUI:Button_Create(Panel_cell_new, "btn_sub", 261.00, 9.00, "res/public/1900000620.png")
	...
	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_cell_new, "Image_bg", 139.00, 9.00, "res/public/1900015004.png")
	GUI:setContentSize(Image_bg, 85, 18)
	GUI:setIgnoreContentAdaptWithSize(Image_bg, false)
	GUI:setChineseName(Image_bg, "属性点_属性点_背景框")
	GUI:setAnchorPoint(Image_bg, 0.00, 0.50)
	GUI:setTouchEnabled(Image_bg, false)
	GUI:setTag(Image_bg, 156)

	-- Create Text_num
	local Text_num = GUI:Text_Create(Panel_cell_new, "Text_num", 144.00, 9.00, 12, "#ffffff", [[1/20]])
