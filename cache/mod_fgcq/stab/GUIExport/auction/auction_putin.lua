...
function ui.init(parent)
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_2, "Button_close", 354.00, 474.00, "res/public/1900000510.png")
	...
	-- Create Text_title
	local Text_title = GUI:Text_Create(Panel_2, "Text_title", 177.00, 470.00, 18, "#f8e6c6", [[上架道具]])
	...
	-- Create Image_14
	local Image_14 = GUI:Image_Create(Panel_2, "Image_14", 177.00, 452.00, "res/public/1900000667.png")
	...
	-- Create Image_icon
	local Image_icon = GUI:Image_Create(Panel_2, "Image_icon", 177.00, 380.00, "res/public/1900000664.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_2, "Text_name", 177.00, 430.00, 16, "#ffffff", [[装备名称七个字]])
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_2, "Text_1", 108.00, 316.00, 16, "#ffffff", [[上架数量：]])
	...
	-- Create Text_1_0
	local Text_1_0 = GUI:Text_Create(Panel_2, "Text_1_0", 108.00, 275.00, 16, "#ffffff", [[出售货币：]])
	...
	-- Create Text_1_0_0
	local Text_1_0_0 = GUI:Text_Create(Panel_2, "Text_1_0_0", 108.00, 240.00, 16, "#ffffff", [[行会折扣：]])
	...
	-- Create Text_1_0_2
	local Text_1_0_2 = GUI:Text_Create(Panel_2, "Text_1_0_2", 108.00, 190.00, 16, "#ffffff", [[竞拍价：]])
	...
	-- Create Text_1_0_3
	local Text_1_0_3 = GUI:Text_Create(Panel_2, "Text_1_0_3", 108.00, 145.00, 16, "#ffffff", [[一口价：]])
	...
	local Button_countadd = GUI:Button_Create(Panel_2, "Button_countadd", 285.00, 316.00, "res/public/1900000621.png")
	...
	local Button_countsub = GUI:Button_Create(Panel_2, "Button_countsub", 137.00, 316.00, "res/public/1900000620.png")
	...
	local TextField_count = GUI:TextInput_Create(Panel_2, "TextField_count", 212.00, 316.00, 102.00, 24.00, 16)
	...
	local Button_cancel = GUI:Button_Create(Panel_2, "Button_cancel", 90.00, 50.00, "res/public/1900000660.png")
	...
	local Button_submit = GUI:Button_Create(Panel_2, "Button_submit", 255.00, 50.00, "res/public/1900000660.png")
	...
	local TextField_bid_price = GUI:TextInput_Create(Panel_2, "TextField_bid_price", 220.00, 190.00, 120.00, 22.00, 16)
	...
	local TextField_buy_price = GUI:TextInput_Create(Panel_2, "TextField_buy_price", 220.00, 145.00, 120.00, 22.00, 16)
