...
function ui.init(parent)
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Scene, "Panel_1", 0.00, 463.00, 439.00, 416.00, false)
	...
	GUI:setTag(Panel_customize, 23)
	GUI:setVisible(Panel_customize, false)

	-- Create Panel_item
	local Panel_item = GUI:Layout_Create(Panel_customize, "Panel_item", 0.00, 220.00, 398.00, 73.50, false)
	GUI:setChineseName(Panel_item, "物品信息分组")
	GUI:setTouchEnabled(Panel_item, true)
	GUI:setTag(Panel_item, 26)

	-- Create Panel_item1
	local Panel_item1 = GUI:Layout_Create(Panel_item, "Panel_item1", 0.00, 0.00, 200.00, 73.50, false)
	GUI:setChineseName(Panel_item1, "商店物品分组(左)")
	GUI:setTouchEnabled(Panel_item1, true)
	GUI:setTag(Panel_item1, 51)
	GUI:setVisible(Panel_item1, false)

	-- Create Image_item_bg
	local Image_item_bg = GUI:Image_Create(Panel_item1, "Image_item_bg", 99.00, 36.00, "res/public/1900000676.png")
	GUI:Image_setScale9Slice(Image_item_bg, 13, 13, 6, 6)
	GUI:setContentSize(Image_item_bg, 198, 73.5)
	GUI:setIgnoreContentAdaptWithSize(Image_item_bg, false)
	GUI:setChineseName(Image_item_bg, "商店物品左_背景图")
	GUI:setAnchorPoint(Image_item_bg, 0.50, 0.50)
	GUI:setTouchEnabled(Image_item_bg, true)
	GUI:setTag(Image_item_bg, 27)

	-- Create Image_icon_bg
	local Image_icon_bg = GUI:Image_Create(Panel_item1, "Image_icon_bg", 37.00, 37.00, "res/public/1900000664.png")
	...
	GUI:setTag(Image_icon_bg, 28)

	-- Create Text_item_name
	local Text_item_name = GUI:Text_Create(Panel_item1, "Text_item_name", 74.00, 52.00, 16, "#ffffff", [[]])
	...
	GUI:setTag(Text_item_name, 30)
	GUI:Text_enableOutline(Text_item_name, "#000000", 1)

	-- Create Text_item_price
	local Text_item_price = GUI:Text_Create(Panel_item1, "Text_item_price", 74.00, 23.00, 16, "#ffffff", [[]])
	...
	GUI:setTag(Text_item_price, 31)
	GUI:Text_enableOutline(Text_item_price, "#000000", 1)

	-- Create Panel_item2
	local Panel_item2 = GUI:Layout_Create(Panel_item, "Panel_item2", 198.00, 0.00, 200.00, 73.50, false)
	GUI:setChineseName(Panel_item2, "商店物品分组(右)")
	GUI:setTouchEnabled(Panel_item2, true)
	GUI:setTag(Panel_item2, 52)
	GUI:setVisible(Panel_item2, false)

	-- Create Image_item_bg
	local Image_item_bg = GUI:Image_Create(Panel_item2, "Image_item_bg", 99.00, 36.00, "res/public/1900000676.png")
	GUI:Image_setScale9Slice(Image_item_bg, 13, 13, 6, 6)
	GUI:setContentSize(Image_item_bg, 198, 73.5)
	GUI:setIgnoreContentAdaptWithSize(Image_item_bg, false)
	...
	GUI:setAnchorPoint(Image_item_bg, 0.50, 0.50)
	GUI:setTouchEnabled(Image_item_bg, true)
	GUI:setTag(Image_item_bg, 53)

	-- Create Image_icon_bg
	local Image_icon_bg = GUI:Image_Create(Panel_item2, "Image_icon_bg", 37.00, 37.00, "res/public/1900000664.png")
	GUI:setChineseName(Image_icon_bg, "商店物品右_物品图标_背景")
	GUI:setAnchorPoint(Image_icon_bg, 0.50, 0.50)
	GUI:setTouchEnabled(Image_icon_bg, false)
	GUI:setTag(Image_icon_bg, 54)

	-- Create Text_item_name
	local Text_item_name = GUI:Text_Create(Panel_item2, "Text_item_name", 74.00, 52.00, 16, "#ffffff", [[]])
	GUI:setChineseName(Text_item_name, "商店物品右_名称_文本")
	GUI:setAnchorPoint(Text_item_name, 0.00, 0.50)
	GUI:setTouchEnabled(Text_item_name, false)
	GUI:setTag(Text_item_name, 55)
	GUI:Text_enableOutline(Text_item_name, "#000000", 1)

	-- Create Text_item_price
	local Text_item_price = GUI:Text_Create(Panel_item2, "Text_item_price", 74.00, 23.00, 16, "#ffffff", [[]])
	GUI:setChineseName(Text_item_price, "商店物品右_图片")
	GUI:setAnchorPoint(Text_item_price, 0.00, 0.50)
	GUI:setTouchEnabled(Text_item_price, false)
	GUI:setTag(Text_item_price, 56)
	GUI:Text_enableOutline(Text_item_price, "#000000", 1)
end
return ui