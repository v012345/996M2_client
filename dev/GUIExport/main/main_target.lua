...
function ui.init(parent)
	...
	GUI:Button_titleEnableOutline(Button_eye, "#000000", 1)
	GUI:setTouchEnabled(Button_eye, true)
	GUI:setTag(Button_eye, -1)
	GUI:setVisible(Button_eye, false)
	...
	-- Create Layout
	local Layout = GUI:Layout_Create(Panel_1, "Layout", -2.00, -41.00, 210.00, 40.00, true)
