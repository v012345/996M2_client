...
function ui.init(parent)
	...
	-- Create TitleText
	local TitleText = GUI:Text_Create(FrameLayout, "TitleText", 23.00, 437.00, 14, "#d8c8ae", [[拍卖行]])
	...
	local ListView_group = GUI:ListView_Create(FrameLayout, "ListView_group", 22.00, 417.00, 410.00, 30.00, 2)
	...
	-- Create Panel_search
	local Panel_search = GUI:Layout_Create(FrameLayout, "Panel_search", 624.00, 385.00, 200.00, 35.00, false)
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_search, "Image_1", 20.00, 16.00, "res/public/btn_szjm_02.png")
	...
	-- Create ImageView
	local ImageView = GUI:Image_Create(Panel_search, "ImageView", 32.00, 17.00, "res/public/1900000668.png")
	...
	-- Create SearchInput
	local SearchInput = GUI:TextInput_Create(Panel_search, "SearchInput", 35.00, 17.00, 100.00, 20.00, 12)
	...
	local Button_confirm = GUI:Button_Create(Panel_search, "Button_confirm", 170.00, 17.00, "res/public/btn_fanye_03.png")
	...
	-- Create Text
	local Text = GUI:Text_Create(Button_confirm, "Text", 32.00, 13.00, 14, "#f8e6c6", [[确 认]])
	...
	-- Create AttachLayout
	local AttachLayout = GUI:Layout_Create(FrameLayout, "AttachLayout", 18.00, 28.00, 608.00, 391.00, false)
