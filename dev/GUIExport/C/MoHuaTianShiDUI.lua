...
function ui.init(parent, __data__, __update__)
	...
	-- Create ImageBG
	local ImageBG = GUI:Image_Create(parent, "ImageBG", 0.00, 1.00, "res/custom/mohuatianshi/jm_4.png")
	...
	-- Create item_5
	local item_5 = GUI:Layout_Create(ImageBG, "item_5", 624.00, 337.00, 52, 52, false)
	GUI:setAnchorPoint(item_5, 0.00, 0.00)
	GUI:setTouchEnabled(item_5, true)
	GUI:setTag(item_5, 0)

	-- Create Button_1
	local Button_1 = GUI:Button_Create(ImageBG, "Button_1", 393.00, 129.00, "res/custom/mohuatianshi/an_3.png")
	...
	-- Create Button_2
	local Button_2 = GUI:Button_Create(ImageBG, "Button_2", 640.00, 129.00, "res/custom/mohuatianshi/an_4.png")
