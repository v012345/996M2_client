...
function ui.init(parent)
	...
	local Button_myTeam = GUI:Button_Create(Panel_1, "Button_myTeam", 53.00, 365.00, "res/public_win32/1900000663.png")
	GUI:Button_loadTextureDisabled(Button_myTeam, "res/public_win32/1900000662.png")
	GUI:Button_setScale9Slice(Button_myTeam, 15, 15, 11, 11)
	GUI:setContentSize(Button_myTeam, 86, 28)
	...
	GUI:Button_setTitleFontSize(Button_myTeam, 14)
	...
	local Button_nearTeam = GUI:Button_Create(Panel_1, "Button_nearTeam", 53.00, 330.00, "res/public_win32/1900000663.png")
	GUI:Button_loadTextureDisabled(Button_nearTeam, "res/public_win32/1900000662.png")
	GUI:Button_setScale9Slice(Button_nearTeam, 15, 15, 11, 11)
	GUI:setContentSize(Button_nearTeam, 86, 28)
	...
	GUI:Button_setTitleFontSize(Button_nearTeam, 14)
	...
	-- Create Panel_myTeam
	local Panel_myTeam = GUI:Layout_Create(Panel_1, "Panel_myTeam", 0.00, 0.00, 606.00, 390.00, false)
	GUI:setChineseName(Panel_myTeam, "我的队伍组合")
	GUI:setTouchEnabled(Panel_myTeam, false)
	GUI:setTag(Panel_myTeam, 31)

	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_myTeam, "Image_1", 0.00, 38.00, "res/private/team_win32/1900014008.png")
	GUI:setChineseName(Image_1, "我的队伍_装饰条")
	GUI:setTouchEnabled(Image_1, false)
	GUI:setTag(Image_1, 38)

	-- Create Image_none
	local Image_none = GUI:Image_Create(Panel_myTeam, "Image_none", 340.00, 200.00, "res/private/team_win32/1900014011.png")
	...
	local Button_createTeam = GUI:Button_Create(Panel_myTeam, "Button_createTeam", 560.00, 18.00, "res/public_win32/1900000660.png")
	GUI:Button_setScale9Slice(Button_createTeam, 15, 15, 11, 11)
	GUI:setContentSize(Button_createTeam, 79, 30)
	...
	GUI:Button_setTitleFontSize(Button_createTeam, 12)
	...
	local Button_applyList = GUI:Button_Create(Panel_myTeam, "Button_applyList", 280.00, 18.00, "res/public_win32/1900000660.png")
	GUI:Button_setScale9Slice(Button_applyList, 15, 15, 11, 11)
	GUI:setContentSize(Button_applyList, 79, 30)
	...
	GUI:Button_setTitleFontSize(Button_applyList, 12)
	...
	-- Create Button_call
	local Button_call = GUI:Button_Create(Panel_myTeam, "Button_call", 375.00, 18.00, "res/public_win32/1900000660.png")
	...
	local Button_invite = GUI:Button_Create(Panel_myTeam, "Button_invite", 470.00, 18.00, "res/public_win32/1900000660.png")
	...
	-- Create Button_exit
	local Button_exit = GUI:Button_Create(Panel_myTeam, "Button_exit", 560.00, 18.00, "res/public_win32/1900000660.png")
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_myTeam, "Text_name", 165.00, 378.00, 12, "#ffffff", [[名字]])
	...
	-- Create Text_job
	local Text_job = GUI:Text_Create(Panel_myTeam, "Text_job", 272.00, 378.00, 12, "#ffffff", [[职业]])
	...
	-- Create Text_level
	local Text_level = GUI:Text_Create(Panel_myTeam, "Text_level", 350.00, 378.00, 12, "#ffffff", [[等级]])
	...
	-- Create Text_guild
	local Text_guild = GUI:Text_Create(Panel_myTeam, "Text_guild", 440.00, 378.00, 12, "#ffffff", [[行会]])
	...
	-- Create Text_map
	local Text_map = GUI:Text_Create(Panel_myTeam, "Text_map", 550.00, 378.00, 12, "#ffffff", [[所在地图]])
	...
	-- Create Text_exp
	local Text_exp = GUI:Text_Create(Panel_myTeam, "Text_exp", 120.00, 18.00, 12, "#ffffff", [[经验加成]])
	...
	local CheckBox_permit = GUI:CheckBox_Create(Panel_myTeam, "CheckBox_permit", 26.00, 18.00, "res/public/1900000654.png", "res/public/1900000655.png")
	...
	-- Create Text_permit
	local Text_permit = GUI:Text_Create(CheckBox_permit, "Text_permit", 25.00, 9.00, 12, "#ffffff", [[允许组队]])
	...
	local ListView_member = GUI:ListView_Create(Panel_myTeam, "ListView_member", 108.00, 40.00, 500.00, 325.00, 1)
	...
	local Panel_nearTeam = GUI:Layout_Create(Panel_1, "Panel_nearTeam", 0.00, 0.00, 606.00, 390.00, false)
	GUI:setChineseName(Panel_nearTeam, "附近队伍组合")
	GUI:setTouchEnabled(Panel_nearTeam, false)
	GUI:setTag(Panel_nearTeam, 32)
	GUI:setVisible(Panel_nearTeam, false)

	-- Create Image_2
	local Image_2 = GUI:Image_Create(Panel_nearTeam, "Image_2", 0.00, 37.00, "res/private/team_win32/19000140013.png")
	GUI:setChineseName(Image_2, "附近队伍_装饰条")
	GUI:setTouchEnabled(Image_2, false)
	GUI:setTag(Image_2, 95)

	-- Create Text_team
	local Text_team = GUI:Text_Create(Panel_nearTeam, "Text_team", 182.00, 373.00, 12, "#ffffff", [[队伍]])
	...
	-- Create Text_guild1
	local Text_guild1 = GUI:Text_Create(Panel_nearTeam, "Text_guild1", 330.00, 373.00, 12, "#ffffff", [[行会]])
	...
	-- Create Text_number
	local Text_number = GUI:Text_Create(Panel_nearTeam, "Text_number", 450.00, 373.00, 12, "#ffffff", [[人数]])
	...
	local Text_operation = GUI:Text_Create(Panel_nearTeam, "Text_operation", 550.00, 373.00, 12, "#ffffff", [[操作]])
	...
	local ListView_near = GUI:ListView_Create(Panel_nearTeam, "ListView_near", 108.00, 39.00, 500.00, 315.00, 1)
