...
function ui.init(parent)
	...
	GUI:setContentSize(Panel_1, 626, 412)
	...
	-- Create Button_close
	local Button_close = GUI:Button_Create(Panel_1, "Button_close", 639.00, 391.00, "res/public/1900000510.png")
	...
	-- Create Panel_8
	local Panel_8 = GUI:Layout_Create(Panel_1, "Panel_8", 10.00, 11.00, 606.00, 390.00, false)
	GUI:setChineseName(Panel_8, "拾取列表_详细信息")
	GUI:setTouchEnabled(Panel_8, true)
	GUI:setTag(Panel_8, 845)

	-- Create Image_title
	local Image_title = GUI:Image_Create(Panel_1, "Image_title", 316.00, 427.00, "res/private/new_setting/textBg.png")
