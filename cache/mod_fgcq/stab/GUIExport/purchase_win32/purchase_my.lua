...
function ui.init(parent)
	...
	local Panel_title_1 = GUI:Layout_Create(Panel_items, "Panel_title_1", 506.00, 322.00, 505.00, 22.00, false)
	GUI:setAnchorPoint(Panel_title_1, 1.00, 1.00)
	GUI:setTouchEnabled(Panel_title_1, false)
	GUI:setTag(Panel_title_1, 328)

	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_title_1, "Text_1", 58.00, 10.00, 12, "#ffffff", [[物品名称]])
	...
	-- Create Text_2
	local Text_2 = GUI:Text_Create(Panel_title_1, "Text_2", 172.00, 10.00, 12, "#ffffff", [[剩余数量]])
	...
	-- Create Text_3
	local Text_3 = GUI:Text_Create(Panel_title_1, "Text_3", 232.00, 10.00, 12, "#ffffff", [[最小数量]])
	GUI:setChineseName(Text_3, "Text_3")
	...
	-- Create Text_4
	local Text_4 = GUI:Text_Create(Panel_title_1, "Text_4", 280.00, 10.00, 12, "#ffffff", [[货币]])
	...
	-- Create Text_5
	local Text_5 = GUI:Text_Create(Panel_title_1, "Text_5", 324.00, 10.00, 12, "#ffffff", [[单价]])
	...
	-- Create Text_5_1
	local Text_5_1 = GUI:Text_Create(Panel_title_1, "Text_5_1", 390.00, 10.00, 12, "#ffffff", [[剩余总价]])
	...
	-- Create Text_6
	local Text_6 = GUI:Text_Create(Panel_title_1, "Text_6", 465.00, 10.00, 12, "#ffffff", [[操作]])
	...
	local Panel_title_2 = GUI:Layout_Create(Panel_items, "Panel_title_2", 506.00, 322.00, 505.00, 22.00, false)
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_title_2, "Text_1", 74.00, 10.00, 12, "#ffffff", [[物品名称]])
	GUI:setAnchorPoint(Text_1, 0.50, 0.50)
	GUI:setTouchEnabled(Text_1, false)
	GUI:setTag(Text_1, 100)
	GUI:Text_enableOutline(Text_1, "#000000", 1)
	...
	-- Create Text_2
	local Text_2 = GUI:Text_Create(Panel_title_2, "Text_2", 188.00, 10.00, 12, "#ffffff", [[单价]])
	GUI:setAnchorPoint(Text_2, 0.50, 0.50)
	GUI:setTouchEnabled(Text_2, false)
	GUI:setTag(Text_2, 101)
	GUI:Text_enableOutline(Text_2, "#000000", 1)
	...
	-- Create Text_3
	local Text_3 = GUI:Text_Create(Panel_title_2, "Text_3", 247.00, 10.00, 12, "#ffffff", [[单位]])
	GUI:setAnchorPoint(Text_3, 0.50, 0.50)
	GUI:setTouchEnabled(Text_3, false)
	GUI:setTag(Text_3, 102)
	GUI:Text_enableOutline(Text_3, "#000000", 1)
	...
	-- Create Text_4
	local Text_4 = GUI:Text_Create(Panel_title_2, "Text_4", 310.00, 10.00, 12, "#ffffff", [[剩余数量]])
	GUI:setAnchorPoint(Text_4, 0.50, 0.50)
	GUI:setTouchEnabled(Text_4, false)
	GUI:setTag(Text_4, 103)
	GUI:Text_enableOutline(Text_4, "#000000", 1)
	...
	-- Create Text_6
	local Text_6 = GUI:Text_Create(Panel_title_2, "Text_6", 453.00, 10.00, 12, "#ffffff", [[操作]])
	GUI:setAnchorPoint(Text_6, 0.50, 0.50)
	GUI:setTouchEnabled(Text_6, false)
	GUI:setTag(Text_6, 103)
	GUI:Text_enableOutline(Text_6, "#000000", 1)
	...
	local Button_last_page = GUI:Button_Create(Panel_bottom, "Button_last_page", 130.00, 3.00, "res/public_win32/1900000660.png")
	...
	local Button_next_page = GUI:Button_Create(Panel_bottom, "Button_next_page", 220.00, 3.00, "res/public_win32/1900000660.png")
	...
	local Button_take_out = GUI:Button_Create(Panel_bottom, "Button_take_out", 518.00, 3.00, "res/public_win32/1900000660.png")
	GUI:Button_setTitleText(Button_take_out, "全部取出")
	GUI:Button_setTitleColor(Button_take_out, "#f8e6c6")
	GUI:Button_setTitleFontSize(Button_take_out, 12)
	...
	local Button_cancel = GUI:Button_Create(Panel_bottom, "Button_cancel", 428.00, 3.00, "res/public_win32/1900000660.png")
	...
	local Button_purchase = GUI:Button_Create(Panel_bottom, "Button_purchase", 518.00, 3.00, "res/public_win32/1900000660.png")
	GUI:Button_setTitleText(Button_purchase, "我要求购")
	GUI:Button_setTitleColor(Button_purchase, "#f8e6c6")
	GUI:Button_setTitleFontSize(Button_purchase, 12)
