...
function ui.init(parent)
	...
	-- Create Text_title
	local Text_title = GUI:Text_Create(Panel_2, "Text_title", 165.00, 122.00, 18, "#ffffff", [[添加好友]])
	...
	local Text_friend_search = GUI:Text_Create(Panel_2, "Text_friend_search", 62.00, 90.00, 16, "#ffffff", [[好友搜索]])
	GUI:setChineseName(Text_friend_search, "添加好友_搜索_文本")
	GUI:setAnchorPoint(Text_friend_search, 0.50, 0.50)
	...
	GUI:Button_setTitleText(Button_ok, "加为好友")
