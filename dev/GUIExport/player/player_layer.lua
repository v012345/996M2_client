...
function ui.init(parent)
	-- Create Scene
	local Scene = GUI:Node_Create(parent, "Scene", -7.00, 0.00)
	GUI:setChineseName(Scene, "玩家面板场景")
	GUI:setAnchorPoint(Scene, 0.50, 0.50)
	GUI:setTag(Scene, -1)

	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(Scene, "Panel_1", 83.00, 340.00, 928.00, 552.00, false)
	...
	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_1, "Image_bg", 464.00, 276.00, "res/private/player_main_layer_ui/player_main_layer_ui_mobile/1900015000.png")
	...
	-- Create Text_Name
	local Text_Name = GUI:Text_Create(Panel_1, "Text_Name", 450.00, 465.00, 18, "#ffe400", [[]])
	...
	-- Create ButtonClose
	local ButtonClose = GUI:Button_Create(Panel_1, "ButtonClose", 943.00, 497.00, "res/public/1900000510.png")
	...
	-- Create Node_panel
	local Node_panel = GUI:Node_Create(Panel_1, "Node_panel", 260.00, 3.00)
	GUI:setChineseName(Node_panel, "玩家面板_节点")
	GUI:setAnchorPoint(Node_panel, 0.50, 0.50)
	GUI:setTag(Node_panel, 26)

	-- Create Node_attr
	local Node_attr = GUI:Node_Create(Panel_1, "Node_attr", 625.00, -78.00)
	GUI:setAnchorPoint(Node_attr, 0.50, 0.50)
	GUI:setTag(Node_attr, 26)

	-- Create Panel_btnList
	local Panel_btnList = GUI:Layout_Create(Panel_1, "Panel_btnList", 145.00, 478.00, 110.00, 454.00, false)
	...
	-- Create Button_1
	local Button_1 = GUI:Button_Create(Panel_btnList, "Button_1", 0.00, 454.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Image_name
	local Image_name = GUI:Image_Create(Button_1, "Image_name", 28.00, 3.00, "res/private/player_main_layer_ui/name1.png")
	GUI:setTouchEnabled(Image_name, false)
	GUI:setTag(Image_name, -1)

	-- Create Button_2
	local Button_2 = GUI:Button_Create(Panel_btnList, "Button_2", 0.00, 368.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Image_name
	local Image_name = GUI:Image_Create(Button_2, "Image_name", 28.00, 3.00, "res/private/player_main_layer_ui/name3.png")
	GUI:setTouchEnabled(Image_name, false)
	GUI:setTag(Image_name, -1)

	-- Create Button_3
	local Button_3 = GUI:Button_Create(Panel_btnList, "Button_3", 0.00, 411.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Image_name
	local Image_name = GUI:Image_Create(Button_3, "Image_name", 28.00, 3.00, "res/private/player_main_layer_ui/name1.png")
	GUI:setTouchEnabled(Image_name, false)
	GUI:setTag(Image_name, -1)

	-- Create Button_4
	local Button_4 = GUI:Button_Create(Panel_btnList, "Button_4", 0.00, 325.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	GUI:Button_loadTexturePressed(Button_4, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015010.png")
	GUI:Button_loadTextureDisabled(Button_4, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Image_name
	local Image_name = GUI:Image_Create(Button_4, "Image_name", 28.00, 3.00, "res/private/player_main_layer_ui/name4.png")
	GUI:setTouchEnabled(Image_name, false)
	GUI:setTag(Image_name, -1)

	-- Create Button_6
	local Button_6 = GUI:Button_Create(Panel_btnList, "Button_6", 0.00, 282.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Image_name
	local Image_name = GUI:Image_Create(Button_6, "Image_name", 28.00, 3.00, "res/private/player_main_layer_ui/name5.png")
	GUI:setTouchEnabled(Image_name, false)
	GUI:setTag(Image_name, -1)

	-- Create Button_11
	local Button_11 = GUI:Button_Create(Panel_btnList, "Button_11", 0.00, 411.00, "res/private/player_main_layer_ui/player_main_layer_ui_win32/1900015011.png")
	...
	-- Create Image_name
	local Image_name = GUI:Image_Create(Button_11, "Image_name", 28.00, 3.00, "res/private/player_main_layer_ui/name2.png")
	GUI:setTouchEnabled(Image_name, false)
	GUI:setTag(Image_name, -1)

	-- Create Panel_btnList_left
	local Panel_btnList_left = GUI:Layout_Create(Panel_1, "Panel_btnList_left", 145.00, 478.00, 110.00, 454.00, false)
	...
	-- Create Button_20
	local Button_20 = GUI:Button_Create(Panel_btnList_left, "Button_20", 0.00, 454.00, "res/public/1900000641_1.png")
	...
	-- Create Image_name
	local Image_name = GUI:Image_Create(Button_20, "Image_name", 28.00, 3.00, "res/private/player_main_layer_ui/name1.png")
	GUI:setTouchEnabled(Image_name, false)
	GUI:setTag(Image_name, -1)

	-- Create ImageTitle
	local ImageTitle = GUI:Image_Create(Panel_1, "ImageTitle", 258.00, 489.00, "res/private/player_main_layer_ui/title1.png")
	GUI:setTouchEnabled(ImageTitle, false)
	GUI:setTag(ImageTitle, -1)

	-- Create Button_qiYun
	local Button_qiYun = GUI:Button_Create(Panel_1, "Button_qiYun", 677.00, 417.00, "res/private/player_main_layer_ui/icon1.png")
	...
	local Button_xiuXian = GUI:Button_Create(Panel_1, "Button_xiuXian", 753.00, 417.00, "res/private/player_main_layer_ui/icon2.png")
	...
	local Button_zhuangBan = GUI:Button_Create(Panel_1, "Button_zhuangBan", 830.00, 417.00, "res/private/player_main_layer_ui/icon3.png")
	...
	local Button_HunZhuang = GUI:Button_Create(Panel_1, "Button_HunZhuang", 856.00, 417.00, "res/private/player_main_layer_ui/icon4.png")
