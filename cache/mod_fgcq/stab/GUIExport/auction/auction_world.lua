...
function ui.init(parent)
	...
	GUI:setContentSize(Image_1_0, 355, 2)
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_items, "Text_1", 69.00, 338.00, 16, "#ffffff", [[竞拍道具]])
	...
	-- Create Text_1_0
	local Text_1_0 = GUI:Text_Create(Panel_items, "Text_1_0", 225.00, 338.00, 16, "#ffffff", [[剩余时间]])
	...
	local Panel_filter_2 = GUI:Layout_Create(Panel_1, "Panel_filter_2", 732.00, 0.00, 732.00, 48.00, false)
	...
	local ListView_filter_3 = GUI:ListView_Create(Image_filter_bg, "ListView_filter_3", 52.00, 2.00, 100.00, 95.00, 1)
