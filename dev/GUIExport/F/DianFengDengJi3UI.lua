...
function ui.init(parent, __data__, __update__)
	...
	-- Create ImageBG
	local ImageBG = GUI:Image_Create(parent, "ImageBG", 121.00, 57.00, "res/custom/DianFengDengJi/bg3.png")
	...
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(ImageBG, "Panel_1", 700.00, 137.00, 139, 46, false)
	GUI:setAnchorPoint(Panel_1, 0.00, 0.00)
	GUI:setTouchEnabled(Panel_1, true)
	GUI:setTag(Panel_1, 0)

	-- Create Node_1
	local Node_1 = GUI:Node_Create(ImageBG, "Node_1", -3.00, -2.00)
	GUI:setTag(Node_1, 0)

	-- Create Image_1
	local Image_1 = GUI:Image_Create(Node_1, "Image_1", 199.00, 171.00, "res/custom/DianFengDengJi/dl3.png")
	...
	-- Create Image_2
	local Image_2 = GUI:Image_Create(Node_1, "Image_2", 186.00, 237.00, "res/custom/DianFengDengJi/dl3.png")
	...
	-- Create Image_3
	local Image_3 = GUI:Image_Create(Node_1, "Image_3", 201.00, 308.00, "res/custom/DianFengDengJi/dl3.png")
	...
	-- Create Image_4
	local Image_4 = GUI:Image_Create(Node_1, "Image_4", 250.00, 373.00, "res/custom/DianFengDengJi/dl3.png")
	...
	-- Create Image_5
	local Image_5 = GUI:Image_Create(Node_1, "Image_5", 321.00, 404.00, "res/custom/DianFengDengJi/dl3.png")
	...
	-- Create Image_6
	local Image_6 = GUI:Image_Create(Node_1, "Image_6", 394.00, 405.00, "res/custom/DianFengDengJi/dl3.png")
	...
	-- Create Image_7
	local Image_7 = GUI:Image_Create(Node_1, "Image_7", 464.00, 373.00, "res/custom/DianFengDengJi/dl3.png")
	...
	-- Create Image_8
	local Image_8 = GUI:Image_Create(Node_1, "Image_8", 512.00, 308.00, "res/custom/DianFengDengJi/dl3.png")
	...
	-- Create Image_9
	local Image_9 = GUI:Image_Create(Node_1, "Image_9", 528.00, 237.00, "res/custom/DianFengDengJi/dl3.png")
	...
	-- Create Image_10
	local Image_10 = GUI:Image_Create(Node_1, "Image_10", 514.00, 172.00, "res/custom/DianFengDengJi/dl3.png")
	...
	-- Create Image_11
	local Image_11 = GUI:Image_Create(ImageBG, "Image_11", 214.00, 474.00, "res/custom/DianFengDengJi/title3.png")
	...
	local Panel_currAtt = GUI:Layout_Create(ImageBG, "Panel_currAtt", 682.00, 341.00, 165, 25, false)
	...
	local Panel_nextAtt = GUI:Layout_Create(ImageBG, "Panel_nextAtt", 778.00, 219.00, 166, 25, false)
