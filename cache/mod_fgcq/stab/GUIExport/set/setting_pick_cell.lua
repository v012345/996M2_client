...
function ui.init(parent)
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(parent, "Panel_1", 0.00, 0.00, 430.00, 60.00, false)
	GUI:setChineseName(Panel_1, "拾取设置_组合")
	GUI:setTouchEnabled(Panel_1, true)
	GUI:setTag(Panel_1, 45)

	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_1, "Text_name", 90.00, 31.00, 16, "#ffffff", [[类型]])
	...
	-- Create Panel_drop
	local Panel_drop = GUI:Layout_Create(Panel_1, "Panel_drop", 157.00, 8.00, 80.00, 40.00, false)
	...
	local Panel_pick_hang_up = GUI:Layout_Create(Panel_1, "Panel_pick_hang_up", 329.00, 8.00, 80.00, 40.00, false)
	...
	GUI:setTag(CheckBox_pick_hang_up, 55)
end
return ui