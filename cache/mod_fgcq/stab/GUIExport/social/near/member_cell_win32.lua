...
function ui.init(parent)
	...
	local Panel_near_member = GUI:Layout_Create(parent, "Panel_near_member", 230.00, 328.00, 500.00, 24.00, false)
	GUI:setChineseName(Panel_near_member, "附件玩家表头组合")
	GUI:setTouchEnabled(Panel_near_member, true)
	GUI:setTag(Panel_near_member, 101)

	-- Create Image_4
	local Image_4 = GUI:Image_Create(Panel_near_member, "Image_4", 250.00, 12.00, "res/private/team_win32/1900014010.png")
	...
	-- Create Label_name
	local Label_name = GUI:Text_Create(Panel_near_member, "Label_name", 60.00, 13.00, 14, "#ffffff", [[玩家名字七个字]])
	...
	-- Create Label_job
	local Label_job = GUI:Text_Create(Panel_near_member, "Label_job", 165.00, 13.00, 14, "#ffffff", [[职业]])
	...
	-- Create Label_level
	local Label_level = GUI:Text_Create(Panel_near_member, "Label_level", 246.00, 13.00, 14, "#ffffff", [[等级]])
	...
	-- Create Label_guild
	local Label_guild = GUI:Text_Create(Panel_near_member, "Label_guild", 335.00, 13.00, 14, "#ffffff", [[行会]])
	...
	local Button_operation = GUI:Button_Create(Panel_near_member, "Button_operation", 445.00, 14.00, "res/public_win32/1900000679.png")
	...
	GUI:Button_setTitleFontSize(Button_operation, 14)
