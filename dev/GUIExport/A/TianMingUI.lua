...
function ui.init(parent, __data__, __update__)
	...
	GUI:setAnchorPoint(NodeMain, 0.00, 0.00)
	GUI:setTag(NodeMain, -1)
	TAGOBJ["-1"] = NodeMain

	-- Create CheckBox
	local CheckBox = GUI:CheckBox_Create(NodeMain, "CheckBox", -88.00, -137.00, "res/custom/TianMing/tg2.png", "res/custom/TianMing/tg1.png")
	GUI:setContentSize(CheckBox, 180, 38)
	...
	GUI:setAnchorPoint(NodeLeft, 0.00, 0.00)
	...
	GUI:setAnchorPoint(NodeRigth, 0.00, 0.00)
	...
	GUI:setAnchorPoint(Nodebottom, 0.00, 0.00)
	GUI:setTag(Nodebottom, -1)
	TAGOBJ["-1"] = Nodebottom

	-- Create ButtonStart
	local ButtonStart = GUI:Button_Create(Nodebottom, "ButtonStart", -145.00, -223.00, "res/custom/TianMing/static/btn1.png")
	...
	TAGOBJ["-1"] = ButtonStart

	-- Create ButtonTuJian
	local ButtonTuJian = GUI:Button_Create(Nodebottom, "ButtonTuJian", 342.00, -328.00, "res/custom/TianMing/static/tujian.png")
	GUI:Button_setTitleText(ButtonTuJian, [[]])
	GUI:Button_setTitleColor(ButtonTuJian, "#ffffff")
	GUI:Button_setTitleFontSize(ButtonTuJian, 14)
	GUI:Button_titleEnableOutline(ButtonTuJian, "#000000", 1)
	GUI:setAnchorPoint(ButtonTuJian, 0.00, 0.00)
	GUI:setTouchEnabled(ButtonTuJian, true)
	GUI:setTag(ButtonTuJian, -1)
	TAGOBJ["-1"] = ButtonTuJian
