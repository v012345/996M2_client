...
function ui.init(parent, __data__, __update__)
	...
	-- Create ImageBG
	local ImageBG = GUI:Image_Create(parent, "ImageBG", 2.00, 0.00, "res/custom/MeiRiHuanJing/hjbg2.png")
	...
	-- Create Button_1
	local Button_1 = GUI:Button_Create(ImageBG, "Button_1", 489.00, 84.00, "res/custom/MeiRiHuanJing/button1.png")
	...
	-- Create Button_2
	local Button_2 = GUI:Button_Create(ImageBG, "Button_2", 684.00, 84.00, "res/custom/MeiRiHuanJing/button2.png")
	...
	-- Create Tips_Button
	local Tips_Button = GUI:Button_Create(ImageBG, "Tips_Button", 389.00, 314.00, "res/custom/public/helpBtn.png")
	...
	-- Create Tips_Show
	local Tips_Show = GUI:Image_Create(ImageBG, "Tips_Show", 294.00, 202.00, "res/custom/public/picktypeui.png")
	...
	-- Create TipsInfo
	local TipsInfo = GUI:RichText_Create(Tips_Show, "TipsInfo", 30.00, 24.00, "<font color='#ffff00' size='16' >刷新: </font><font color='#00ff00' size='16' >幻の万古尸王[酆都]</font><br><font color='#00ff00' size='16' >          幻の虹魔猪卫[酆都]</font><br><font color='#ffff00' size='16' >爆出: </font><font color='#00ff00' size='16' >阴/阳/幽冥残魂之一</font><br><font color='#ff0000' size='16' >再次点击按钮关闭提示</font>", 200)
