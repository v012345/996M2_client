...
function ui.init(parent)
	...
	GUI:setChineseName(Image_1, "英雄其他属性_背景图")
	...
	GUI:setChineseName(Panel_2, "英雄其他属性组合")
	...
	GUI:setChineseName(ListView_extraAtt, "英雄其他属性_列表")
