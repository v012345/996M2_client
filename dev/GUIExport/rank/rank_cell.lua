...
function ui.init(parent)
	-- Create Panel_cells
	local Panel_cells = GUI:Layout_Create(parent, "Panel_cells", 241.00, 382.00, 451.00, 40.00, false)
	GUI:setChineseName(Panel_cells, "排行榜_组合")
	GUI:setTouchEnabled(Panel_cells, true)
	GUI:setTag(Panel_cells, 1)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_cells, "Image_bg", 0.00, 0.00, "res/private/rank_ui/rank_ui_mobile/1900020022.png")
	...
	-- Create Text_rank
	local Text_rank = GUI:Text_Create(Panel_cells, "Text_rank", 4.00, 20.00, 18, "#ffffff", [[4]])
	...
	-- Create Panel_ranks
	local Panel_ranks = GUI:Layout_Create(Panel_cells, "Panel_ranks", 1.00, 2.00, 34.00, 34.00, false)
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_cells, "Text_1", 118.00, 20.00, 16, "#fffc98", [[]])
	...
	-- Create Text_3
	local Text_3 = GUI:Text_Create(Panel_cells, "Text_3", 251.00, 20.00, 16, "#f67c1a", [[]])
	...
	-- Create Text_4
	local Text_4 = GUI:Text_Create(Panel_cells, "Text_4", 380.00, 20.00, 16, "#ffffff", [[]])
	...
	-- Create Image_select
	local Image_select = GUI:Image_Create(Panel_cells, "Image_select", 0.00, 0.00, "res/private/rank_ui/rank_ui_mobile/1900020028.png")
	...
	-- Create Panel_touch
	local Panel_touch = GUI:Layout_Create(Panel_cells, "Panel_touch", 0.00, 0.00, 451.00, 40.00, false)
