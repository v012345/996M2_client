...
function ui.init(parent)
	...
	-- Create Image_title
	local Image_title = GUI:Image_Create(Image_1, "Image_title", 268.00, 208.00, "res/private/trading_bank/jyh_2_04.png")
	GUI:setAnchorPoint(Image_title, 0.50, 0.50)
	GUI:setTouchEnabled(Image_title, false)
	GUI:setTag(Image_title, 32)

	-- Create Button_3
	local Button_3 = GUI:Button_Create(Image_1, "Button_3", 550.00, 227.00, "res/private/trading_bank/1900000510.png")
	...
	GUI:setTag(Button_3, 477)

	-- Create Text_desc
	local Text_desc = GUI:Text_Create(Image_1, "Text_desc", 38.00, 195.00, 20, "#ffffff", [[]])
	GUI:setIgnoreContentAdaptWithSize(Text_desc, false)
	GUI:Text_setTextAreaSize(Text_desc, { width = 460, height = 130})
	GUI:Text_setTextVerticalAlignment(Text_desc, 1)
	...
	-- Create Button_2
	local Button_2 = GUI:Button_Create(Image_1, "Button_2", 268.00, 40.00, "res/private/trading_bank/btn_jiaoyh_01.png")
	...
	GUI:Button_setTitleText(Button_2, "取回角色")
	...
	GUI:setContentSize(Slider_3, 237, 0)
	GUI:setIgnoreContentAdaptWithSize(Slider_3, false)
	GUI:Slider_setPercent(Slider_3, 100)
