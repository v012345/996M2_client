...
function ui.init(parent)
	...
	-- Create Layout
	local Layout = GUI:Layout_Create(Node, "Layout", 0.00, 0.00, 40.00, 40.00, false)
	...
	-- Create Text_count
	local Text_count = GUI:Text_Create(Layout, "Text_count", 38.00, 8.00, 13, "#ffffff", [[1]])
	...
	-- Create Text_star_lv
	local Text_star_lv = GUI:Text_Create(Layout, "Text_star_lv", 0.00, 40.00, 16, "#efad21", [[0]])
	...
	-- Create Node_needNum
	local Node_needNum = GUI:Node_Create(Layout, "Node_needNum", 38.00, 8.00)
