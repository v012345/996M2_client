...
function HeroTitle_Look.main(data)
    ...
    local path = "hero_look/hero_title_node"
    HeroTitle_Look._resPath = SLDefine.PATH_RES_PRIVATE .. "title_layer_ui/"
...
function HeroTitle_Look.refresh()
    ...
    if activateId then
        ...
        GUI:Text_setFontSize(HeroTitle_Look._ui.Text_curTitle, 18)
    ...
    local cellPath = "hero_look/title_cell.lua"
    for i = 1, count do
        local widget = GUI:Widget_Create(HeroTitle_Look._ui.ListView_cells, "title_cell_" .. i, 0, 0, 348, 55)
