...
function ui.init(parent)
	...
	-- Create Panel_3
	local Panel_3 = GUI:Layout_Create(Panel_1, "Panel_3", 22.00, 61.00, 686.00, 200.00, false)
	...
	GUI:Image_setScale9Slice(ImageBG2, 5, 5, 5, 5)
	GUI:setContentSize(ImageBG2, 228, 204)
	...
	-- Create ScrollView_2
	local ScrollView_2 = GUI:ScrollView_Create(ImageBG2, "ScrollView_2", 0.00, 2.00, 228.00, 200.00, 1)
	GUI:ScrollView_setBackGroundImageScale9Slice(ScrollView_2, 33, 33, 9, 9)
	GUI:ScrollView_setBounceEnabled(ScrollView_2, true)
	GUI:ScrollView_setInnerContainerSize(ScrollView_2, 228.00, 200.00)
	...
	-- Create ScrollView_3
	local ScrollView_3 = GUI:ScrollView_Create(ImageBG3, "ScrollView_3", 0.00, 2.00, 454.00, 200.00, 1)
	GUI:ScrollView_setBackGroundImageScale9Slice(ScrollView_3, 33, 33, 9, 9)
	GUI:ScrollView_setBounceEnabled(ScrollView_3, true)
	GUI:ScrollView_setInnerContainerSize(ScrollView_3, 456.00, 200.00)
	GUI:setChineseName(ScrollView_3, "战斗设置_分布2-2详细信息")
	GUI:setTouchEnabled(ScrollView_3, true)
	GUI:setTag(ScrollView_3, 22)

	-- Create ScrollView_4
	local ScrollView_4 = GUI:ScrollView_Create(Panel_1, "ScrollView_4", 22.00, 15.00, 686.00, 40.00, 1)
	GUI:ScrollView_setBackGroundImageScale9Slice(ScrollView_4, 0, 0, 0, 0)
	GUI:ScrollView_setBounceEnabled(ScrollView_4, true)
	GUI:ScrollView_setInnerContainerSize(ScrollView_4, 686.00, 40.00)
	GUI:setChineseName(ScrollView_4, "战斗设置_分布3组合")
	GUI:setTouchEnabled(ScrollView_4, true)
	GUI:setTag(ScrollView_4, 769)
	...
	GUI:setContentSize(Image_bg, 686, 40)
	GUI:setIgnoreContentAdaptWithSize(Image_bg, false)
	GUI:setChineseName(Image_bg, "战斗设置_分布3_背景图")
	GUI:setTouchEnabled(Image_bg, false)
	GUI:setTag(Image_bg, 770)
end
return ui