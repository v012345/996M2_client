...
function HeroEquip.InitPanelMoveEvent(equipPanel, pos)
    ...
    GUI:MoveWidget_Create(equipPanel, "move_equip_" .. pos, panelSize.width / 2 , panelSize.height / 2, panelSize.width, panelSize.height, SL:GetMetaValue("ITEMFROMUI_ENUM").HERO_EQUIP, {
        equipPos = equipPos,
...
function HeroEquip.UpdateEquipUI(data)
    ...
    if HeroEquip._ui["move_equip_" .. pos] then
        HeroEquip._ui["move_equip_" .. pos]._movingState = false
    end
    HeroEquip._moveItemData = nil
