ChiReQiangHuaOBJ = {}
ChiReQiangHuaOBJ.__cname = "ChiReQiangHuaOBJ"
--ChiReQiangHuaOBJ.config = ssrRequireCsvCfg("cfg_ChiReQiangHua")
ChiReQiangHuaOBJ.cost = {{"炽焰之核",20},{"造化结晶",10},{"灵符",400}}
ChiReQiangHuaOBJ.give = {{}}
local attrGroup = 1
local clientAttrGroup = attrGroup + 1 --客户端的自定义属性的下标是从1开始
local equipPos = 21 --装备位置
local equipName = "ζ法相天地ζ"
-------------------------------↓↓↓ UI操作 ↓↓↓---------------------------------------
function ChiReQiangHuaOBJ:main(objcfg)
    ...
    GUI:addOnClickEvent(self.ui.Button_1, function()
        ssrMessage:sendmsg(ssrNetMsgCfg.ChiReQiangHua_Request)
    end)
    GUI:Effect_Create(self.ui.Node_1, "sfx1111", 0, 0, 6, 10001, 0, 0, 4, 1)
    self:UpdateUI()
end

function ChiReQiangHuaOBJ:UpdateUI()
...
-------------------------------↓↓↓ 网络消息 ↓↓↓---------------------------------------
function ChiReQiangHuaOBJ:SyncResponse(arg1, arg2, arg3, data)
    if GUI:GetWindow(nil, self.__cname) then
        self:UpdateUI()
    end
end
return ChiReQiangHuaOBJ