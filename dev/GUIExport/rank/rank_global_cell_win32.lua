...
function ui.init(parent)
	-- Create Panel_cells
	local Panel_cells = GUI:Layout_Create(parent, "Panel_cells", 200.00, 329.00, 560.00, 33.00, false)
	...
	GUI:setContentSize(Image_bg, 560, 33)
	...
	GUI:setVisible(Image_rank_bg, false)
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Panel_cells, "Text_1", 110.00, 16.00, 18, "#fffc98", [[]])
	...
	-- Create Text_2
	local Text_2 = GUI:Text_Create(Panel_cells, "Text_2", 222.00, 16.00, 18, "#00ffff", [[]])
	...
	-- Create Text_3
	local Text_3 = GUI:Text_Create(Panel_cells, "Text_3", 350.00, 16.00, 18, "#f67c1a", [[]])
	...
	-- Create Text_4
	local Text_4 = GUI:Text_Create(Panel_cells, "Text_4", 461.00, 16.00, 18, "#ffffff", [[]])
	...
	GUI:setContentSize(Image_select, 560, 33)
	...
	-- Create Panel_touch
	local Panel_touch = GUI:Layout_Create(Panel_cells, "Panel_touch", 0.00, 0.00, 560.00, 33.00, false)
