...
function ui.init(parent)
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_skill_cell, "Image_1", 63.00, 17.00, "res/private/player_skill-win32/1900015021.png")
	...
	-- Create Image_2
	local Image_2 = GUI:Image_Create(Panel_skill_cell, "Image_2", 109.00, 16.00, "res/private/player_skill-win32/1900015020.png")
	...
	local Text_skillLevel = GUI:Text_Create(Panel_skill_cell, "Text_skillLevel", 88.00, 17.00, 12, "#ffff0f", [[-]])
	...
	local Text_skillTrain = GUI:Text_Create(Panel_skill_cell, "Text_skillTrain", 144.00, 16.00, 12, "#ffffff", [[-]])
	...
	-- Create Text_levelup
	local Text_levelup = GUI:Text_Create(Panel_skill_cell, "Text_levelup", 109.00, 16.00, 12, "#ffffff", [[强化-重]])
