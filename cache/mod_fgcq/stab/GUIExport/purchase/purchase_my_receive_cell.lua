...
function ui.init(parent)
	...
	-- Create Text_single
	local Text_single = GUI:Text_Create(Panel_cell, "Text_single", 228.00, 40.00, 16, "#ffffff", [[单价]])
	...
	-- Create Text_coin
	local Text_coin = GUI:Text_Create(Panel_cell, "Text_coin", 310.00, 40.00, 16, "#ffffff", [[单位]])
	...
	-- Create Text_remain
	local Text_remain = GUI:Text_Create(Panel_cell, "Text_remain", 388.00, 40.00, 16, "#ffffff", [[剩余数量]])
	...
	-- Create Text_receive
	local Text_receive = GUI:Text_Create(Panel_cell, "Text_receive", 476.00, 40.00, 16, "#ffffff", [[待提取数量]])
