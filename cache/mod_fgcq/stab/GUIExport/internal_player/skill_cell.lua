...
function ui.init(parent)
	...
	local Panel_skill_cell = GUI:Layout_Create(parent, "Panel_skill_cell", 0.00, 0.00, 310.00, 70.00, false)
	GUI:setChineseName(Panel_skill_cell, "内功技能_组合")
	GUI:setTouchEnabled(Panel_skill_cell, true)
	GUI:setTag(Panel_skill_cell, 14)

	-- Create Image_bg
	local Image_bg = GUI:Image_Create(Panel_skill_cell, "Image_bg", 72.00, 35.00, "res/private/player_skill/1900015004.png")
	GUI:Image_setScale9Slice(Image_bg, 19, 19, 9, 9)
	GUI:setContentSize(Image_bg, 240, 60)
	...
	-- Create Image_icon
	local Image_icon = GUI:Image_Create(Panel_skill_cell, "Image_icon", 37.00, 35.00, "res/private/player_skill/1900015031.png")
	...
	-- Create Image_1
	local Image_1 = GUI:Image_Create(Panel_skill_cell, "Image_1", 180.00, 50.00, "res/private/player_skill/1900015021.png")
	...
	-- Create Image_2
	local Image_2 = GUI:Image_Create(Panel_skill_cell, "Image_2", 78.00, 20.00, "res/private/player_skill/1900015020.png")
	...
	local Text_skillName = GUI:Text_Create(Panel_skill_cell, "Text_skillName", 78.00, 51.00, 16, "#ffffff", [[技能名称]])
	...
	local Text_skillLevel = GUI:Text_Create(Panel_skill_cell, "Text_skillLevel", 216.00, 50.00, 16, "#ffff0f", [[0]])
	...
	local Text_skillTrain = GUI:Text_Create(Panel_skill_cell, "Text_skillTrain", 128.00, 22.00, 16, "#ffffff", [[123]])
	...
	-- Create Text_levelup
	local Text_levelup = GUI:Text_Create(Panel_skill_cell, "Text_levelup", 78.00, 22.00, 16, "#ffffff", [[强化一重]])
	...
	-- Create Button_onoff
	local Button_onoff = GUI:Button_Create(Panel_skill_cell, "Button_onoff", 248.00, 35.00, "res/private/internal/bg_jnkan_02.png")
	GUI:Button_loadTexturePressed(Button_onoff, "res/private/internal/bg_jnkan_01.png")
	GUI:Button_loadTextureDisabled(Button_onoff, "res/private/internal/bg_jnkan_01.png")
	...
	-- Create Image_onoff
	local Image_onoff = GUI:Image_Create(Button_onoff, "Image_onoff", 0.00, 11.00, "res/private/internal/btn_jnkan_02.png")
