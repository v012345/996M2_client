...
function ui.init(parent)
	-- Create Panel_1
	local Panel_1 = GUI:Layout_Create(parent, "Panel_1", 0.00, 0.00, 200.00, 42.00, false)
	GUI:setTouchEnabled(Panel_1, false)
	GUI:setTag(Panel_1, 254)

	-- Create Image_sel
	local Image_sel = GUI:Image_Create(Panel_1, "Image_sel", 100.00, 21.00, "res/public/1900000678.png")
	GUI:Image_setScale9Slice(Image_sel, 43, 43, 11, 10)
	GUI:setContentSize(Image_sel, 200, 32)
	...
	-- Create Text_name
	local Text_name = GUI:Text_Create(Panel_1, "Text_name", 100.00, 21.00, 16, "#ffffff", [[物品名]])
