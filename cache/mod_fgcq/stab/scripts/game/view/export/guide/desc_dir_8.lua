...
Image_arrow:setTag(58)
Image_arrow:setCascadeColorEnabled(true)
Image_arrow:setCascadeOpacityEnabled(true)
Image_arrow:setPosition(-12.9774, -13.0133)
Image_arrow:setRotationSkewX(315.0001)
Image_arrow:setRotationSkewY(315.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(Image_arrow)
layout:setSize({width = 33.0000, height = 29.0000})
layout:setLeftMargin(-29.4774)
layout:setRightMargin(-3.5226)
layout:setTopMargin(-1.4867)
layout:setBottomMargin(-27.5133)
...
Image_desc:setPosition(-99.6017, -58.3202)
Image_desc:setRotationSkewY(0.0003)
layout = ccui.LayoutComponent:bindLayoutComponent(Image_desc)
layout:setSize({width = 167.0000, height = 66.0000})
layout:setLeftMargin(-183.1017)
layout:setRightMargin(16.1017)
layout:setTopMargin(25.3202)
layout:setBottomMargin(-91.3202)
...
Node_desc:setPosition(-99.6014, -58.3203)
layout = ccui.LayoutComponent:bindLayoutComponent(Node_desc)
layout:setLeftMargin(-99.6014)
layout:setRightMargin(99.6014)
layout:setTopMargin(58.3203)
layout:setBottomMargin(-58.3203)
