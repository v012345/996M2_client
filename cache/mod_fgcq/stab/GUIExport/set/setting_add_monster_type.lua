...
function ui.init(parent)
	...
	GUI:setChineseName(Panel_1, "添加怪物类型组合")
	...
	GUI:setChineseName(Image_7, "添加怪物类型_标题组合")
	GUI:setAnchorPoint(Image_7, 0.50, 0.50)
	GUI:setTouchEnabled(Image_7, false)
	GUI:setTag(Image_7, 150)

	-- Create Text_1
	local Text_1 = GUI:Text_Create(Image_7, "Text_1", 158.00, 14.00, 20, "#ffffff", [[怪物类别]])
	GUI:setChineseName(Text_1, "添加怪物类型_类别_文本")
	...
	-- Create ListView_1
	local ListView_1 = GUI:ListView_Create(Panel_1, "ListView_1", 12.00, 117.00, 312.00, 274.00, 1)
	GUI:ListView_setGravity(ListView_1, 5)
	GUI:setChineseName(ListView_1, "怪物类型_类型列表")
	GUI:setTouchEnabled(ListView_1, true)
	GUI:setTag(ListView_1, 224)

	-- Create Image_10
	local Image_10 = GUI:Image_Create(Panel_1, "Image_10", 15.00, 84.00, "res/private/new_setting/textBg.png")
	...
	GUI:setChineseName(Button_add, "怪物类型_新增_按钮")
	GUI:setAnchorPoint(Button_add, 0.50, 0.50)
	GUI:setTouchEnabled(Button_add, true)
	GUI:setTag(Button_add, 242)

	-- Create Button_del
	local Button_del = GUI:Button_Create(Panel_1, "Button_del", 268.00, 36.00, "res/private/new_setting/btnbg.png")
	...
	GUI:setChineseName(Button_close, "怪物类型_关闭_按钮")
