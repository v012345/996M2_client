...
function ui.init(parent)
	...
	GUI:LoadingBar_setPercent(LoadingBar_mp, 0)
	...
	GUI:LoadingBar_setPercent(LoadingBar_fhp, 0)
	...
	-- Create Text_hp
	local Text_hp = GUI:BmpText_Create(Image_1, "Text_hp", 70.00, 18.00, "#ffffff", [[-]])
	...
	-- Create Text_mp
	local Text_mp = GUI:BmpText_Create(Image_1, "Text_mp", 70.00, 2.00, "#ffffff", [[-]])
	...
	local Text_position = GUI:BmpText_Create(Panel_hp, "Text_position", 37.00, 7.00, "#ffffff", [[-]])
	...
	local Panel_chat_funcs = GUI:Layout_Create(Panel_chat, "Panel_chat_funcs", 10.00, 148.00, 232.00, 15.00, false)
	...
	GUI:setContentSize(Button_map, 30, 13)
	...
	-- Create Button_trade
	local Button_trade = GUI:Button_Create(Panel_chat_funcs, "Button_trade", 43.00, 7.00, "res/private/main-win32/1900011015.png")
	GUI:Button_loadTexturePressed(Button_trade, "res/private/main-win32/1900011016.png")
	GUI:Button_loadTextureDisabled(Button_trade, "Default/Button_Disable.png")
	GUI:Button_setScale9Slice(Button_trade, 10, 10, 4, 5)
	GUI:setContentSize(Button_trade, 30, 13)
	...
	-- Create Button_guild
	local Button_guild = GUI:Button_Create(Panel_chat_funcs, "Button_guild", 72.00, 7.00, "res/private/main-win32/1900011015.png")
	...
	GUI:setContentSize(Button_guild, 30, 13)
	...
	-- Create Button_near
	local Button_near = GUI:Button_Create(Panel_chat_funcs, "Button_near", 101.00, 7.00, "res/private/main-win32/1900011013.png")
	...
	GUI:setContentSize(Button_near, 30, 13)
	...
	-- Create Button_rank
	local Button_rank = GUI:Button_Create(Panel_chat_funcs, "Button_rank", 130.00, 7.00, "res/private/main-win32/1900011027.png")
	...
	GUI:setContentSize(Button_rank, 30, 13)
	...
	local Button_private = GUI:Button_Create(Panel_chat_funcs, "Button_private", 159.00, 7.00, "res/private/main-win32/1900011029.png")
	...
	GUI:setContentSize(Button_private, 30, 13)
	...
	-- Create Button_drop
	local Button_drop = GUI:Button_Create(Panel_chat_funcs, "Button_drop", 188.00, 7.00, "res/private/main-win32/1900011050.png")
	GUI:Button_loadTexturePressed(Button_drop, "res/private/main-win32/1900011051.png")
	GUI:Button_setScale9Slice(Button_drop, 10, 10, 4, 5)
	GUI:setContentSize(Button_drop, 30, 13)
	...
	-- Create Button_resolution
	local Button_resolution = GUI:Button_Create(Panel_chat_funcs, "Button_resolution", 173.00, 0.00, "res/private/main-win32/1900011060.png")
	GUI:Button_loadTexturePressed(Button_resolution, "res/private/main-win32/1900011061.png")
	GUI:Button_setTitleText(Button_resolution, "")
	GUI:Button_setTitleColor(Button_resolution, "#ffffff")
	GUI:Button_setTitleFontSize(Button_resolution, 14)
	GUI:Button_titleEnableOutline(Button_resolution, "#000000", 1)
	GUI:addOnClickEvent(Button_resolution, function ()  ; if true then SL:OpenResolutionSetUI() end end)
	GUI:setChineseName(Button_resolution, "聊天_分辨率_按钮")
	GUI:setTouchEnabled(Button_resolution, true)
	GUI:setTag(Button_resolution, -1)

	-- Create Panel_exit_funcs
	local Panel_exit_funcs = GUI:Layout_Create(Panel_chat, "Panel_exit_funcs", 628.00, 147.00, 60.00, 15.00, false)
	...
	-- Create Button_fbl
	local Button_fbl = GUI:Button_Create(Panel_exit_funcs, "Button_fbl", -62.00, 9.00, "res/private/main-win32/1900011060.png")
	GUI:Button_loadTexturePressed(Button_fbl, "res/private/main-win32/1900011061.png")
	GUI:Button_loadTextureDisabled(Button_fbl, "Default/Button_Disable.png")
	GUI:Button_setTitleText(Button_fbl, "")
	GUI:Button_setTitleColor(Button_fbl, "#ffffff")
	GUI:Button_setTitleFontSize(Button_fbl, 10)
	GUI:Button_titleEnableOutline(Button_fbl, "#000000", 1)
	GUI:setAnchorPoint(Button_fbl, 0.50, 0.50)
	GUI:setTouchEnabled(Button_fbl, true)
	GUI:setTag(Button_fbl, -1)
	GUI:setVisible(Button_fbl, false)

	-- Create Button_bq
	local Button_bq = GUI:Button_Create(Panel_exit_funcs, "Button_bq", -27.00, 9.00, "res/private/main-win32/1900011070.png")
	GUI:Button_loadTexturePressed(Button_bq, "res/private/main-win32/1900011071.png")
	GUI:Button_loadTextureDisabled(Button_bq, "Default/Button_Disable.png")
	GUI:Button_setTitleText(Button_bq, "")
	GUI:Button_setTitleColor(Button_bq, "#ffffff")
	GUI:Button_setTitleFontSize(Button_bq, 10)
	GUI:Button_titleEnableOutline(Button_bq, "#000000", 1)
	GUI:setAnchorPoint(Button_bq, 0.50, 0.50)
	GUI:setTouchEnabled(Button_bq, true)
	GUI:setTag(Button_bq, -1)
	GUI:setVisible(Button_bq, false)

	-- Create Button_out
	local Button_out = GUI:Button_Create(Panel_exit_funcs, "Button_out", 13.00, 9.00, "res/private/main-win32/1900011017.png")
	...
	GUI:setContentSize(Button_out, 30, 13)
	...
	-- Create Button_end
	local Button_end = GUI:Button_Create(Panel_exit_funcs, "Button_end", 44.00, 9.00, "res/private/main-win32/1900011019.png")
	...
	GUI:setContentSize(Button_end, 30, 13)
	...
	-- Create Button_role
	local Button_role = GUI:Button_Create(Panel_act, "Button_role", 43.00, 153.00, "res/private/main-win32/00000058.png")
	GUI:Button_loadTexturePressed(Button_role, "res/private/main-win32/00000059.png")
	GUI:Button_setScale9Slice(Button_role, 10, 10, 10, 10)
	GUI:setContentSize(Button_role, 30, 30)
	...
	-- Create Button_bag
	local Button_bag = GUI:Button_Create(Panel_act, "Button_bag", 86.00, 162.00, "res/private/main-win32/00000060.png")
	GUI:Button_loadTexturePressed(Button_bag, "res/private/main-win32/00000061.png")
	GUI:Button_setScale9Slice(Button_bag, 10, 10, 10, 10)
	GUI:setContentSize(Button_bag, 30, 30.5)
	...
	-- Create Button_skill
	local Button_skill = GUI:Button_Create(Panel_act, "Button_skill", 131.00, 173.00, "res/private/main-win32/00000062.png")
	GUI:Button_loadTexturePressed(Button_skill, "res/private/main-win32/00000063.png")
	GUI:Button_setScale9Slice(Button_skill, 10, 10, 10, 10)
	GUI:setContentSize(Button_skill, 30, 30)
	...
	-- Create Button_voice
	local Button_voice = GUI:Button_Create(Panel_act, "Button_voice", 174.00, 188.00, "res/private/main-win32/00000064.png")
	GUI:Button_loadTexturePressed(Button_voice, "res/private/main-win32/00000065.png")
	GUI:Button_setScale9Slice(Button_voice, 10, 10, 10, 10)
	GUI:setContentSize(Button_voice, 30, 30)
	...
	-- Create Button_store
	local Button_store = GUI:Button_Create(Panel_act, "Button_store", 162.00, 31.00, "res/private/main-win32/000038.png")
	GUI:Button_loadTexturePressed(Button_store, "res/private/main-win32/000039.png")
	GUI:Button_setScale9Slice(Button_store, 18, 19, 19, 19)
	GUI:setContentSize(Button_store, 55, 57)
	...
	GUI:setTouchEnabled(Image_time, false)
	GUI:setTag(Image_time, 235)
	GUI:setVisible(Image_time, false)

	-- Create LoadingBar_exp
	local LoadingBar_exp = GUI:LoadingBar_Create(Panel_act, "LoadingBar_exp", 90.00, 52.00, "res/private/main-win32/00000041.png", 0)
	GUI:LoadingBar_setPercent(LoadingBar_exp, 0)
	...
	local LoadingBar_weight = GUI:LoadingBar_Create(Panel_act, "LoadingBar_weight", 81.00, 31.00, "res/private/main-win32/00000041.png", 0)
	GUI:LoadingBar_setPercent(LoadingBar_weight, 0)
	...
	-- Create Image_2
	local Image_2 = GUI:Image_Create(Panel_act, "Image_2", 80.00, 11.00, "res/private/main-win32/000018.png")
	...
	-- Create Text_time
	local Text_time = GUI:BmpText_Create(Panel_act, "Text_time", 80.00, 12.00, "#ffffff", [[17:06:05]])
	...
	-- Create Text_level
	local Text_level = GUI:BmpText_Create(Panel_act, "Text_level", 65.00, 74.00, "#ffffff", [[50]])
	...
	-- Create Text_FPS
	local Text_FPS = GUI:BmpText_Create(Panel_act, "Text_FPS", 74.00, 33.00, "#ffffff", [[FPS:60]])
	...
	-- Create Text_pkmode
	local Text_pkmode = GUI:BmpText_Create(Panel_act, "Text_pkmode", 70.00, 109.00, "#ffffff", [==========[[全体攻击模式]]==========])
	...
	-- Create ButtonPaiMaiHang
	local ButtonPaiMaiHang = GUI:Button_Create(Panel_act, "ButtonPaiMaiHang", 144.00, 102.00, "res/private/main-win32/000194.png")
	GUI:Button_setTitleText(ButtonPaiMaiHang, "")
	GUI:Button_setTitleColor(ButtonPaiMaiHang, "#ffffff")
	GUI:Button_setTitleFontSize(ButtonPaiMaiHang, 10)
	GUI:Button_titleEnableOutline(ButtonPaiMaiHang, "#000000", 1)
	GUI:addOnClickEvent(ButtonPaiMaiHang, function ()  ; if true then SL:OpenAuctionUI() end end)
	GUI:setChineseName(ButtonPaiMaiHang, "主界面_拍卖行按钮")
	GUI:setTouchEnabled(ButtonPaiMaiHang, true)
	GUI:setTag(ButtonPaiMaiHang, -1)
	...
	local ListView_bubble_tips = GUI:ListView_Create(Panel_bubble_tips, "ListView_bubble_tips", 0.00, -46.00, 150.00, 50.00, 2)
	...
	-- Create Panel_quick
	local Panel_quick = GUI:Layout_Create(Panel_mid, "Panel_quick", 250.00, 150.00, 333.00, 53.00, false)
	...
	local Image_quick_bg = GUI:Image_Create(Panel_quick, "Image_quick_bg", 166.00, 0.00, "res/private/main-win32/00000040.png")
	GUI:Image_setScale9Slice(Image_quick_bg, 69, 69, 22, 22)
	GUI:setContentSize(Image_quick_bg, 333, 44)
	...
	local Panel_quick_use_1 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_1", 66.00, 25.00, 30.00, 30.00, false)
	...
	local Panel_quick_use_2 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_2", 106.00, 25.00, 30.00, 30.00, false)
	...
	local Panel_quick_use_3 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_3", 146.00, 25.00, 30.00, 30.00, false)
	...
	local Panel_quick_use_4 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_4", 186.00, 25.00, 30.00, 30.00, false)
	...
	local Panel_quick_use_5 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_5", 226.00, 25.00, 30.00, 30.00, false)
	...
	local Panel_quick_use_6 = GUI:Layout_Create(Panel_quick, "Panel_quick_use_6", 266.00, 25.00, 30.00, 30.00, false)
