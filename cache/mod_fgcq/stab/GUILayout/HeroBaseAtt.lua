...
function HeroBaseAtt.main()
    ...
    GUI:LoadExport(parent, "hero/hero_base_attri_node")
...
function HeroBaseAtt.CreateAttri(parent,data)
    ...
    local widget = GUI:Widget_Create(parent, "Attribute_"..HeroBaseAtt._index, 0, 0, 348, 27)
    GUI:LoadExport(widget, "hero/att_show_list")
