...
function ui.init(parent)
	...
	-- Create Text_1
	local Text_1 = GUI:Text_Create(Image_7, "Text_1", 158.00, 14.00, 20, "#ffffff", [[已学技能]])
	GUI:setChineseName(Text_1, "挂机技能_标题_文本")
	...
	-- Create ListView_1
	local ListView_1 = GUI:ListView_Create(Panel_1, "ListView_1", 12.00, 14.00, 312.00, 378.00, 1)
